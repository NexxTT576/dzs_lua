...
function cc.Animation3D:initWithFile(const_std_string_filename, const_std_string_animationName)
end
--[[
	init Animation3D from bundle dat
	@return bool
]]
function cc.Animation3D:init(const_Animation3DData_data)
end
--[[
	get duratio
	@return float
...
function cc.Animation3D:create(const_std_string_filename, const_std_string_animationName)
end
...
cc.Animate3D = {}
function cc.Animate3D:setKeyFrameUserInfo(int_keyFrame, const_ValueMap_userInfo)
end
--[[
...
function cc.Animate3D:setQuality(Animate3DQuality_quality)
end
function cc.Animate3D:setWeight(float_weight)
end
...
function cc.Animate3D:initWithFrames(Animation3D_animation, int_startFrame, int_endFrame, float_frameRate)
end
--[[
	@return float
]]
...
function cc.Animate3D:setSpeed(float_speed)
end
--[[
	init method
	@return bool
]]
function cc.Animate3D:init(Animation3D_animation)
end
--[[
	get & set origin interva
]]
function cc.Animate3D:setOriginInterval(float_interval)
end
--[[
...
function cc.Animate3D:create(Animation3D_animation)
end
--[[
	create Animate3D
...
function cc.Animate3D:create(Animation3D_animation, float_fromTime, float_duration)
end
--[[
...
function cc.Animate3D:createWithFrames(Animation3D_animation, int_startFrame, int_endFrame, float_frameRate)
end
--[[
	set animate transition time between 3d animations
]]
function cc.Animate3D:setTransitionTime(float_transTime)
end
...
function cc.TextureCube:setTexParameters(const_TexParams)
end
...
function cc.AttachNode:create(Bone3D_attachBone)
end
...
function cc.BillBoard:setMode(Mode_mode)
end
--[[
...
function cc.BillBoard:create(Mode_mode)
end
--[[
...
function cc.BillBoard:create(const_std_string_filename, Mode_mode)
end
--[[
...
function cc.BillBoard:create(const_std_string_filename, const_Rect_rect, Mode_mode)
end
--[[
...
function cc.BillBoard:createWithTexture(Texture2D_texture, Mode_mode)
end
...
function cc.Mesh:setMaterial(Material_material)
end
--[[
	name getter
	@return std_string
...
function cc.Mesh:getMeshVertexAttribute(int_idx)
end
--[[
...
function cc.Mesh:draw(Renderer_renderer, float_globalZ, const_Mat4_transform, uint32_t_flags, unsigned_int_lightMask, const_Vec4_color, bool_forceDepthWrite)
end
--[[
	name sette
]]
function cc.Mesh:setName(const_std_string_name)
end
--[[
	Mesh index data sette
]]
function cc.Mesh:setMeshIndexData(MeshIndexData_indexdata)
end
--[[
...
function cc.Mesh:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	force set this Sprite3D to 2D render queue
]]
function cc.Mesh:setForce2DQueue(bool_force2D)
end
--[[
	skin sette
]]
function cc.Mesh:setSkin(MeshSkin_skin)
end
--[[
	@return bool
]]
...
function cc.Mesh:setGLProgramState(GLProgramState_glProgramState)
end
--[[
	visible getter and sette
]]
function cc.Mesh:setVisible(bool_visible)
end
...
function cc.Skeleton3D:addBone(Bone3D_bone)
end
--[[
	@return [luaIde#Bone3D]
]]
function cc.Skeleton3D:getBoneByName(const_std_string_id)
end
--[[
	@return [luaIde#Bone3D]
]]
function cc.Skeleton3D:getRootBone(int_index)
end
--[[
...
function cc.Skeleton3D:getBoneByIndex(unsigned_int_index)
end
--[[
	get & set root bon
	@return ssize_t
...
function cc.Skeleton3D:getBoneIndex(Bone3D_bone)
end
--[[
	get total bone coun
	@return ssize_t
...
function cc.Sprite3D:setCullFaceEnabled(bool_enable)
end
--[[
	set diffuse texture, set the first if multiple textures exis
]]
function cc.Sprite3D:setTexture(const_std_string_texFile)
end
--[[
	@return int
]]
...
function cc.Sprite3D:setMaterial(Material_material)
end
--[[
	Adds a new material to a particular mesh of the sprite.
	meshIndex is the mesh that will be applied to.
...
function cc.Sprite3D:setMaterial(Material_material, int_meshIndex)
end
--[[
	get mes
...
function cc.Sprite3D:getMeshByIndex(int_index)
end
--[[
	@return bool
]]
...
function cc.Sprite3D:setLightMask(unsigned_int_mask)
end
--[[
	get AttachNode by bone name, return nullptr if not exis
	@return [luaIde#cc.AttachNode]
]]
function cc.Sprite3D:getAttachNode(const_std_string_boneName)
end
--[[
	overrides
]]
function cc.Sprite3D:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	force set this Sprite3D to 2D render queue
]]
function cc.Sprite3D:setForce2DQueue(bool_force2D)
end
--[[
	generate default materia
]]
function cc.Sprite3D:genMaterial(bool_useLight)
end
--[[
	remove attach nod
]]
function cc.Sprite3D:removeAttachNode(const_std_string_boneName)
end
--[[
...
function cc.Sprite3D:setForceDepthWrite(bool_value)
end
--[[
	get Mesh by Name, it returns the first one if there are more than one mesh with the same name
	@return [luaIde#cc.Mesh]
]]
function cc.Sprite3D:getMeshByName(const_std_string_name)
end
--[[
	Creates an empty sprite3D without 3D model and texture.
	@return [luaIde#cc.Sprite3D]   An autoreleased sprite3D object.
]]
function cc.Sprite3D:create()
end
--[[
	creates a Sprite3
	@return [luaIde#cc.Sprite3D]
]]
function cc.Sprite3D:create(const_std_string_modelPath)
end
--[[
	@return [luaIde#cc.Sprite3D]
]]
function cc.Sprite3D:create(const_std_string_modelPath, const_std_string_texturePath)
end
...
function cc.Sprite3DCache:removeSprite3DData(const_std_string_key)
end
--[[
...
function cc.Sprite3DMaterial:getMaterialType()
end
--[[
...
function cc.Sprite3DMaterial:createWithFilename(const_std_string_path)
end
--[[
	Release all cached materials
]]
function cc.Sprite3DMaterial:releaseCachedMaterial()
end
--[[
...
function cc.Sprite3DMaterial:createBuiltInMaterial(MaterialType_type, bool_skinned)
end
--[[
	Create all build in materials
]]
function cc.Sprite3DMaterial:createBuiltInMaterial()
end
--[[
...
function cc.Sprite3DMaterial:createWithGLStateProgram(GLProgramState_programState)
end
--[[
	Release all built in materials
]]
function cc.Sprite3DMaterial:releaseBuiltInMaterial()
end
...
function cc.Terrain:initHeightMap(const_std_string_heightMap)
end
--[[
	set the MaxDetailAmount.
]]
function cc.Terrain:setMaxDetailMapAmount(int_maxValue)
end
--[[
	show the wireline instead of the surface,Debug Use only.
	@Note only support desktop platform
]]
function cc.Terrain:setDrawWire(bool_boolValue)
end
--[[
...
function cc.Terrain:setDetailMap(unsigned_int_index, DetailMap_detailMap)
end
--[[
	reset the heightmap data.
]]
function cc.Terrain:resetHeightMap(const_std_string_heightMap)
end
--[[
...
function cc.Terrain:setLightDir(const_Vec3_lightDir)
end
--[[
	set the alpha ma
]]
function cc.Terrain:setAlphaMap(cocos2d_Texture2D__newAlphaMapTexture)
end
--[[
	set the skirt height ratio
]]
function cc.Terrain:setSkirtHeightRatio(float_ratio)
end
--[[
	Convert a world Space position (X,Z) to terrain space position (X,Z)
	@return [luaIde#cc.Vec2]
]]
function cc.Terrain:convertToTerrainSpace(const_Vec2_worldSpace)
end
--[[
...
function cc.Terrain:initWithTerrainData(TerrainData_parameter, CrackFixedType_fixedType)
end
--[[
...
function cc.Terrain:setLODDistance(float_lod1, float_lod2, float_lod3)
end
--[[
...
function cc.Terrain:getNormal(int_pixelX, int_pixelY)
end
...
function cc.Terrain:getImageHeight(int_pixelX, int_pixelY)
end
--[[
	set light map texture
]]
function cc.Terrain:setLightMap(const_std_string_fileName)
end
--[[
	Switch frustum Culling Flag
	@Note frustum culling will remarkable improve your terrain rendering performance.
]]
function cc.Terrain:setIsEnableFrustumCull(bool_boolValue)
end
--[[
...
function cc.Bundle3D:load(const_std_string_path)
end
--[[
...
function cc.Bundle3D:loadSkinData(const_std_string_id, SkinData_skindata)
end
...
function cc.Bundle3D:loadMaterials(MaterialDatas_materialdatas)
end
--[[
	@return bool
]]
function cc.Bundle3D:loadNodes(NodeDatas_nodedatas)
end
--[[
...
function cc.Bundle3D:loadAnimationData(const_std_string_id, Animation3DData_animationdata)
end
--[[
...
function cc.Bundle3D:destroyBundle(Bundle3D_bundle)
end

ccexp.AudioProfile = {}
function ccexp.AudioProfile:new()
end
...
function ccexp.AudioEngine:setCurrentTime(int_audioID, float_sec)
end
--[[
...
function ccexp.AudioEngine:getVolume(int_audioID)
end
--[[
...
function ccexp.AudioEngine:uncache(const_std_string_filePath)
end
--[[
...
function ccexp.AudioEngine:pause(int_audioID)
end
--[[
...
function ccexp.AudioEngine:isEnabled()
end
--[[
...
function ccexp.AudioEngine:getCurrentTime(int_audioID)
end
--[[
...
function ccexp.AudioEngine:setMaxAudioInstance(int_maxInstances)
end
--[[
...
function ccexp.AudioEngine:isLoop(int_audioID)
end
--[[
...
function ccexp.AudioEngine:setVolume(int_audioID, float_volume)
end
--[[
	Preload audio file.
	@param filePath The file path of an audio.
]]
function ccexp.AudioEngine:preload(const_std_string_filePath)
end
--[[
	Preload audio file.
	@param filePath The file path of an audio.
...
function ccexp.AudioEngine:setEnabled(bool_isEnabled)
end
--[[
	Play 2d sound.
...
function ccexp.AudioEngine:play2d(const_std_string_filePath, bool_loop, float_volume, const_AudioProfile_profile)
end
--[[
...
function ccexp.AudioEngine:getState(int_audioID)
end
--[[
	Resume an audio instance.
	@param audioID An audioID returned by the play2d function.
]]
function ccexp.AudioEngine:resume(int_audioID)
end
--[[
	Stop an audio instance.
	@param audioID An audioID returned by the play2d function.
]]
function ccexp.AudioEngine:stop(int_audioID)
end
--[[
...
function ccexp.AudioEngine:getDuration(int_audioID)
end
--[[
...
function ccexp.AudioEngine:setLoop(int_audioID, bool_loop)
end
--[[
...
function ccexp.AudioEngine:getProfile(int_audioID)
end
--[[
...
function ccexp.AudioEngine:getProfile(const_std_string_profileName)
end
--[[
	Gets playing audio count.
	@return int
]]
function ccexp.AudioEngine:getPlayingAudioCount()
end
...
cc.Console = {}
function cc.Console:listenOnTCP()
end
function cc.Console:log()
end
function cc.Console:delCommand()
end
function cc.Console:stop()
end
function cc.Console:listenOnFileDescriptor()
end
function cc.Console:setCommandSeparator()
end
function cc.Console:setBindAddress()
end
function cc.Console:isIpv6Server()
end
...
function cc.Texture2D:setAlphaTexture(Texture2D_alphaTexture)
end
--[[
...
function cc.Texture2D:initWithImage(Image__image)
end
--[[
	Initializes a texture from a UIImage object.
...
function cc.Texture2D:initWithImage(Image__image, PixelFormat_format)
end
--[[
	Gets max S.
	@return GLfloat
...
function cc.Texture2D:getAlphaTextureName()
end
--[[
...
function cc.Texture2D:getBitsPerPixelForFormat()
end
--[[
...
function cc.Texture2D:getBitsPerPixelForFormat(Texture2D_PixelFormat_format)
end
--[[
...
function cc.Texture2D:initWithString(
    const_char_text,
    const_std_string_fontName,
    float_fontSize,
    const_Size_dimensions,
    TextHAlignment_hAlignment,
    TextVAlignment_vAlignment,
    bool_enableWrap,
    int_overflow)
end
--[[
...
function cc.Texture2D:initWithString(const_char_text, const_FontDefinition_textDefinition)
end
--[[
	Sets max T.
]]
function cc.Texture2D:setMaxT(GLfloat_maxT)
end
--[[
	@return std_string
]]
function cc.Texture2D:getPath()
end
--[[
	Draws a texture inside a rect
]]
function cc.Texture2D:drawInRect(const_Rect_rect)
end
--[[
...
function cc.Texture2D:getAlphaTexture()
end
--[[
...
function cc.Texture2D:setGLProgram(GLProgram_program)
end
--[[
	Get content size.
	@return [luaIde#cc.Size]
...
function cc.Texture2D:drawAtPoint(const_Vec2_point)
end
--[[
...
function cc.Texture2D:setMaxS(GLfloat_maxS)
end
--[[
...
function cc.Texture2D:setDefaultAlphaPixelFormat(Texture2D_PixelFormat_format)
end
--[[
...
function cc.Touch:getCurrentForce()
end
--[[
...
function cc.Touch:setTouchInfo(int_id, float_x, float_y)
end
--[[
	Set the touch information. It always used to monitor touch event.
	@param id A given id
...
function cc.Touch:setTouchInfo(int_id, float_x, float_y, float_force, float_maxForce)
end
--[[
	Returns the maximum touch force for 3d touch.
	@return float   The maximum touch force for 3d touch.
]]
function cc.Touch:getMaxForce()
end
--[[
...
function cc.EventTouch:setEventCode(EventCode_eventCode)
end
...
cc.Component = {}
function cc.Component:setEnabled(bool_enabled)
end
function cc.Component:onRemove()
end
function cc.Component:setName(const_std_string_name)
end
--[[
	@return bool
]]
...
function cc.Component:update(float_delta)
end
--[[
...
function cc.Component:setOwner(Node_owner)
end
--[[
	@return std_string
]]
...
function cc.Node:addChild(Node__child)
end
--[[
...
function cc.Node:addChild(Node__child, int_localZOrder)
end
--[[
...
function cc.Node:addChild(Node_child, int_localZOrder, int_tag)
end
--[[
	Adds a child to the container with z order and tag
	If the child is added to a 'running' node, then 'onEnter' and 'onEnterTransitionDidFinish' will be called immediately.
...
function cc.Node:addChild(Node_child, int_localZOrder, const_std_string_name)
end
--[[
...
function cc.Node:setRotationSkewY(float_rotationY)
end
--[[
...
function cc.Node:getChildByName(const_std_string_name)
end
--[[
	@return [luaIde#T]
]]
...
function cc.Node:setRotation(float_rotation)
end
--[[
...
function cc.Node:setScaleZ(float_scaleZ)
end
--[[
...
function cc.Node:setScaleY(float_scaleY)
end
--[[
...
function cc.Node:setScaleX(float_scaleX)
end
--[[
...
function cc.Node:setRotationSkewX(float_rotationX)
end
--[[
	Helper function used by `setLocalZOrder`. Don't use it unless you know what you are doing.
	@js NA
]]
function cc.Node:_setLocalZOrder(std_int32_t_z)
end
--[[
...
function cc.Node:removeChild(Node_child, bool_cleanup)
end
--[[
...
function cc.Node:setSkewX(float_skewX)
end
--[[
	Set the GLProgramState for this node.
	@param glProgramState The GLProgramState for this node.
]]
function cc.Node:setGLProgramState(GLProgramState_glProgramState)
end
--[[
	FIXME: should get deprecated in v4.0
]]
function cc.Node:setNormalizedPosition(const_Vec2_position)
end
--[[
	Removes all children from the container with a cleanup.
	@see `removeAllChildrenWithCleanup(bool)`
]]
function cc.Node:removeAllChildren()
end
--[[
	Sets the parent node.
	@param parent    A pointer to the parent node.
]]
function cc.Node:setParent(Node_parent)
end
--[[
...
function cc.Node:setPositionNormalized(const_Vec2_position)
end
--[[
...
function cc.Node:setPosition(const_Vec2_position)
end
--[[
	Sets the position (x,y) of the node in its parent's coordinate system.
...
function cc.Node:setPosition(float_x, float_y)
end
--[[
...
function cc.Node:reorderChild(Node__child, int_localZOrder)
end
--[[
...
function cc.Node:setSkewY(float_skewY)
end
--[[
...
function cc.Node:setPositionZ(float_positionZ)
end
--[[
...
function cc.Node:setRotation3D(const_Vec3_rotation)
end
--[[
	Sets the x coordinate of the node in its parent's coordinate system.
	@param x The x coordinate of the node.
]]
function cc.Node:setPositionX(float_x)
end
--[[
...
function cc.Node:setGLProgram(GLProgram_glprogram)
end
--[[
...
function cc.Node:removeChildByName(const_std_string_name, bool_cleanup)
end
--[[
...
function cc.Node:setName(const_std_string_name)
end
--[[
	Gets the local Z order of this node.
	@see `setLocalZOrder(int)`
	@return [luaIde#std_int32_t]   The local (relative to its siblings) Z order.
]]
...
function cc.Node:getPositionNormalized()
end
--[[
...
function cc.Node:removeChildByTag(int_tag, bool_cleanup)
end
--[[
	Sets the y coordinate of the node in its parent's coordinate system.
	@param y The y coordinate of the node.
]]
function cc.Node:setPositionY(float_y)
end
--[[
...
function cc.Node:setVisible(bool_visible)
end
--[[
...
function cc.Node:setGlobalZOrder(float_globalZOrder)
end
--[[
...
function cc.Node:setScale(float_scale)
end
--[[
...
function cc.Node:setScale(float_scaleX, float_scaleY)
end
--[[
...
function cc.Node:getChildByTag(int_tag)
end
--[[
	@return [luaIde#T]
]]
...
function cc.Node:setLocalZOrder(std_int32_t_localZOrder)
end
--[[
...
function cc.Node:setIgnoreAnchorPointForPosition(bool_ignore)
end
--[[
...
function cc.Node:setUserObject(Ref_userObject)
end
--[[
	Removes this node itself from its parent node with a cleanup.
	If the node orphan, then nothing happens.
	@see `removeFromParent(bool)`
]]
function cc.Node:removeFromParent()
end
--[[
...
function cc.Node:setPosition3D(const_Vec3_position)
end
--[[
...
function cc.Node:updateOrderOfArrival()
end
--[[
	@return [luaIde#cc.Vec2]
]]
...
function cc.Node:setTag(int_tag)
end
--[[
...
function cc.Node:getAttachedNodeCount()
end
...
function cc.Scene:initWithPhysics()
end
...
function cc.Scene:render(Renderer_renderer, const_Mat4_eyeTransform, const_Mat4_eyeProjection)
end
--[[
	Render the scene.
	@param renderer The renderer use to render the scene.
...
function cc.Scene:render(Renderer_renderer, const_Mat4_eyeTransforms, const_Mat4_eyeProjections, unsigned_int_multiViewCount)
end
function cc.Scene:stepPhysicsAndNavigation(float_deltaTime)
end
function cc.Scene:onProjectionChanged(EventCustom_event)
end
--[[
...
function cc.Scene:initWithSize(const_Size_size)
end
--[[
...
function cc.Scene:createWithSize(const_Size_size)
end
--[[
...
function cc.GLView:setFrameSize(float_width, float_height)
end
--[[
...
function cc.GLView:setContentScaleFactor(float_scaleFactor)
end
--[[
...
function cc.GLView:setIMEKeyboardState(bool_open)
end
--[[
	Gets safe area rectangle
	@return [luaIde#cc.Rect]
]]
function cc.GLView:getSafeAreaRect()
end
--[[
	@return [luaIde#VRIRenderer]
]]
function cc.GLView:getVR()
end
--[[
...
function cc.GLView:setScissorInPoints(float_x, float_y, float_w, float_h)
end
--[[
	Get the view name.
...
function cc.GLView:setCursorVisible(bool_isVisible)
end
--[[
...
function cc.GLView:setDefaultIcon()
end
--[[
...
function cc.GLView:setFrameZoomFactor(float_zoomFactor)
end
--[[
...
function cc.GLView:setIcon(const_std_string_filename)
end
--[[
	Set window icon (implemented for windows and linux).
...
function cc.GLView:setIcon()
end
--[[
	Sets the cursor for the window back to default.
]]
function cc.GLView:setDefaultCursor()
end
--[[
...
function cc.GLView:setDesignResolutionSize(float_width, float_height, ResolutionPolicy_resolutionPolicy)
end
--[[
...
function cc.GLView:renderScene(Scene_scene, Renderer_renderer)
end
--[[
	Sets a VR renderer.
	if `vrrenderer` is `nullptr` VR will be disabled
]]
function cc.GLView:setVR(VRIRenderer_vrrenderer)
end
--[[
...
function cc.GLView:setViewPortInPoints(float_x, float_y, float_w, float_h)
end
--[[
...
function cc.GLView:setCursor(const_std_string_filename, Vec2_hotspot)
end
--[[
	Get retina factor.
...
function cc.GLView:setViewName(const_std_string_viewname)
end
--[[
...
function cc.GLView:setGLContextAttrs(GLContextAttrs_glContextAttrs)
end
--[[
...
function cc.Director:pushProjectionMatrix(size_t_index)
end
--[[
...
function cc.Director:popProjectionMatrix(size_t_index)
end
--[[
...
function cc.Director:setEventDispatcher(EventDispatcher_dispatcher)
end
--[[
...
function cc.Director:loadProjectionIdentityMatrix(size_t_index)
end
--[[
...
function cc.Director:setContentScaleFactor(float_scaleFactor)
end
--[[
...
function cc.Director:getSafeAreaRect()
end
--[[
...
function cc.Director:setActionManager(ActionManager_actionManager)
end
--[[
	Enables/disables OpenGL alpha blending.
]]
function cc.Director:setAlphaBlending(bool_on)
end
--[[
...
function cc.Director:loadMatrix(MATRIX_STACK_TYPE_type, const_Mat4_mat)
end
--[[
...
function cc.Director:mainLoop(float_dt)
end
--[[
	Enables/disables OpenGL depth test.
]]
function cc.Director:setDepthTest(bool_on)
end
--[[
	Gets Frame Rate.
	@js NA
...
function cc.Director:convertToUI(const_Vec2_point)
end
--[[
	Clones a specified type matrix and put it to the top of specified type of matrix stack.
	@js NA
]]
function cc.Director:pushMatrix(MATRIX_STACK_TYPE_type)
end
--[[
...
function cc.Director:setScheduler(Scheduler_scheduler)
end
--[[
...
function cc.Director:multiplyProjectionMatrix(const_Mat4_mat, size_t_index)
end
--[[
...
function cc.Director:getMatrix(MATRIX_STACK_TYPE_type)
end
--[[
	returns whether or not the Director is in a valid state
	@return bool
]]
function cc.Director:isValid()
end
--[[
...
function cc.Director:popToSceneStackLevel(int_level)
end
--[[
...
function cc.Director:setClearColor(const_Color4F_clearColor)
end
--[[
	Sets the GLView.
	@lua NA
]]
function cc.Director:setOpenGLView(GLView_openGLView)
end
--[[
...
function cc.Director:convertToGL(const_Vec2_point)
end
--[[
...
function cc.Director:runWithScene(Scene_scene)
end
--[[
	Sets the notification node.
	@see Director::getNotificationNode()
]]
function cc.Director:setNotificationNode(Node_node)
end
--[[
	Draw the scene.
...
function cc.Director:loadIdentityMatrix(MATRIX_STACK_TYPE_type)
end
--[[
...
function cc.Director:setProjection(Projection_projection)
end
--[[
...
function cc.Director:multiplyMatrix(MATRIX_STACK_TYPE_type, const_Mat4_mat)
end
--[[
...
function cc.Director:setNextDeltaTimeZero(bool_nextDeltaTimeZero)
end
--[[
	Pops the top matrix of the specified type of matrix stack.
	@js NA
]]
function cc.Director:popMatrix(MATRIX_STACK_TYPE_type)
end
--[[
...
function cc.Director:loadProjectionMatrix(const_Mat4_mat, size_t_index)
end
--[[
...
function cc.Director:initProjectionMatrixStack(size_t_stackCount)
end
--[[
...
function cc.Director:pushScene(Scene_scene)
end
--[[
	Gets the FPS value.
	@return float
...
function cc.Director:getClearColor()
end
--[[
...
function cc.Director:setDisplayStats(bool_displayStats)
end
--[[
...
function cc.Director:replaceScene(Scene_scene)
end
--[[
	Sets the FPS value. FPS = 1/interval.
]]
function cc.Director:setAnimationInterval(float_interval)
end
--[[
...
cc.Timer = {}
function cc.Timer:setupTimerWithInterval(float_seconds, unsigned_int_repeat, float_delay)
end
--[[
	triggers the timer
]]
function cc.Timer:update(float_dt)
end
--[[
	@return bool
]]
function cc.Timer:isAborted()
end
--[[
	@return bool
]]
function cc.Timer:isExhausted()
end
function cc.Timer:trigger(float_dt)
end
function cc.Timer:cancel()
end
function cc.Timer:setAborted()
end
...
function cc.Scheduler:setTimeScale(float_timeScale)
end
--[[
...
function cc.Scheduler:removeAllFunctionsToBePerformedInCocosThread()
end
--[[
...
function cc.AsyncTaskPool:enqueue(TaskType_type, TaskCallBack_callback, void_callbackParam)
end
--[[
	Enqueue a asynchronous task.
	@param type task type is io task, network task or others, each type of task has a thread to deal with it.
...
function cc.AsyncTaskPool:enqueue(AsyncTaskPool_TaskType_type)
end
function cc.AsyncTaskPool:enqueue(TaskCallBack_callback, void_callbackParam)
end
--[[
	Stop tasks.
	@param type Task type you want to stop.
]]
function cc.AsyncTaskPool:stopTasks(TaskType_type)
end
--[[
	Destroys the async task pool.
]]
function cc.AsyncTaskPool:destroyInstance()
end
--[[
...
function cc.Action:startWithTarget(Node_target)
end
--[[
...
function cc.Action:setOriginalTarget(Node_originalTarget)
end
--[[
...
function cc.Action:update(float_time)
end
--[[
...
function cc.Action:setTarget(Node_target)
end
--[[
...
function cc.FiniteTimeAction:setDuration(float_duration)
end
--[[
...
function cc.Speed:setInnerAction(ActionInterval_action)
end
--[[
	Return the speed.
...
function cc.Speed:setSpeed(float_speed)
end
--[[
	Initializes the action.
	@return bool
]]
function cc.Speed:initWithAction(ActionInterval_action, float_speed)
end
--[[
...
function cc.Speed:create(ActionInterval_action, float_speed)
end
...
function cc.Follow:setBoundarySet(bool_value)
end
--[[
...
function cc.Follow:initWithTarget(Node_followedNode, const_Rect_rect)
end
--[[
...
function cc.Follow:initWithTargetAndOffset(Node_followedNode, float_xOffset, float_yOffset, const_Rect_rect)
end
--[[
	Return boundarySet.
...
function cc.Follow:create(Node_followedNode, const_Rect_rect)
end
--[[
...
function cc.Follow:createWithOffset(Node_followedNode, float_xOffset, float_yOffset, const_Rect_rect)
end
...
function cc.Image:saveToFile(const_std_string_filename, bool_isToRGB)
end
--[[
	@return bool
]]
...
function cc.Image:initWithImageFile(const_std_string_path)
end
--[[
	@return int
]]
...
function cc.Image:setPVRImagesHavePremultipliedAlpha(bool_haveAlphaPremultiplied)
end
--[[
	Enables or disables premultiplied alpha for PNG files.
	@param enabled (default: true)
]]
function cc.Image:setPNGPremultipliedAlphaEnabled(bool_enabled)
end
...
function cc.GLProgramState:setUniformVec4(const_std_string_uniformName, const_Vec4_value)
end
function cc.GLProgramState:setUniformVec4(GLint_uniformLocation, const_Vec4_value)
end
--[[
...
function cc.GLProgramState:applyAutoBinding(const_std_string_uniformName, const_std_string_autoBinding)
end
function cc.GLProgramState:setUniformVec2(const_std_string_uniformName, const_Vec2_value)
end
function cc.GLProgramState:setUniformVec2(GLint_uniformLocation, const_Vec2_value)
end
function cc.GLProgramState:setUniformVec3(const_std_string_uniformName, const_Vec3_value)
end
function cc.GLProgramState:setUniformVec3(GLint_uniformLocation, const_Vec3_value)
end
--[[
	Apply GLProgram, attributes and uniforms.
	@param modelView The applied modelView matrix to shader.
]]
function cc.GLProgramState:apply(const_Mat4_modelView)
end
--[[
...
function cc.GLProgramState:setUniformVec4v(const_std_string_uniformName, ssize_t_size, const_Vec4_pointer)
end
function cc.GLProgramState:setUniformVec4v(GLint_uniformLocation, ssize_t_size, const_Vec4_pointer)
end
--[[
	Apply GLProgram, and built in uniforms.
	@param modelView The applied modelView matrix to shader.
]]
function cc.GLProgramState:applyGLProgram(const_Mat4_modelView)
end
--[[
...
function cc.GLProgramState:setNodeBinding(Node_node)
end
--[[
	@{
	Setting user defined uniforms by uniform string name in the shader.
]]
function cc.GLProgramState:setUniformInt(const_std_string_uniformName, int_value)
end
--[[
	@{
	Setting user defined uniforms by uniform location in the shader.
]]
function cc.GLProgramState:setUniformInt(GLint_uniformLocation, int_value)
end
--[[
...
function cc.GLProgramState:setParameterAutoBinding(const_std_string_uniformName, const_std_string_autoBinding)
end
function cc.GLProgramState:setUniformVec2v(const_std_string_uniformName, ssize_t_size, const_Vec2_pointer)
end
function cc.GLProgramState:setUniformVec2v(GLint_uniformLocation, ssize_t_size, const_Vec2_pointer)
end
--[[
...
function cc.GLProgramState:applyAttributes(bool_applyAttribFlags)
end
--[[
...
function cc.GLProgramState:setGLProgram(GLProgram_glprogram)
end
function cc.GLProgramState:setUniformFloatv(const_std_string_uniformName, ssize_t_size, const_float_pointer)
end
function cc.GLProgramState:setUniformFloatv(GLint_uniformLocation, ssize_t_size, const_float_pointer)
end
--[[
	@return [luaIde#cc.GLProgram]
]]
...
function cc.GLProgramState:setUniformTexture(const_std_string_uniformName, Texture2D_texture)
end
--[[
...
function cc.GLProgramState:setUniformTexture(const_std_string_uniformName, GLuint_textureId)
end
function cc.GLProgramState:setUniformTexture(GLint_uniformLocation, Texture2D_texture)
end
--[[
	@deprecated, please use setUniformTexture(GLint uniformLocation, Texture2D *texture) instead,
	Passing a `textureId` may trigger texture lost issue (https://github.com/cocos2d/cocos2d-x/issues/16871).
]]
function cc.GLProgramState:setUniformTexture(GLint_uniformLocation, GLuint_textureId)
end
--[[
...
function cc.GLProgramState:setUniformFloat(const_std_string_uniformName, float_value)
end
function cc.GLProgramState:setUniformFloat(GLint_uniformLocation, float_value)
end
function cc.GLProgramState:setUniformMat4(const_std_string_uniformName, const_Mat4_value)
end
function cc.GLProgramState:setUniformMat4(GLint_uniformLocation, const_Mat4_value)
end
function cc.GLProgramState:setUniformVec3v(const_std_string_uniformName, ssize_t_size, const_Vec3_pointer)
end
function cc.GLProgramState:setUniformVec3v(GLint_uniformLocation, ssize_t_size, const_Vec3_pointer)
end
--[[
...
function cc.GLProgramState:create(GLProgram_glprogram)
end
--[[
	gets-or-creates an instance of GLProgramState for a given GLProgramName
	@return [luaIde#cc.GLProgramState]
]]
function cc.GLProgramState:getOrCreateWithGLProgramName(const_std_string_glProgramName)
end
--[[
	gets-or-creates an instance of GLProgramState for the given GLProgramName & texture
	@return [luaIde#cc.GLProgramState]
]]
function cc.GLProgramState:getOrCreateWithGLProgramName(const_std_string_glProgramName, Texture2D_texture)
end
--[[
	gets-or-creates an instance of GLProgramState for a given GLProgram
	@return [luaIde#cc.GLProgramState]
]]
function cc.GLProgramState:getOrCreateWithGLProgram(GLProgram_glprogram)
end
--[[
	gets-or-creates an instance of GLProgramState for given shaders
	@return [luaIde#cc.GLProgramState]
]]
function cc.GLProgramState:getOrCreateWithShaders(const_std_string_vertexShader, const_std_string_fragShader, const_std_string_compileTimeDefines)
end
...
function cc.PolygonInfo:getFilename()
end
--[[
...
function cc.PolygonInfo:getRect()
end
function cc.PolygonInfo:setFilename(const_std_string_filename)
end
--[[
...
function cc.PolygonInfo:setQuads(V3F_C4B_T2F_Quad_quads, int_numberOfQuads)
end
--[[
	get vertex count
...
function cc.PolygonInfo:getTrianglesCount()
end
--[[
...
function cc.PolygonInfo:setQuad(V3F_C4B_T2F_Quad_quad)
end
--[[
...
function cc.PolygonInfo:setTriangles(const_TrianglesCommand_Triangles_triangles)
end
function cc.PolygonInfo:setRect(const_Rect_rect)
end

cc.AutoPolygon = {}
function cc.AutoPolygon:new()
end
...
function cc.SpriteFrame:setAnchorPoint(const_Vec2_anchorPoint)
end
--[[
	Set texture of the frame, the texture is retained.
	@param pobTexture The texture of the sprite frame.
]]
function cc.SpriteFrame:setTexture(Texture2D_pobTexture)
end
--[[
...
function cc.SpriteFrame:setOffsetInPixels(const_Vec2_offsetInPixels)
end
--[[
...
function cc.SpriteFrame:setOriginalSize(const_Size_sizeInPixels)
end
--[[
...
function cc.SpriteFrame:getCenterRect()
end
--[[
	Set rect of the sprite frame.
	@param rectInPixels The rect of the sprite frame, in pixels.
]]
function cc.SpriteFrame:setRectInPixels(const_Rect_rectInPixels)
end
--[[
...
function cc.SpriteFrame:setCenterRectInPixels(const_Rect_centerRect)
end
--[[
	Set offset of the frame.
	@param offsets The offset of the sprite frame.
]]
function cc.SpriteFrame:setOffset(const_Vec2_offsets)
end
--[[
...
function cc.SpriteFrame:initWithTextureFilename(const_std_string_filename, const_Rect_rect)
end
--[[
...
function cc.SpriteFrame:initWithTextureFilename(const_std_string_filename, const_Rect_rect, bool_rotated, const_Vec2_offset, const_Size_originalSize)
end
--[[
	Set rect of the frame.
	@param rect The rect of the sprite.
]]
function cc.SpriteFrame:setRect(const_Rect_rect)
end
--[[
...
function cc.SpriteFrame:initWithTexture(Texture2D_pobTexture, const_Rect_rect)
end
--[[
	Initializes a SpriteFrame with a texture, rect, rotated, offset and originalSize in pixels.
...
function cc.SpriteFrame:initWithTexture(Texture2D_pobTexture, const_Rect_rect, bool_rotated, const_Vec2_offset, const_Size_originalSize)
end
--[[
	Get original size of the trimmed image.
...
function cc.SpriteFrame:hasCenterRect()
end
--[[
	Set rotated of the sprite frame.
	@param rotated Rotated the sprite frame if true.
]]
function cc.SpriteFrame:setRotated(bool_rotated)
end
--[[
...
function cc.SpriteFrame:create(const_std_string_filename, const_Rect_rect)
end
--[[
...
function cc.SpriteFrame:create(const_std_string_filename, const_Rect_rect, bool_rotated, const_Vec2_offset, const_Size_originalSize)
end
--[[
...
function cc.SpriteFrame:createWithTexture(Texture2D_pobTexture, const_Rect_rect)
end
--[[
...
function cc.SpriteFrame:createWithTexture(Texture2D_pobTexture, const_Rect_rect, bool_rotated, const_Vec2_offset, const_Size_originalSize)
end
...
function cc.AnimationFrame:setSpriteFrame(SpriteFrame_frame)
end
--[[
...
function cc.AnimationFrame:setDelayUnits(float_delayUnits)
end
--[[
...
function cc.AnimationFrame:setUserInfo(const_ValueMap_userInfo)
end
--[[
	initializes the animation frame with a spriteframe, number of delay units and a notification user info
	@return bool
]]
function cc.AnimationFrame:initWithSpriteFrame(SpriteFrame_spriteFrame, float_delayUnits, const_ValueMap_userInfo)
end
--[[
...
function cc.AnimationFrame:create(SpriteFrame_spriteFrame, float_delayUnits, const_ValueMap_userInfo)
end
...
function cc.Animation:addSpriteFrame(SpriteFrame_frame)
end
--[[
	Sets whether to restore the original frame when animation finishes.
	@param restoreOriginalFrame Whether to restore the original frame when animation finishes.
]]
function cc.Animation:setRestoreOriginalFrame(bool_restoreOriginalFrame)
end
--[[
...
function cc.Animation:initWithAnimationFrames(float_delayPerUnit, unsigned_int_loops)
end
--[[
...
function cc.Animation:setFrames()
end
--[[
...
function cc.Animation:setLoops(unsigned_int_loops)
end
--[[
	Sets the delay in seconds of the "delay unit".
	@param delayPerUnit The delay in seconds of the "delay unit".
]]
function cc.Animation:setDelayPerUnit(float_delayPerUnit)
end
--[[
...
function cc.Animation:addSpriteFrameWithFile(const_std_string_filename)
end
--[[
...
function cc.Animation:initWithSpriteFrames(float_delay, unsigned_int_loops)
end
--[[
...
function cc.Animation:addSpriteFrameWithTexture(Texture2D_pobTexture, const_Rect_rect)
end
--[[
...
function cc.Animation:create(float_delayPerUnit, unsigned_int_loops)
end
--[[
...
function cc.Animation:createWithSpriteFrames(float_delay, unsigned_int_loops)
end
...
function cc.ActionInterval:initWithDuration(float_d)
end
--[[
	Sets the amplitude rate, extension in GridAction
	@param amp   The amplitude rate.
]]
function cc.ActionInterval:setAmplitudeRate(float_amp)
end
--[[
...
function cc.Sequence:init()
end
--[[
	initializes the action
	@return bool
]]
function cc.Sequence:initWithTwoActions(FiniteTimeAction_pActionOne, FiniteTimeAction_pActionTwo)
end
...
function cc.Repeat:setInnerAction(FiniteTimeAction_action)
end
--[[
	initializes a Repeat action. Times is an unsigned integer between 1 and pow(2,30)
	@return bool
]]
function cc.Repeat:initWithAction(FiniteTimeAction_pAction, unsigned_int_times)
end
--[[
...
function cc.Repeat:create(FiniteTimeAction_action, unsigned_int_times)
end
...
function cc.RepeatForever:setInnerAction(ActionInterval_action)
end
--[[
	initializes the action
	@return bool
]]
function cc.RepeatForever:initWithAction(ActionInterval_action)
end
--[[
	Gets the inner action.
...
function cc.RepeatForever:create(ActionInterval_action)
end
...
function cc.Spawn:init()
end
--[[
	initializes the Spawn action with the 2 actions to spawn
	@return bool
]]
function cc.Spawn:initWithTwoActions(FiniteTimeAction_action1, FiniteTimeAction_action2)
end
...
function cc.RotateTo:initWithDuration(float_duration, float_dstAngleX, float_dstAngleY)
end
--[[
	initializes the action
	@param duration in seconds
...
function cc.RotateTo:initWithDuration(float_duration, const_Vec3_dstAngle3D)
end
--[[
...
function cc.RotateTo:create(float_duration, float_dstAngleX, float_dstAngleY)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.RotateTo:create(float_duration, float_dstAngle)
end
--[[
...
function cc.RotateTo:create(float_duration, const_Vec3_dstAngle3D)
end
...
function cc.RotateBy:initWithDuration(float_duration, float_deltaAngle)
end
--[[
...
function cc.RotateBy:initWithDuration(float_duration, float_deltaAngleZ_X, float_deltaAngleZ_Y)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.RotateBy:create(float_duration, float_deltaAngle)
end
--[[
	Creates the action with separate rotation angles.
	@param duration Duration time, in seconds.
...
function cc.RotateBy:create(float_duration, float_deltaAngleZ_X, float_deltaAngleZ_Y)
end
--[[
	Creates the action with 3D rotation angles.
	@param duration Duration time, in seconds.
...
function cc.RotateBy:create(float_duration, const_Vec3_deltaAngle3D)
end
...
function cc.MoveBy:initWithDuration(float_duration, const_Vec2_deltaPosition)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.MoveBy:create(float_duration, const_Vec2_deltaPosition)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.MoveBy:create(float_duration, const_Vec3_deltaPosition)
end
...
function cc.MoveTo:initWithDuration(float_duration, const_Vec2_position)
end
--[[
	initializes the action
	@param duration in seconds
...
function cc.MoveTo:initWithDuration(float_duration, const_Vec3_position)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.MoveTo:create(float_duration, const_Vec2_position)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.MoveTo:create(float_duration, const_Vec3_position)
end
...
function cc.SkewTo:initWithDuration(float_t, float_sx, float_sy)
end
--[[
	Creates the action.
...
function cc.SkewTo:create(float_t, float_sx, float_sy)
end
...
function cc.SkewBy:initWithDuration(float_t, float_sx, float_sy)
end
--[[
	Creates the action.
	@param t Duration time, in seconds.
...
function cc.SkewBy:create(float_t, float_deltaSkewX, float_deltaSkewY)
end
...
function cc.JumpBy:initWithDuration(float_duration, const_Vec2_position, float_height, int_jumps)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.JumpBy:create(float_duration, const_Vec2_position, float_height, int_jumps)
end
...
function cc.JumpTo:initWithDuration(float_duration, const_Vec2_position, float_height, int_jumps)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.JumpTo:create(float_duration, const_Vec2_position, float_height, int_jumps)
end
...
function cc.BezierBy:initWithDuration(float_t, const_ccBezierConfig_c)
end
...
function cc.BezierTo:initWithDuration(float_t, const_ccBezierConfig_c)
end
...
function cc.ScaleTo:initWithDuration(float_duration, float_s)
end
--[[
...
function cc.ScaleTo:initWithDuration(float_duration, float_sx, float_sy)
end
--[[
...
function cc.ScaleTo:initWithDuration(float_duration, float_sx, float_sy, float_sz)
end
--[[
...
function cc.ScaleTo:create(float_duration, float_s)
end
--[[
...
function cc.ScaleTo:create(float_duration, float_sx, float_sy)
end
--[[
...
function cc.ScaleTo:create(float_duration, float_sx, float_sy, float_sz)
end
...
function cc.ScaleBy:create(float_duration, float_s)
end
--[[
	Creates the action with and X factor and a Y factor.
	@param duration Duration time, in seconds.
...
function cc.ScaleBy:create(float_duration, float_sx, float_sy)
end
--[[
	Creates the action with X Y Z factor.
	@param duration Duration time, in seconds.
...
function cc.ScaleBy:create(float_duration, float_sx, float_sy, float_sz)
end
...
function cc.Blink:initWithDuration(float_duration, int_blinks)
end
--[[
	Creates the action.
	@param duration Duration time, in seconds.
...
function cc.Blink:create(float_duration, int_blinks)
end
...
function cc.FadeTo:initWithDuration(float_duration, GLubyte_opacity)
end
--[[
...
function cc.FadeTo:create(float_duration, GLubyte_opacity)
end
...
function cc.FadeIn:setReverseAction(FadeTo_ac)
end
--[[
	Creates the action.
...
function cc.FadeIn:create(float_d)
end
...
function cc.FadeOut:setReverseAction(FadeTo_ac)
end
--[[
	Creates the action.
	@param d Duration time, in seconds.
...
function cc.FadeOut:create(float_d)
end
...
function cc.TintTo:initWithDuration(float_duration, GLubyte_red, GLubyte_green, GLubyte_blue)
end
--[[
...
function cc.TintTo:create(float_duration, GLubyte_red, GLubyte_green, GLubyte_blue)
end
--[[
	Creates an action with duration and color.
	@param duration Duration time, in seconds.
...
function cc.TintTo:create(float_duration, const_Color3B_color)
end
...
function cc.TintBy:initWithDuration(float_duration, GLshort_deltaRed, GLshort_deltaGreen, GLshort_deltaBlue)
end
--[[
	Creates an action with duration and color.
	@param duration Duration time, in seconds.
...
function cc.TintBy:create(float_duration, GLshort_deltaRed, GLshort_deltaGreen, GLshort_deltaBlue)
end
...
function cc.DelayTime:create(float_d)
end
...
function cc.Animate:initWithAnimation(Animation_animation)
end
--[[
...
function cc.Animate:getCurrentFrameIndex()
end
--[[
	Sets the Animation object to be animated
	@param animation certain animation.
]]
function cc.Animate:setAnimation(Animation_animation)
end
--[[
...
function cc.Animate:create(Animation_animation)
end
...
function cc.TargetedAction:initWithTarget(Node_target, FiniteTimeAction_action)
end
--[[
	Sets the target that the action will be forced to run with.
	@param forcedTarget The target that the action will be forced to run with.
]]
function cc.TargetedAction:setForcedTarget(Node_forcedTarget)
end
--[[
...
function cc.TargetedAction:create(Node_target, FiniteTimeAction_action)
end
...
function cc.ActionFloat:initWithDuration(float_duration, float_from, float_to, ActionFloatCallback_callback)
end
--[[
...
function cc.ActionFloat:create(float_duration, float_from, float_to, ActionFloatCallback_callback)
end
...
function cc.Properties:getVariable(const_char_name, const_char_defaultValue)
end
--[[
...
function cc.Properties:getString(const_char_name, const_char_defaultValue)
end
--[[
...
function cc.Properties:getLong(const_char_name)
end
--[[
...
function cc.Properties:getNamespace(const_char_id, bool_searchNames, bool_recurse)
end
--[[
	Get the name of this Property's namespace.
	@return char   The name of this Property's namespace.
]]
function cc.Properties:getNamespace()
end
--[[
...
function cc.Properties:getPath(const_char_name, std_string_path)
end
--[[
...
function cc.Properties:getMat4(const_char_name, Mat4_out)
end
--[[
...
function cc.Properties:exists(const_char_name)
end
--[[
...
function cc.Properties:setString(const_char_name, const_char_value)
end
--[[
...
function cc.Properties:setVariable(const_char_name, const_char_value)
end
--[[
...
function cc.Properties:getBool(const_char_name, bool_defaultValue)
end
--[[
...
function cc.Properties:getColor(const_char_name, Vec3_out)
end
--[[
...
function cc.Properties:getColor(const_char_name, Vec4_out)
end
--[[
...
function cc.Properties:getType(const_char_name)
end
--[[
...
function cc.Properties:getInt(const_char_name)
end
--[[
...
function cc.Properties:getVec3(const_char_name, Vec3_out)
end
--[[
...
function cc.Properties:getVec2(const_char_name, Vec2_out)
end
--[[
...
function cc.Properties:getVec4(const_char_name, Vec4_out)
end
--[[
...
function cc.Properties:getFloat(const_char_name)
end
--[[
...
function cc.Properties:getQuaternionFromAxisAngle(const_char_name, Quaternion_out)
end
--[[
...
function cc.Properties:parseColor(const_char_str, Vec3_out)
end
--[[
...
function cc.Properties:parseColor(const_char_str, Vec4_out)
end
--[[
...
function cc.Properties:parseVec3(const_char_str, Vec3_out)
end
--[[
...
function cc.Properties:parseAxisAngle(const_char_str, Quaternion_out)
end
--[[
...
function cc.Properties:parseVec2(const_char_str, Vec2_out)
end
--[[
...
function cc.Properties:parseVec4(const_char_str, Vec4_out)
end
...
function cc.UserDefault:setIntegerForKey(const_char_key, int_value)
end
--[[
...
function cc.UserDefault:deleteValueForKey(const_char_key)
end
--[[
...
function cc.UserDefault:getFloatForKey(const_char_key)
end
--[[
...
function cc.UserDefault:getFloatForKey(const_char_key, float_defaultValue)
end
--[[
...
function cc.UserDefault:getBoolForKey(const_char_key)
end
--[[
...
function cc.UserDefault:getBoolForKey(const_char_key, bool_defaultValue)
end
--[[
...
function cc.UserDefault:setDoubleForKey(const_char_key, double_value)
end
--[[
...
function cc.UserDefault:setFloatForKey(const_char_key, float_value)
end
--[[
...
function cc.UserDefault:getStringForKey(const_char_key)
end
--[[
...
function cc.UserDefault:getStringForKey(const_char_key, const_std_string__defaultValue)
end
--[[
...
function cc.UserDefault:setStringForKey(const_char_key, const_std_string__value)
end
--[[
...
function cc.UserDefault:getIntegerForKey(const_char_key)
end
--[[
	Get bool value by key, if the key doesn't exist, will return passed default value.
	@param key The key to get value.
...
function cc.UserDefault:getIntegerForKey(const_char_key, int_defaultValue)
end
--[[
...
function cc.UserDefault:getDoubleForKey(const_char_key)
end
--[[
...
function cc.UserDefault:getDoubleForKey(const_char_key, double_defaultValue)
end
--[[
...
function cc.UserDefault:setBoolForKey(const_char_key, bool_value)
end
--[[
	@js NA
]]
...
function cc.FileUtils:fullPathForFilename(const_std_string_filename)
end
--[[
	Gets string from a file.
	@return std_string
]]
function cc.FileUtils:getStringFromFile(const_std_string_filename)
end
--[[
...
function cc.FileUtils:getStringFromFile(const_std_string_path)
end
--[[
...
function cc.FileUtils:setFilenameLookupDictionary(const_ValueMap_filenameLookupDict)
end
--[[
	Removes a file.
...
function cc.FileUtils:removeFile(const_std_string_filepath)
end
--[[
...
function cc.FileUtils:listFilesRecursivelyAsync(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:isAbsolutePath(const_std_string_path)
end
--[[
...
function cc.FileUtils:renameFile(const_std_string_path, const_std_string_oldname, const_std_string_name)
end
--[[
...
function cc.FileUtils:renameFile(const_std_string_oldfullpath, const_std_string_newfullpath)
end
--[[
	Renames a file under the given directory, async off the main cocos thread.
	@param oldfullpath  The current fullpath of the file. Includes path and name.
...
function cc.FileUtils:getDefaultResourceRootPath()
end
--[[
...
function cc.FileUtils:getValueVectorFromFile(const_std_string_filename)
end
--[[
...
function cc.FileUtils:writeToFile(const_ValueMap_dict, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:getOriginalSearchPaths()
end
--[[
...
function cc.FileUtils:getNewFilename(const_std_string_filename)
end
--[[
...
function cc.FileUtils:listFiles(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:getValueMapFromFile(const_std_string_filename)
end
--[[
...
function cc.FileUtils:getFileSize(const_std_string_filepath)
end
--[[
...
function cc.FileUtils:getValueMapFromData(const_char_filedata, int_filesize)
end
--[[
	Removes a directory.
...
function cc.FileUtils:removeDirectory(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:setSearchPaths()
end
--[[
...
function cc.FileUtils:writeStringToFile(const_std_string_dataStr, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:writeStringToFile(std_string_dataStr, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:setSearchResolutionsOrder()
end
--[[
...
function cc.FileUtils:addSearchResolutionsOrder(const_std_string_order, const_bool_front)
end
--[[
	Add search path.
	@since v2.1
]]
function cc.FileUtils:addSearchPath(const_std_string__path, const_bool_front)
end
--[[
...
function cc.FileUtils:writeValueVectorToFile(const_ValueVector_vecData, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:writeValueVectorToFile(ValueVector_vecData, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:isFileExist(const_std_string_filename)
end
--[[
...
function cc.FileUtils:fullPathFromRelativeFile(const_std_string_filename, const_std_string_relativeFile)
end
--[[
...
function cc.FileUtils:getSuitableFOpen(const_std_string_filenameUtf8)
end
--[[
...
function cc.FileUtils:writeValueMapToFile(const_ValueMap_dict, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:writeValueMapToFile(ValueMap_dict, const_std_string_fullPath)
end
--[[
...
function cc.FileUtils:getFileExtension(const_std_string_filePath)
end
--[[
	Sets writable path.
]]
function cc.FileUtils:setWritablePath(const_std_string_writablePath)
end
--[[
	Sets whether to pop-up a message box when failed to load an image.
]]
function cc.FileUtils:setPopupNotify(bool_notify)
end
--[[
...
function cc.FileUtils:isDirectoryExist(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:isDirectoryExist(const_std_string_fullPath)
end
--[[
	Set default resource root path.
]]
function cc.FileUtils:setDefaultResourceRootPath(const_std_string_path)
end
--[[
...
function cc.FileUtils:createDirectory(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:listFilesAsync(const_std_string_dirPath)
end
--[[
...
function cc.FileUtils:listFilesRecursively(const_std_string_dirPath)
end
--[[
...
function cc.EventListener:setEnabled(bool_enabled)
end
--[[
...
function cc.EventDispatcher:pauseEventListenersForTarget(Node_target, bool_recursive)
end
--[[
...
function cc.EventDispatcher:addEventListenerWithSceneGraphPriority(EventListener_listener, Node_node)
end
--[[
	Whether to enable dispatching events.
	@param isEnabled  True if enable dispatching events.
]]
function cc.EventDispatcher:setEnabled(bool_isEnabled)
end
--[[
...
function cc.EventDispatcher:addEventListenerWithFixedPriority(EventListener_listener, int_fixedPriority)
end
--[[
	Remove a listener.
	@param listener The specified event listener which needs to be removed.
]]
function cc.EventDispatcher:removeEventListener(EventListener_listener)
end
--[[
...
function cc.EventDispatcher:dispatchCustomEvent(const_std_string_eventName, void_optionalUserData)
end
--[[
...
function cc.EventDispatcher:resumeEventListenersForTarget(Node_target, bool_recursive)
end
--[[
...
function cc.EventDispatcher:removeEventListenersForTarget(Node_target, bool_recursive)
end
--[[
...
function cc.EventDispatcher:setPriority(EventListener_listener, int_fixedPriority)
end
--[[
...
function cc.EventDispatcher:dispatchEvent(Event_event)
end
--[[
...
function cc.EventDispatcher:hasEventListener(const_EventListener_ListenerID_listenerID)
end
--[[
...
function cc.EventDispatcher:removeCustomEventListeners(const_std_string_customEventName)
end
--[[
...
function cc.EventDispatcher:removeEventListenersForType(EventListener_Type_listenerType)
end
...
function cc.EventListenerAcceleration:init()
end
...
function cc.EventListenerCustom:new()
end
...
function cc.EventMouse:setScrollData(float_scrollX, float_scrollY)
end
--[[
	Returns the start touch location in screen coordinates.
	@return [luaIde#cc.Vec2]   The start touch location in screen coordinates.
...
function cc.EventMouse:setMouseButton(MouseButton_button)
end
--[[
	Returns the current touch location in screen coordinates.
	@return [luaIde#cc.Vec2]   The current touch location in screen coordinates.
...
function cc.EventMouse:setCursorPosition(float_x, float_y)
end
...
function cc.EventListenerTouchOneByOne:setSwallowTouches(bool_needSwallow)
end
--[[
	@return bool
]]
...
function cc.EventController:setConnectStatus(bool_isConnected)
end
--[[
...
function cc.EventController:setKeyCode(int_keyCode)
end
--[[
...
function cc.ActionCamera:setEye(const_Vec3_eye)
end
--[[
...
function cc.ActionCamera:setUp(const_Vec3_up)
end
--[[
...
function cc.ActionCamera:setCenter(const_Vec3_center)
end
--[[
...
function cc.OrbitCamera:initWithDuration(float_t, float_radius, float_deltaRadius, float_angleZ, float_deltaAngleZ, float_angleX, float_deltaAngleX)
end
--[[
...
function cc.OrbitCamera:create(float_t, float_radius, float_deltaRadius, float_angleZ, float_deltaAngleZ, float_angleX, float_deltaAngleX)
end
...
function cc.CardinalSplineTo:updatePosition(const_Vec2_newPos)
end
--[[
...
function cc.CardinalSplineTo:initWithDuration(float_duration, PointArray_points, float_tension)
end
...
cc.CardinalSplineBy = {}
function cc.CardinalSplineBy:new()
end
...
function cc.CatmullRomTo:initWithDuration(float_dt, PointArray_points)
end
...
function cc.CatmullRomBy:initWithDuration(float_dt, PointArray_points)
end
...
function cc.ActionEase:initWithAction(ActionInterval_action)
end
--[[
...
function cc.EaseRateAction:setRate(float_rate)
end
--[[
...
function cc.EaseRateAction:initWithAction(ActionInterval_pAction, float_fRate)
end
--[[
...
function cc.EaseRateAction:create(ActionInterval_action, float_rate)
end
...
function cc.EaseExponentialIn:new()
end
function cc.EaseExponentialIn:create()
end
...
function cc.EaseExponentialOut:new()
end
function cc.EaseExponentialOut:create()
end
...
function cc.EaseExponentialInOut:new()
end
function cc.EaseExponentialInOut:create()
end
...
cc.EaseSineIn = {}
function cc.EaseSineIn:new()
end
function cc.EaseSineIn:create()
end
...
cc.EaseSineOut = {}
function cc.EaseSineOut:new()
end
function cc.EaseSineOut:create()
end
...
cc.EaseSineInOut = {}
function cc.EaseSineInOut:new()
end
function cc.EaseSineInOut:create()
end
...
cc.EaseBounceIn = {}
function cc.EaseBounceIn:new()
end
function cc.EaseBounceIn:create()
end
...
cc.EaseBounceOut = {}
function cc.EaseBounceOut:new()
end
function cc.EaseBounceOut:create()
end
...
cc.EaseBounceInOut = {}
function cc.EaseBounceInOut:new()
end
...
cc.EaseBackIn = {}
function cc.EaseBackIn:new()
end
function cc.EaseBackIn:create()
end
...
cc.EaseBackOut = {}
function cc.EaseBackOut:new()
end
function cc.EaseBackOut:create()
end
...
cc.EaseBackInOut = {}
function cc.EaseBackInOut:new()
end
function cc.EaseBackInOut:create()
end
...
function cc.EaseQuadraticActionIn:new()
end
function cc.EaseQuadraticActionIn:create()
end
...
function cc.EaseQuadraticActionOut:new()
end
...
function cc.EaseQuadraticActionInOut:new()
end
function cc.EaseQuadraticActionInOut:create()
end
...
function cc.EaseQuarticActionIn:new()
end
function cc.EaseQuarticActionIn:create()
end
...
function cc.EaseQuarticActionOut:new()
end
function cc.EaseQuarticActionOut:create()
end
...
function cc.EaseQuarticActionInOut:new()
end
function cc.EaseQuarticActionInOut:create()
end
...
function cc.EaseQuinticActionIn:new()
end
function cc.EaseQuinticActionIn:create()
end
...
function cc.EaseQuinticActionOut:new()
end
function cc.EaseQuinticActionOut:create()
end
...
function cc.EaseQuinticActionInOut:new()
end
function cc.EaseQuinticActionInOut:create()
end
...
function cc.EaseCircleActionIn:new()
end
function cc.EaseCircleActionIn:create()
end
...
function cc.EaseCircleActionOut:new()
end
function cc.EaseCircleActionOut:create()
end
...
function cc.EaseCircleActionInOut:new()
end
function cc.EaseCircleActionInOut:create()
end
...
function cc.EaseCubicActionIn:new()
end
...
function cc.EaseCubicActionOut:new()
end
function cc.EaseCubicActionOut:create()
end
...
function cc.EaseCubicActionInOut:new()
end
function cc.EaseCubicActionInOut:create()
end
...
cc.EaseIn = {}
function cc.EaseIn:new()
end
function cc.EaseIn:create()
end
...
cc.EaseOut = {}
function cc.EaseOut:new()
end
function cc.EaseOut:create()
end
...
cc.EaseInOut = {}
function cc.EaseInOut:new()
end
function cc.EaseInOut:create()
end
...
function cc.EaseElastic:setPeriod(float_fPeriod)
end
--[[
...
function cc.EaseElastic:initWithAction(ActionInterval_action, float_period)
end
--[[
...
cc.EaseElasticIn = {}
function cc.EaseElasticIn:new()
end
function cc.EaseElasticIn:create()
end
...
cc.EaseElasticOut = {}
function cc.EaseElasticOut:new()
end
function cc.EaseElasticOut:create()
end
...
cc.EaseElasticInOut = {}
function cc.EaseElasticInOut:new()
end
function cc.EaseElasticInOut:create()
end
...
function cc.EaseBezierAction:setBezierParamer(float_p0, float_p1, float_p2, float_p3)
end
--[[
...
function cc.EaseBezierAction:create(cocos2d_ActionInterval_action)
end
...
function cc.RemoveSelf:init(bool_isNeedCleanUp)
end
--[[
	Create the action.
...
function cc.RemoveSelf:create(bool_isNeedCleanUp)
end
...
function cc.FlipX:initWithFlipX(bool_x)
end
--[[
	Create the action.
...
function cc.FlipX:create(bool_x)
end
...
function cc.FlipY:initWithFlipY(bool_y)
end
--[[
	Create the action.
...
function cc.FlipY:create(bool_y)
end
...
function cc.Place:initWithPosition(const_Vec2_pos)
end
--[[
...
function cc.Place:create(const_Vec2_pos)
end
...
function cc.CallFunc:setTargetCallback(Ref_sel)
end
...
function cc.GridAction:initWithDuration(float_duration, const_Size_gridSize)
end
...
function cc.Grid3DAction:getGridRect()
end
...
function cc.ReuseGrid:initWithTimes(int_times)
end
--[[
...
function cc.ReuseGrid:create(int_times)
end
...
function cc.Waves3D:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.Waves3D:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
--[[
...
function cc.Waves3D:setAmplitude(float_amplitude)
end
--[[
...
function cc.Waves3D:create(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
...
function cc.FlipX3D:initWithSize(const_Size_gridSize, float_duration)
end
--[[
...
function cc.FlipX3D:initWithDuration(float_duration)
end
--[[
...
function cc.FlipX3D:create(float_duration)
end
...
function cc.FlipY3D:create(float_duration)
end
...
function cc.Lens3D:setConcave(bool_concave)
end
--[[
...
function cc.Lens3D:initWithDuration(float_duration, const_Size_gridSize, const_Vec2_position, float_radius)
end
--[[
	@brief Set the value of lens effect.
	@param lensEffect The value of lens effect will be set.
]]
function cc.Lens3D:setLensEffect(float_lensEffect)
end
--[[
...
function cc.Lens3D:setPosition(const_Vec2_position)
end
--[[
...
function cc.Lens3D:create(float_duration, const_Size_gridSize, const_Vec2_position, float_radius)
end
...
function cc.Ripple3D:setAmplitudeRate(float_fAmplitudeRate)
end
--[[
...
function cc.Ripple3D:initWithDuration(float_duration, const_Size_gridSize, const_Vec2_position, float_radius, unsigned_int_waves, float_amplitude)
end
--[[
...
function cc.Ripple3D:setAmplitude(float_fAmplitude)
end
--[[
...
function cc.Ripple3D:setPosition(const_Vec2_position)
end
--[[
...
function cc.Ripple3D:create(float_duration, const_Size_gridSize, const_Vec2_position, float_radius, unsigned_int_waves, float_amplitude)
end
...
function cc.Shaky3D:initWithDuration(float_duration, const_Size_gridSize, int_range, bool_shakeZ)
end
--[[
...
function cc.Shaky3D:create(float_initWithDuration, const_Size_gridSize, int_range, bool_shakeZ)
end
...
function cc.Liquid:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.Liquid:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
--[[
	@brief Get the amplitude of the effect.
	@return float   Return the amplitude of the effect.
...
function cc.Liquid:setAmplitude(float_amplitude)
end
--[[
...
function cc.Liquid:create(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
...
function cc.Waves:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.Waves:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude, bool_horizontal, bool_vertical)
end
--[[
	@brief Get the amplitude of the effect.
	@return float   Return the amplitude of the effect.
...
function cc.Waves:setAmplitude(float_amplitude)
end
--[[
...
function cc.Waves:create(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude, bool_horizontal, bool_vertical)
end
...
function cc.Twirl:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.Twirl:initWithDuration(float_duration, const_Size_gridSize, const_Vec2_position, unsigned_int_twirls, float_amplitude)
end
--[[
	@brief Get the amplitude rate of the effect.
	@return float   Return the amplitude rate of the effect.
...
function cc.Twirl:setAmplitude(float_amplitude)
end
--[[
	@brief Get the amplitude of the effect.
	@return float   Return the amplitude of the effect.
...
function cc.Twirl:setPosition(const_Vec2_position)
end
--[[
...
function cc.Twirl:create(float_duration, const_Size_gridSize, const_Vec2_position, unsigned_int_twirls, float_amplitude)
end
...
function cc.ActionManager:getActionByTag(int_tag, const_Node_target)
end
--[[
...
function cc.ActionManager:removeActionByTag(int_tag, Node_target)
end
--[[
...
function cc.ActionManager:removeActionsByFlags(unsigned_int_flags, Node_target)
end
--[[
...
function cc.ActionManager:addAction(Action_action, Node_target, bool_paused)
end
--[[
	Resumes the target. All queued actions will be resumed.
	@param target    A certain target.
]]
function cc.ActionManager:resumeTarget(Node_target)
end
--[[
...
function cc.ActionManager:getNumberOfRunningActions()
end
--[[
	Pauses the target: all running actions and newly added actions will be paused.
	@param target    A certain target.
]]
function cc.ActionManager:pauseTarget(Node_target)
end
--[[
...
function cc.ActionManager:getNumberOfRunningActionsInTarget(const_Node_target)
end
--[[
...
function cc.ActionManager:removeAllActionsFromTarget(Node_target)
end
--[[
	Resume a set of targets (convenience function to reverse a pauseAllRunningActions call).
	@param targetsToResume   A set of targets need to be resumed.
]]
function cc.ActionManager:resumeTargets()
end
--[[
	Removes an action given an action reference.
	@param action    A certain target.
]]
function cc.ActionManager:removeAction(Action_action)
end
--[[
...
function cc.ActionManager:update(float_dt)
end
--[[
...
function cc.ActionManager:removeAllActionsByTag(int_tag, Node_target)
end
--[[
...
function cc.ActionManager:getNumberOfRunningActionsInTargetByTag(const_Node_target, int_tag)
end
...
function cc.PageTurn3D:create(float_duration, const_Size_gridSize)
end
...
function cc.ProgressTo:initWithDuration(float_duration, float_percent)
end
--[[
...
function cc.ProgressTo:create(float_duration, float_percent)
end
...
function cc.ProgressFromTo:initWithDuration(float_duration, float_fromPercentage, float_toPercentage)
end
--[[
...
function cc.ProgressFromTo:create(float_duration, float_fromPercentage, float_toPercentage)
end
...
function cc.ShakyTiles3D:initWithDuration(float_duration, const_Size_gridSize, int_range, bool_shakeZ)
end
--[[
	@brief Create the action with a range, shake Z vertices, a grid and duration.
	@param duration Specify the duration of the ShakyTiles3D action. It's a value in seconds.
...
function cc.ShakyTiles3D:create(float_duration, const_Size_gridSize, int_range, bool_shakeZ)
end
...
function cc.ShatteredTiles3D:initWithDuration(float_duration, const_Size_gridSize, int_range, bool_shatterZ)
end
--[[
...
function cc.ShatteredTiles3D:create(float_duration, const_Size_gridSize, int_range, bool_shatterZ)
end
...
function cc.ShuffleTiles:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_seed)
end
--[[
	@return [luaIde#cc.Size]
]]
function cc.ShuffleTiles:getDelta(const_Size_pos)
end
--[[
...
function cc.ShuffleTiles:create(float_duration, const_Size_gridSize, unsigned_int_seed)
end
...
function cc.FadeOutTRTiles:turnOnTile(const_Vec2_pos)
end
--[[
	@brief Hide the tile at specified position.
	@param pos The position index of the tile should be hide.
]]
function cc.FadeOutTRTiles:turnOffTile(const_Vec2_pos)
end
--[[
...
function cc.FadeOutTRTiles:transformTile(const_Vec2_pos, float_distance)
end
--[[
...
function cc.FadeOutTRTiles:testFunc(const_Size_pos, float_time)
end
--[[
...
function cc.FadeOutTRTiles:create(float_duration, const_Size_gridSize)
end
...
function cc.FadeOutBLTiles:create(float_duration, const_Size_gridSize)
end
...
function cc.FadeOutUpTiles:create(float_duration, const_Size_gridSize)
end
...
function cc.FadeOutDownTiles:create(float_duration, const_Size_gridSize)
end
...
function cc.TurnOffTiles:turnOnTile(const_Vec2_pos)
end
--[[
	@brief Hide the tile at specified position.
	@param pos The position index of the tile should be hide.
]]
function cc.TurnOffTiles:turnOffTile(const_Vec2_pos)
end
--[[
	@brief Initializes the action with grid size, random seed and duration.
...
function cc.TurnOffTiles:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_seed)
end
--[[
	@brief Create the action with the grid size and the duration.
	@param duration Specify the duration of the TurnOffTiles action. It's a value in seconds.
...
function cc.TurnOffTiles:create(float_duration, const_Size_gridSize)
end
--[[
	@brief Create the action with the grid size and the duration.
	@param duration Specify the duration of the TurnOffTiles action. It's a value in seconds.
...
function cc.TurnOffTiles:create(float_duration, const_Size_gridSize, unsigned_int_seed)
end
...
function cc.WavesTiles3D:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.WavesTiles3D:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
--[[
	@brief Get the amplitude of the effect.
	@return float   Return the amplitude of the effect.
...
function cc.WavesTiles3D:setAmplitude(float_amplitude)
end
--[[
...
function cc.WavesTiles3D:create(float_duration, const_Size_gridSize, unsigned_int_waves, float_amplitude)
end
...
function cc.JumpTiles3D:setAmplitudeRate(float_amplitudeRate)
end
--[[
...
function cc.JumpTiles3D:initWithDuration(float_duration, const_Size_gridSize, unsigned_int_numberOfJumps, float_amplitude)
end
--[[
	@brief Get the amplitude of the effect.
	@return float   Return the amplitude of the effect.
...
function cc.JumpTiles3D:setAmplitude(float_amplitude)
end
--[[
...
function cc.JumpTiles3D:create(float_duration, const_Size_gridSize, unsigned_int_numberOfJumps, float_amplitude)
end
...
function cc.SplitRows:initWithDuration(float_duration, unsigned_int_rows)
end
--[[
...
function cc.SplitRows:create(float_duration, unsigned_int_rows)
end
...
function cc.SplitCols:initWithDuration(float_duration, unsigned_int_cols)
end
--[[
...
function cc.SplitCols:create(float_duration, unsigned_int_cols)
end
...
function cc.ActionTween:initWithDuration(float_duration, const_std_string_key, float_from, float_to)
end
--[[
...
function cc.ActionTween:create(float_duration, const_std_string_key, float_from, float_to)
end
...
function cc.AtlasNode:initWithTileFile(const_std_string_tile, int_tileWidth, int_tileHeight, int_itemsToRender)
end
--[[
	@return [luaIde#cc.Texture2D]
]]
...
function cc.AtlasNode:setTextureAtlas(TextureAtlas_textureAtlas)
end
--[[
	@code
...
function cc.AtlasNode:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.AtlasNode:setTexture(Texture2D_texture)
end
--[[
...
function cc.AtlasNode:initWithTexture(Texture2D_texture, int_tileWidth, int_tileHeight, int_itemsToRender)
end
function cc.AtlasNode:setQuadsToDraw(ssize_t_quadsToDraw)
end
--[[
...
function cc.AtlasNode:create(const_std_string_filename, int_tileWidth, int_tileHeight, int_itemsToRender)
end
...
function cc.ClippingNode:init(Node_stencil)
end
--[[
...
function cc.ClippingNode:setAlphaThreshold(GLfloat_alphaThreshold)
end
--[[
...
function cc.ClippingNode:create()
end
--[[
...
function cc.ClippingNode:create(Node_stencil)
end
...
function cc.ClippingRectangleNode:setClippingEnabled(bool_enabled)
end
--[[
...
function cc.ClippingRectangleNode:setClippingRegion(const_Rect_clippingRegion)
end
--[[
...
function cc.ClippingRectangleNode:create(const_Rect_clippingRegion)
end
--[[
	@brief Create a clipping rectangle node.
	@return [luaIde#cc.ClippingRectangleNode]   If the creation success, return a pointer of ClippingRectangleNode; otherwise return nil.
]]
function cc.ClippingRectangleNode:create()
end
...
function cc.DrawNode:drawLine(const_Vec2_origin, const_Vec2_destination, const_Color4F_color)
end
--[[
...
function cc.DrawNode:setIsolated(bool_isolated)
end
--[[
...
function cc.DrawNode:drawRect(const_Vec2_origin, const_Vec2_destination, const_Color4F_color)
end
--[[
...
function cc.DrawNode:drawRect(const_Vec2_p1, const_Vec2_p2, const_Vec2_p3, const_Vec2_p4, const_Color4F_color)
end
--[[
...
function cc.DrawNode:drawSolidCircle(const_Vec2_center, float_radius, float_angle, unsigned_int_segments, float_scaleX, float_scaleY, const_Color4F_color)
end
--[[
	Draws a solid circle given the center, radius and number of segments.
	@param center The circle center point.
...
function cc.DrawNode:drawSolidCircle(const_Vec2_center, float_radius, float_angle, unsigned_int_segments, const_Color4F_color)
end
function cc.DrawNode:setLineWidth(GLfloat_lineWidth)
end
--[[
	@js NA
]]
function cc.DrawNode:onDrawGLPoint(const_Mat4_transform, uint32_t_flags)
end
--[[
...
function cc.DrawNode:drawDot(const_Vec2_pos, float_radius, const_Color4F_color)
end
--[[
...
function cc.DrawNode:drawSegment(const_Vec2_from, const_Vec2_to, float_radius, const_Color4F_color)
end
--[[
...
function cc.DrawNode:onDraw(const_Mat4_transform, uint32_t_flags)
end
--[[
...
function cc.DrawNode:drawCircle(const_Vec2_center, float_radius, float_angle, unsigned_int_segments, bool_drawLineToCenter, float_scaleX, float_scaleY, const_Color4F_color)
end
--[[
	Draws a circle given the center, radius and number of segments.
	@param center The circle center point.
...
function cc.DrawNode:drawCircle(const_Vec2_center, float_radius, float_angle, unsigned_int_segments, bool_drawLineToCenter, const_Color4F_color)
end
--[[
...
function cc.DrawNode:drawQuadBezier(const_Vec2_origin, const_Vec2_control, const_Vec2_destination, unsigned_int_segments, const_Color4F_color)
end
--[[
	@js NA
]]
function cc.DrawNode:onDrawGLLine(const_Mat4_transform, uint32_t_flags)
end
--[[
...
function cc.DrawNode:drawTriangle(const_Vec2_p1, const_Vec2_p2, const_Vec2_p3, const_Color4F_color)
end
--[[
...
function cc.DrawNode:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.DrawNode:drawSolidRect(const_Vec2_origin, const_Vec2_destination, const_Color4F_color)
end
--[[
	@return GLfloat
]]
function cc.DrawNode:getLineWidth()
end
--[[
	Draw a point.
...
function cc.DrawNode:drawPoint(const_Vec2_point, const_float_pointSize, const_Color4F_color)
end
--[[
	@return bool
]]
function cc.DrawNode:isIsolated()
end
--[[
...
function cc.DrawNode:drawCubicBezier(const_Vec2_origin, const_Vec2_control1, const_Vec2_control2, const_Vec2_destination, unsigned_int_segments, const_Color4F_color)
end
--[[
	creates and initialize a DrawNode node.
	@return [luaIde#cc.DrawNode]   Return an autorelease object.
]]
function cc.DrawNode:create(GLfloat_defaultLineWidth)
end
...
function cc.Label:enableShadow(const_Color4B_shadowColor, const_Size_offset, int_blurRadius)
end
--[[
	Sets the untransformed size of the Label in a more efficient way.
]]
function cc.Label:setDimensions(float_width, float_height)
end
--[[
	@return float
]]
...
function cc.Label:disableEffect(LabelEffect_effect)
end
--[[
...
function cc.Label:setTTFConfig(const_TTFConfig_ttfConfig)
end
--[[
	Returns type of label
	@warning Not support system font.
	@return [luaIde#LabelType]   the type of label
	@since v3.17.1
]]
function cc.Label:getLabelType()
end
--[[
...
function cc.Label:getBlendFunc()
end
--[[
...
function cc.Label:getBMFontSize()
end
--[[
	@return float
]]
...
function cc.Label:getShadowOffset()
end
--[[
	@return float
]]
function cc.Label:getLineSpacing()
end
--[[
	Clips upper and lower margin to reduce height of Label
]]
function cc.Label:setClipMarginEnabled(bool_clipEnabled)
end
--[[
	Sets the text that this Label is to display
]]
function cc.Label:setString(const_std_string_text)
end
--[[
...
function cc.Label:setSystemFontName(const_std_string_font)
end
--[[
...
function cc.Label:isWrapEnabled()
end
--[[
	Return the outline effect size value.
	@return float
]]
function cc.Label:getOutlineSize()
end
--[[
	Sets a new bitmap font to Label
	@return bool
]]
function cc.Label:setBMFontFilePath(const_std_string_bmfontFilePath, const_Vec2_imageOffset, float_fontSize)
end
--[[
	@return bool
]]
function cc.Label:initWithTTF(const_TTFConfig_ttfConfig, const_std_string_text, TextHAlignment_hAlignment, int_maxLineWidth)
end
--[[
...
function cc.Label:setLineHeight(float_height)
end
--[[
	Sets the system font size of Label
]]
function cc.Label:setSystemFontSize(float_fontSize)
end
--[[
...
function cc.Label:setOverflow(Overflow_overflow)
end
--[[
...
function cc.Label:enableStrikethrough()
end
--[[
...
function cc.Label:setLineBreakWithoutSpace(bool_breakWithoutSpace)
end
--[[
...
function cc.Label:enableOutline(const_Color4B_outlineColor, int_outlineSize)
end
--[[
	Return the shadow effect blur radius.
	@return float
]]
function cc.Label:getShadowBlurRadius()
end
--[[
	Return current effect color value.
	@return [luaIde#Color4F]
]]
function cc.Label:getEffectColor()
end
function cc.Label:removeAllChildrenWithCleanup(bool_cleanup)
end
--[[
...
function cc.Label:setCharMap(const_std_string_charMapFile, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
	Sets a new char map configuration to Label.
...
function cc.Label:setCharMap(Texture2D_texture, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
	Sets a new char map configuration to Label.
...
function cc.Label:setCharMap(const_std_string_plistFile)
end
--[[
	@return [luaIde#cc.Size]
]]
...
function cc.Label:setMaxLineWidth(float_maxLineWidth)
end
--[[
...
function cc.Label:setVerticalAlignment(TextVAlignment_vAlignment)
end
function cc.Label:setLineSpacing(float_height)
end
--[[
	Returns font size
	@return float
]]
function cc.Label:getRenderingFontSize()
end
--[[
...
function cc.Label:getShadowColor()
end
--[[
...
function cc.Label:enableItalics()
end
--[[
...
function cc.Label:setTextColor(const_Color4B_color)
end
--[[
...
function cc.Label:getLetter(int_lettetIndex)
end
--[[
...
function cc.Label:setAdditionalKerning(float_space)
end
--[[
...
function cc.Label:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	Returns the Label's text horizontal alignment
	@return [luaIde#TextHAlignment]
...
function cc.Label:setHorizontalAlignment(TextHAlignment_hAlignment)
end
--[[
	Enable bold rendering
]]
function cc.Label:enableBold()
end
--[[
	Enable underline
]]
function cc.Label:enableUnderline()
end
--[[
	Return current effect type.
	@return [luaIde#LabelEffect]
]]
function cc.Label:getLabelEffectType()
end
--[[
	Sets the Label's text horizontal alignment
]]
function cc.Label:setAlignment(TextHAlignment_hAlignment)
end
--[[
	Sets the Label's text alignment
]]
function cc.Label:setAlignment(TextHAlignment_hAlignment, TextVAlignment_vAlignment)
end
--[[
...
function cc.Label:setBMFontSize(float_fontSize)
end
--[[
...
function cc.Label:createWithCharMap(const_std_string_charMapFile, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
	Allocates and initializes a Label, with char map configuration.
...
function cc.Label:createWithCharMap(Texture2D_texture, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
	Allocates and initializes a Label, with char map configuration.
...
function cc.Label:createWithCharMap(const_std_string_plistFile)
end
...
cc.LabelAtlas = {}
function cc.LabelAtlas:setString(const_std_string_label)
end
--[[
	Initializes the LabelAtlas with a string, a char map file(the atlas), the width and height of each element and the starting char of the atlas.
	@return bool
]]
function cc.LabelAtlas:initWithString(const_std_string_string, const_std_string_charMapFile, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
...
function cc.LabelAtlas:initWithString(const_std_string_string, const_std_string_fntFile)
end
--[[
...
function cc.LabelAtlas:initWithString(const_std_string_string, Texture2D_texture, int_itemWidth, int_itemHeight, int_startCharMap)
end
--[[
	@return std_string
]]
...
function cc.LayerColor:changeWidthAndHeight(GLfloat_w, GLfloat_h)
end
--[[
	@lua NA
	@return [luaIde#cc.BlendFunc]
...
function cc.LayerColor:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	Change width in Points.
	@param w The width of layer.
]]
function cc.LayerColor:changeWidth(GLfloat_w)
end
--[[
	@return bool
]]
function cc.LayerColor:initWithColor(const_Color4B_color, GLfloat_width, GLfloat_height)
end
--[[
	Change height in Points.
	@param h The height of layer.
]]
function cc.LayerColor:changeHeight(GLfloat_h)
end
--[[
	Creates a fullscreen black layer.
	@return [luaIde#cc.LayerColor]   An autoreleased LayerColor object.
]]
function cc.LayerColor:create()
end
--[[
...
function cc.LayerColor:create(const_Color4B_color, GLfloat_width, GLfloat_height)
end
--[[
...
function cc.LayerColor:create(const_Color4B_color)
end
...
function cc.LayerGradient:setVector(const_Vec2_alongVector)
end
--[[
	Returns the start opacity of the gradient.
	@param startOpacity The start opacity, from 0 to 255.
]]
function cc.LayerGradient:setStartOpacity(GLubyte_startOpacity)
end
--[[
...
function cc.LayerGradient:setCompressedInterpolation(bool_compressedInterpolation)
end
--[[
	Returns the end opacity of the gradient.
	@param endOpacity The end opacity, from 0 to 255.
]]
function cc.LayerGradient:setEndOpacity(GLubyte_endOpacity)
end
--[[
...
function cc.LayerGradient:setEndColor(const_Color3B_endColor)
end
--[[
...
function cc.LayerGradient:initWithColor(const_Color4B_start, const_Color4B_end)
end
--[[
...
function cc.LayerGradient:initWithColor(const_Color4B_start, const_Color4B_end, const_Vec2_v)
end
--[[
...
function cc.LayerGradient:setStartColor(const_Color3B_startColor)
end
--[[
	Creates a fullscreen black layer.
	@return [luaIde#cc.LayerGradient]   An autoreleased LayerGradient object.
]]
function cc.LayerGradient:create()
end
--[[
...
function cc.LayerGradient:create(const_Color4B_start, const_Color4B_end)
end
--[[
...
function cc.LayerGradient:create(const_Color4B_start, const_Color4B_end, const_Vec2_v)
end
...
function cc.LayerRadialGradient:getStartColor()
end
--[[
	@return [luaIde#cc.BlendFunc]
]]
function cc.LayerRadialGradient:getBlendFunc()
end
--[[
	@return [luaIde#Color3B]
]]
function cc.LayerRadialGradient:getStartColor3B()
end
--[[
	@return [luaIde#GLubyte]
]]
function cc.LayerRadialGradient:getStartOpacity()
end
function cc.LayerRadialGradient:setCenter(const_Vec2_center)
end
--[[
	@return [luaIde#Color4B]
]]
function cc.LayerRadialGradient:getEndColor()
end
function cc.LayerRadialGradient:setStartOpacity(GLubyte_opacity)
end
--[[
	@return [luaIde#cc.Vec2]
]]
function cc.LayerRadialGradient:getCenter()
end
function cc.LayerRadialGradient:setEndOpacity(GLubyte_opacity)
end
function cc.LayerRadialGradient:setExpand(float_expand)
end
--[[
	@return [luaIde#GLubyte]
]]
function cc.LayerRadialGradient:getEndOpacity()
end
--[[
	@return bool
]]
function cc.LayerRadialGradient:initWithColor(const_Color4B_startColor, const_Color4B_endColor, float_radius, const_Vec2_center, float_expand)
end
function cc.LayerRadialGradient:setEndColor(const_Color3B_color)
end
--[[
	@return [luaIde#Color3B]
]]
function cc.LayerRadialGradient:getEndColor3B()
end
function cc.LayerRadialGradient:setRadius(float_radius)
end
function cc.LayerRadialGradient:setStartColor(const_Color3B_color)
end
--[[
	@return float
]]
function cc.LayerRadialGradient:getExpand()
end
function cc.LayerRadialGradient:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	@return float
]]
function cc.LayerRadialGradient:getRadius()
end
--[[
...
function cc.LayerRadialGradient:create(const_Color4B_startColor, const_Color4B_endColor, float_radius, const_Vec2_center, float_expand)
end
...
function cc.LayerMultiplex:initWithArray()
end
--[[
...
function cc.LayerMultiplex:switchToAndReleaseMe(int_n)
end
--[[
	Add a certain layer to LayerMultiplex.
	@param layer A layer need to be added to the LayerMultiplex.
]]
function cc.LayerMultiplex:addLayer(Layer_layer)
end
--[[
...
function cc.LayerMultiplex:switchTo(int_n)
end
--[[
	The same as switchTo(int), but has a parameter to set if need to clean up child.
]]
function cc.LayerMultiplex:switchTo(int_n, bool_cleanup)
end
...
function cc.MenuItem:setEnabled(bool_value)
end
--[[
	Activate the item.
]]
...
function cc.MenuItemLabel:setLabel(Node_node)
end
--[[
	Get the inner string of the inner label.
	@return std_string
]]
function cc.MenuItemLabel:getString()
end
--[[
...
function cc.MenuItemLabel:setString(const_std_string_label)
end
--[[
	Initializes a MenuItemLabel with a Label, target and selector.
	@return bool
]]
function cc.MenuItemLabel:initWithLabel(Node_label, const_ccMenuCallback_callback)
end
--[[
	Initializes a MenuItemLabel with a Label, target and selector.
	@return bool
]]
function cc.MenuItemLabel:initWithLabel(Node_label, Ref_target, SEL_MenuHandler_selector)
end
--[[
	Sets the color that will be used when the item is disabled.
]]
function cc.MenuItemLabel:setDisabledColor(const_Color3B_color)
end
--[[
...
function cc.MenuItemAtlasFont:initWithString(const_std_string_value, const_std_string_charMapFile, int_itemWidth, int_itemHeight, char_startCharMap, Ref_target, SEL_MenuHandler_selector)
end
--[[
	Initializes a menu item from a string and atlas with a target/selector.
	@return bool
]]
function cc.MenuItemAtlasFont:initWithString(const_std_string_value, const_std_string_charMapFile, int_itemWidth, int_itemHeight, char_startCharMap, const_ccMenuCallback_callback)
end
...
function cc.MenuItemFont:setFontNameObj(const_std_string_name)
end
--[[
	Initializes a menu item from a string with a target/selector.
	@return bool
]]
function cc.MenuItemFont:initWithString(const_std_string_value, Ref_target, SEL_MenuHandler_selector)
end
--[[
	Initializes a menu item from a string with a target/selector.
	@return bool
]]
function cc.MenuItemFont:initWithString(const_std_string_value, const_ccMenuCallback_callback)
end
--[[
	get font size .
	@js getFontSize
...
function cc.MenuItemFont:setFontSizeObj(int_size)
end
--[[
	Set the default font name.
]]
function cc.MenuItemFont:setFontName(const_std_string_name)
end
--[[
...
function cc.MenuItemFont:setFontSize(int_size)
end
...
function cc.MenuItemSprite:setEnabled(bool_bEnabled)
end
--[[
	The item was selected (not activated), similar to "mouse-over".
	@since v0.99.5
...
function cc.MenuItemSprite:setNormalImage(Node_image)
end
--[[
	Sets the image used when the item is disabled.
]]
function cc.MenuItemSprite:setDisabledImage(Node_image)
end
--[[
	Initializes a menu item with a normal, selected and disabled image with target/selector.
	@return bool
]]
function cc.MenuItemSprite:initWithNormalSprite(Node_normalSprite, Node_selectedSprite, Node_disabledSprite, Ref_target, SEL_MenuHandler_selector)
end
--[[
	Initializes a menu item with a normal, selected and disabled image with a callable object.
	@return bool
]]
function cc.MenuItemSprite:initWithNormalSprite(Node_normalSprite, Node_selectedSprite, Node_disabledSprite, const_ccMenuCallback_callback)
end
--[[
	Sets the image used when the item is selected.
]]
function cc.MenuItemSprite:setSelectedImage(Node_image)
end
--[[
...
function cc.MenuItemImage:setDisabledSpriteFrame(SpriteFrame_frame)
end
--[[
	Sets the sprite frame for the selected image.
]]
function cc.MenuItemImage:setSelectedSpriteFrame(SpriteFrame_frame)
end
--[[
	Sets the sprite frame for the normal image.
]]
function cc.MenuItemImage:setNormalSpriteFrame(SpriteFrame_frame)
end
--[[
	@return bool
]]
...
function cc.MenuItemImage:initWithNormalImage(const_std_string_normalImage, const_std_string_selectedImage, const_std_string_disabledImage, Ref_target, SEL_MenuHandler_selector)
end
--[[
	Initializes a menu item with a normal, selected and disabled image with a callable object.
	@return bool
]]
function cc.MenuItemImage:initWithNormalImage(const_std_string_normalImage, const_std_string_selectedImage, const_std_string_disabledImage, const_ccMenuCallback_callback)
end
...
function cc.MenuItemToggle:setSubItems()
end
--[[
	Initializes a menu item with a item.
	@return bool
]]
function cc.MenuItemToggle:initWithItem(MenuItem_item)
end
--[[
...
function cc.MenuItemToggle:addSubItem(MenuItem_item)
end
--[[
...
function cc.MenuItemToggle:setSelectedIndex(unsigned_int_index)
end
...
function cc.Menu:initWithArray()
end
--[[
...
function cc.Menu:setEnabled(bool_value)
end
--[[
...
function cc.Menu:alignItemsHorizontallyWithPadding(float_padding)
end
--[[
	Align items vertically with padding.
	@since v0.7.2
]]
function cc.Menu:alignItemsVerticallyWithPadding(float_padding)
end
...
function cc.MotionStreak:setTexture(Texture2D_texture)
end
--[[
	@return [luaIde#cc.Texture2D]
]]
...
function cc.MotionStreak:tintWithColor(const_Color3B_colors)
end
--[[
	@js NA
	@lua NA
]]
function cc.MotionStreak:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.MotionStreak:setStartingPositionInitialized(bool_bStartingPositionInitialized)
end
--[[
	@js NA
	@lua NA
...
function cc.MotionStreak:initWithFade(float_fade, float_minSeg, float_stroke, const_Color3B_color, const_std_string_path)
end
--[[
	initializes a motion streak with fade in seconds, minimum segments, stroke's width, color and texture
	@return bool
]]
function cc.MotionStreak:initWithFade(float_fade, float_minSeg, float_stroke, const_Color3B_color, Texture2D_texture)
end
--[[
	Sets fast mode or not.
	@param bFastMode True if enabled fast mode.
]]
function cc.MotionStreak:setFastMode(bool_bFastMode)
end
--[[
	Set stroke.
	@param stroke The width of stroke.
]]
function cc.MotionStreak:setStroke(float_stroke)
end
--[[
...
function cc.MotionStreak:create(float_timeToFade, float_minSeg, float_strokeWidth, const_Color3B_strokeColor, const_std_string_imagePath)
end
--[[
...
function cc.MotionStreak:create(float_timeToFade, float_minSeg, float_strokeWidth, const_Color3B_strokeColor, Texture2D_texture)
end
...
function cc.NodeGrid:setGridRect(const_Rect_gridRect)
end
--[[
	Set the Grid Target.
	@param target A Node is used to set the Grid Target.
]]
function cc.NodeGrid:setTarget(Node_target)
end
--[[
	Changes a grid object that is used when applying effects.
	@param grid  A Grid object that is used when applying effects.
]]
function cc.NodeGrid:setGrid(GridBase_grid)
end
--[[
	Get a Grid Node.
...
function cc.NodeGrid:getGridRect()
end
--[[
	Create a Grid Node.
...
function cc.ParticleBatchNode:setTexture(Texture2D_texture)
end
--[[
	initializes the particle system with Texture2D, a capacity of particles
	@return bool
]]
function cc.ParticleBatchNode:initWithTexture(Texture2D_tex, int_capacity)
end
--[[
	Disables a particle by inserting a 0'd quad into the texture atlas.
	@param particleIndex The index of the particle.
]]
function cc.ParticleBatchNode:disableParticle(int_particleIndex)
end
--[[
	@return [luaIde#cc.Texture2D]
]]
...
function cc.ParticleBatchNode:setTextureAtlas(TextureAtlas_atlas)
end
--[[
	initializes the particle system with the name of a file on disk (for a list of supported formats look at the Texture2D class), a capacity of particles
	@return bool
]]
function cc.ParticleBatchNode:initWithFile(const_std_string_fileImage, int_capacity)
end
--[[
	@code
	When this function bound into js or lua,the parameter will be changed
...
function cc.ParticleBatchNode:setBlendFunc(const_BlendFunc_blendFunc)
end
function cc.ParticleBatchNode:removeAllChildrenWithCleanup(bool_doCleanup)
end
--[[
...
function cc.ParticleBatchNode:insertChild(ParticleSystem_system, int_index)
end
--[[
...
function cc.ParticleBatchNode:removeChildAtIndex(int_index, bool_doCleanup)
end
--[[
...
function cc.ParticleBatchNode:create(const_std_string_fileImage, int_capacity)
end
--[[
...
function cc.ParticleBatchNode:createWithTexture(Texture2D_tex, int_capacity)
end

cc.ParticleData = {}
function cc.ParticleData:release()
end
--[[
	@return int
]]
function cc.ParticleData:getMaxCount()
end
--[[
	@return bool
]]
function cc.ParticleData:init(int_count)
end
function cc.ParticleData:copyParticle(int_p1, int_p2)
end
...
function cc.ParticleSystem:setPosVar(const_Vec2_pos)
end
--[[
...
function cc.ParticleSystem:setRotatePerSecondVar(float_degrees)
end
--[[
	@} end of PlayableProtocol
]]
function cc.ParticleSystem:setSourcePositionCompatible(bool_sourcePositionCompatible)
end
--[[
...
function cc.ParticleSystem:setTangentialAccel(float_t)
end
--[[
...
function cc.ParticleSystem:setStartRadius(float_startRadius)
end
--[[
...
function cc.ParticleSystem:setRotatePerSecond(float_degrees)
end
--[[
	Sets the end size in pixels of each particle.
	@param endSize The end size in pixels of each particle.
]]
function cc.ParticleSystem:setEndSize(float_endSize)
end
--[[
	Gets the gravity.
...
function cc.ParticleSystem:resumeEmissions()
end
--[[
...
function cc.ParticleSystem:setEndRadius(float_endRadius)
end
--[[
	Gets the speed.
...
function cc.ParticleSystem:pauseEmissions()
end
--[[
...
function cc.ParticleSystem:setEndColor(const_Color4F_color)
end
--[[
	Sets the start spin of each particle.
	@param spin The start spin of each particle.
]]
function cc.ParticleSystem:setStartSpin(float_spin)
end
--[[
...
function cc.ParticleSystem:setDuration(float_duration)
end
--[[
	@return bool
]]
function cc.ParticleSystem:initWithTotalParticles(int_numberOfParticles)
end
function cc.ParticleSystem:addParticles(int_count)
end
function cc.ParticleSystem:setTexture(Texture2D_texture)
end
--[[
...
function cc.ParticleSystem:setPositionType(PositionType_type)
end
...
function cc.ParticleSystem:setStartSpinVar(float_pinVar)
end
--[[
...
function cc.ParticleSystem:setAtlasIndex(int_index)
end
--[[
	Sets the tangential acceleration variance.
	@param t The tangential acceleration variance.
]]
function cc.ParticleSystem:setTangentialAccelVar(float_t)
end
--[[
	Sets the end radius variance.
	@param endRadiusVar The end radius variance.
]]
function cc.ParticleSystem:setEndRadiusVar(float_endRadiusVar)
end
--[[
	Gets the end radius.
...
function cc.ParticleSystem:setRadialAccelVar(float_t)
end
--[[
	Sets the start size in pixels of each particle.
	@param startSize The start size in pixels of each particle.
]]
function cc.ParticleSystem:setStartSize(float_startSize)
end
--[[
	Sets the speed.
	@param speed The speed.
]]
function cc.ParticleSystem:setSpeed(float_speed)
end
--[[
...
function cc.ParticleSystem:getResourceFile()
end
--[[
...
function cc.ParticleSystem:setEmitterMode(Mode_mode)
end
--[[
...
function cc.ParticleSystem:setSourcePosition(const_Vec2_pos)
end
function cc.ParticleSystem:stop()
end
--[[
	Update the verts position data of particle,
	should be overridden by subclasses.
]]
function cc.ParticleSystem:updateParticleQuads()
end
--[[
...
function cc.ParticleSystem:setEndSpinVar(float_endSpinVar)
end
--[[
...
function cc.ParticleSystem:initWithFile(const_std_string_plistFile)
end
--[[
...
function cc.ParticleSystem:setStartColor(const_Color4F_color)
end
--[[
...
function cc.ParticleSystem:isPaused()
end
--[[
	Sets the speed variance.
	@param speed The speed variance.
]]
function cc.ParticleSystem:setSpeedVar(float_speed)
end
--[[
	Set the particle system auto removed it self on finish.
	@param var True if the particle system removed self on finish.
]]
function cc.ParticleSystem:setAutoRemoveOnFinish(bool_var)
end
--[[
	Sets the gravity.
	@param g The gravity.
]]
function cc.ParticleSystem:setGravity(const_Vec2_g)
end
--[[
...
function cc.ParticleSystem:setEmissionRate(float_rate)
end
--[[
...
function cc.ParticleSystem:setStartSizeVar(float_sizeVar)
end
--[[
...
function cc.ParticleSystem:setStartColorVar(const_Color4F_color)
end
--[[
	Sets the end spin of each particle.
	@param endSpin The end spin of each particle.
]]
function cc.ParticleSystem:setEndSpin(float_endSpin)
end
--[[
	Sets the radial acceleration.
	@param t The radial acceleration.
]]
function cc.ParticleSystem:setRadialAccel(float_t)
end
--[[
...
function cc.ParticleSystem:initWithDictionary(ValueMap_dictionary)
end
--[[
...
function cc.ParticleSystem:initWithDictionary(ValueMap_dictionary, const_std_string_dirname)
end
--[[
...
function cc.ParticleSystem:isSourcePositionCompatible()
end
--[[
...
function cc.ParticleSystem:setStartRadiusVar(float_startRadiusVar)
end
--[[
	@code
	When this function bound into js or lua,the parameter will be changed
...
function cc.ParticleSystem:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.ParticleSystem:create(const_std_string_plistFile)
end
--[[
...
function cc.ParticleSystem:createWithTotalParticles(int_numberOfParticles)
end
--[[
	Gets all ParticleSystem references
	@return [luaIde#Vector__ParticleSystem__]
]]
function cc.ParticleSystem:getAllParticleSystems()
end
...
function cc.ParticleSystemQuad:setDisplayFrame(SpriteFrame_spriteFrame)
end
--[[
...
function cc.ParticleSystemQuad:setTextureWithRect(Texture2D_texture, const_Rect_rect)
end
--[[
...
function cc.ParticleSystemQuad:listenRendererRecreated(EventCustom_event)
end
--[[
	Creates a Particle Emitter.
	@return [luaIde#cc.ParticleSystemQuad]   An autoreleased ParticleSystemQuad object.
]]
function cc.ParticleSystemQuad:create()
end
--[[
...
function cc.ParticleSystemQuad:create(const_std_string_filename)
end
--[[
...
function cc.ParticleSystemQuad:create(ValueMap_dictionary)
end
--[[
...
function cc.ParticleSystemQuad:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleFire:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleFireworks:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleSun:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleGalaxy:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleFlower:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleMeteor:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleSpiral:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleExplosion:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleSmoke:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleSnow:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ParticleRain:createWithTotalParticles(int_numberOfParticles)
end
...
function cc.ProgressTimer:initWithSprite(Sprite_sp)
end
--[[
...
function cc.ProgressTimer:setBarChangeRate(const_Vec2_barChangeRate)
end
--[[
...
function cc.ProgressTimer:setSprite(Sprite_sprite)
end
--[[
...
function cc.ProgressTimer:setMidpoint(const_Vec2_point)
end
--[[
...
function cc.ProgressTimer:setReverseDirection(bool_value)
end
--[[
...
function cc.ProgressTimer:setPercentage(float_percentage)
end
--[[
	Set the ProgressTimer type.
	@param type Is an Type.
]]
function cc.ProgressTimer:setType(Type_type)
end
--[[
...
function cc.ProgressTimer:create(Sprite_sp)
end
...
function cc.ProtectedNode:addProtectedChild(Node__child)
end
--[[
	Adds a child to the container with a local z-order.
	If the child is added to a 'running' node, then 'onEnter' and 'onEnterTransitionDidFinish' will be called immediately.
...
function cc.ProtectedNode:addProtectedChild(Node__child, int_localZOrder)
end
--[[
	Adds a child to the container with z order and tag.
	If the child is added to a 'running' node, then 'onEnter' and 'onEnterTransitionDidFinish' will be called immediately.
...
function cc.ProtectedNode:addProtectedChild(Node_child, int_localZOrder, int_tag)
end
...
function cc.ProtectedNode:removeProtectedChildByTag(int_tag, bool_cleanup)
end
--[[
	Reorders a child according to a new z value.
	@param child     An already added child node. It MUST be already added.
...
function cc.ProtectedNode:reorderProtectedChild(Node__child, int_localZOrder)
end
--[[
...
function cc.ProtectedNode:removeAllProtectedChildrenWithCleanup(bool_cleanup)
end
...
function cc.ProtectedNode:getProtectedChildByTag(int_tag)
end
--[[
	Removes a child from the container. It will also cleanup all running actions depending on the cleanup parameter.
	@param child     The child node which will be removed.
...
function cc.ProtectedNode:removeProtectedChild(Node_child, bool_cleanup)
end
--[[
	Removes all children from the container with a cleanup.
	@see `removeAllChildrenWithCleanup(bool)`.
...
function cc.Sprite:setSpriteFrame(const_std_string_spriteFrameName)
end
--[[
...
function cc.Sprite:setTexture(const_std_string_filename)
end
--[[
	@overload
	The Texture's rect is not changed.
]]
function cc.Sprite:setTexture(Texture2D_texture)
end
--[[
...
function cc.Sprite:setFlippedY(bool_flippedY)
end
--[[
	Sets whether the sprite should be flipped horizontally or not.
	@param flippedX true if the sprite should be flipped horizontally, false otherwise.
]]
function cc.Sprite:setFlippedX(bool_flippedX)
end
--[[
	@return int
]]
function cc.Sprite:getResourceType()
end
--[[
	Changes the display frame with animation name and index.
	The animation name will be get from the AnimationCache.
]]
function cc.Sprite:setDisplayFrameWithAnimationName(const_std_string_animationName, ssize_t_frameIndex)
end
--[[
...
function cc.Sprite:getCenterRect()
end
function cc.Sprite:removeAllChildrenWithCleanup(bool_cleanup)
end
--[[
...
function cc.Sprite:setCenterRectNormalized(const_Rect_rect)
end
--[[
	returns whether or not contentSize stretches the sprite's texture
	@return bool
]]
function cc.Sprite:isStretchEnabled()
end
--[[
...
function cc.Sprite:setTextureRect(const_Rect_rect)
end
--[[
	@overload
	It will update the texture coordinates and the vertex rectangle.
]]
function cc.Sprite:setTextureRect(const_Rect_rect, bool_rotated, const_Size_untrimmedSize)
end
--[[
...
function cc.Sprite:initWithSpriteFrameName(const_std_string_spriteFrameName)
end
--[[
	whether or not contentSize stretches the sprite's texture
]]
function cc.Sprite:setStretchEnabled(bool_enabled)
end
--[[
	Returns whether or not a SpriteFrame is being displayed.
	@return bool
]]
function cc.Sprite:isFrameDisplayed(SpriteFrame_frame)
end
--[[
...
function cc.Sprite:setBatchNode(SpriteBatchNode_spriteBatchNode)
end
--[[
	@js  NA
	@lua NA
...
function cc.Sprite:setCenterRect(const_Rect_rect)
end
--[[
	Sets the weak reference of the TextureAtlas when the sprite is rendered using via SpriteBatchNode.
]]
function cc.Sprite:setTextureAtlas(TextureAtlas_textureAtlas)
end
--[[
...
function cc.Sprite:getResourceName()
end
--[[
...
function cc.Sprite:getCenterRectNormalized()
end
--[[
	Sets the index used on the TextureAtlas.
	@warning Don't modify this value unless you know what you are doing.
]]
function cc.Sprite:setAtlasIndex(ssize_t_atlasIndex)
end
--[[
...
function cc.Sprite:initWithTexture(Texture2D_texture)
end
--[[
...
function cc.Sprite:initWithTexture(Texture2D_texture, const_Rect_rect)
end
--[[
...
function cc.Sprite:initWithTexture(Texture2D_texture, const_Rect_rect, bool_rotated)
end
--[[
	Makes the Sprite to be updated in the Atlas.
]]
function cc.Sprite:setDirty(bool_dirty)
end
--[[
...
function cc.Sprite:initWithFile(const_std_string_filename)
end
--[[
...
function cc.Sprite:initWithFile(const_std_string_filename, const_Rect_rect)
end
--[[
	@code
	When this function bound into js or lua,the parameter will be changed.
...
function cc.Sprite:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.Sprite:initWithSpriteFrame(SpriteFrame_spriteFrame)
end
--[[
...
function cc.Sprite:setVertexRect(const_Rect_rect)
end
--[[
...
function cc.Sprite:createWithTexture(Texture2D_texture)
end
--[[
...
function cc.Sprite:createWithTexture(Texture2D_texture, const_Rect_rect, bool_rotated)
end
--[[
...
function cc.Sprite:createWithSpriteFrameName(const_std_string_spriteFrameName)
end
--[[
...
function cc.Sprite:createWithSpriteFrame(SpriteFrame_spriteFrame)
end
...
function cc.RenderTexture:setVirtualViewport(const_Vec2_rtBegin, const_Rect_fullRect, const_Rect_fullViewport)
end
--[[
	Clears the texture with a specified stencil value.
	@param stencilValue A specified stencil value.
]]
function cc.RenderTexture:clearStencil(int_stencilValue)
end
--[[
...
function cc.RenderTexture:setClearStencil(int_clearStencil)
end
--[[
	Sets the Sprite being used.
	@param sprite A Sprite.
]]
function cc.RenderTexture:setSprite(Sprite_sprite)
end
--[[
...
function cc.RenderTexture:setKeepMatrix(bool_keepMatrix)
end
--[[
	Set flags.
	@param clearFlags Valid flags: GL_COLOR_BUFFER_BIT, GL_DEPTH_BUFFER_BIT, GL_STENCIL_BUFFER_BIT.
]]
function cc.RenderTexture:setClearFlags(unsigned_int_clearFlags)
end
--[[
	Starts grabbing.
]]
...
function cc.RenderTexture:saveToFile(const_std_string_filename, bool_isRGBA)
end
--[[
...
function cc.RenderTexture:saveToFile(const_std_string_filename, Image_Format_format, bool_isRGBA)
end
--[[
...
function cc.RenderTexture:setAutoDraw(bool_isAutoDraw)
end
--[[
	Set color value.
	@param clearColor Color value.
]]
function cc.RenderTexture:setClearColor(const_Color4F_clearColor)
end
--[[
...
function cc.RenderTexture:beginWithClear(float_r, float_g, float_b, float_a)
end
--[[
	Starts rendering to the texture while clearing the texture first.
	This is more efficient then calling -clear first and then -begin.
...
function cc.RenderTexture:beginWithClear(float_r, float_g, float_b, float_a, float_depthValue)
end
--[[
	Starts rendering to the texture while clearing the texture first.
	This is more efficient then calling -clear first and then -begin.
...
function cc.RenderTexture:beginWithClear(float_r, float_g, float_b, float_a, float_depthValue, int_stencilValue)
end
function cc.RenderTexture:beginWithClear(float_r, float_g, float_b, float_a, float_depthValue, int_stencilValue, GLbitfield_flags)
end
--[[
	Clears the texture with a specified depth value.
	@param depthValue A specified depth value.
]]
function cc.RenderTexture:clearDepth(float_depthValue)
end
--[[
...
function cc.RenderTexture:clear(float_r, float_g, float_b, float_a)
end
--[[
...
function cc.RenderTexture:newImage(bool_flipImage)
end
--[[
	Set Value for clearDepth.
	@param clearDepth Value for clearDepth.
]]
function cc.RenderTexture:setClearDepth(float_clearDepth)
end
--[[
...
function cc.RenderTexture:initWithWidthAndHeight(int_w, int_h, Texture2D_PixelFormat_format)
end
--[[
...
function cc.RenderTexture:initWithWidthAndHeight(int_w, int_h, Texture2D_PixelFormat_format, GLuint_depthStencilFormat)
end
--[[
	Initializes a RenderTexture object with width and height in Points and a pixel format( only RGB and RGBA formats are valid ) and depthStencil format.
	@param w The RenderTexture object width.
...
function cc.RenderTexture:create(int_w, int_h, Texture2D_PixelFormat_format, GLuint_depthStencilFormat)
end
--[[
...
function cc.RenderTexture:create(int_w, int_h, Texture2D_PixelFormat_format)
end
--[[
...
function cc.RenderTexture:create(int_w, int_h)
end
...
function cc.TransitionEaseScene:easeActionWithAction(ActionInterval__action)
end
...
function cc.TransitionScene:initWithDuration(float_t, Scene_scene)
end
--[[
	@return float
]]
...
function cc.TransitionScene:create(float_t, Scene_scene)
end
...
function cc.TransitionSceneOriented:initWithDuration(float_t, Scene_scene, Orientation_orientation)
end
--[[
...
function cc.TransitionSceneOriented:create(float_t, Scene_scene, Orientation_orientation)
end
...
function cc.TransitionRotoZoom:create(float_t, Scene_scene)
end
...
function cc.TransitionJumpZoom:create(float_t, Scene_scene)
end
...
function cc.TransitionMoveInL:easeActionWithAction(ActionInterval__action)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionMoveInL:create(float_t, Scene_scene)
end
...
function cc.TransitionMoveInR:create(float_t, Scene_scene)
end
...
function cc.TransitionMoveInT:create(float_t, Scene_scene)
end
...
function cc.TransitionMoveInB:create(float_t, Scene_scene)
end
...
function cc.TransitionSlideInL:easeActionWithAction(ActionInterval__action)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionSlideInL:create(float_t, Scene_scene)
end
...
function cc.TransitionSlideInR:create(float_t, Scene_scene)
end
...
function cc.TransitionSlideInB:create(float_t, Scene_scene)
end
...
function cc.TransitionSlideInT:create(float_t, Scene_scene)
end
...
function cc.TransitionShrinkGrow:easeActionWithAction(ActionInterval__action)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionShrinkGrow:create(float_t, Scene_scene)
end
...
function cc.TransitionFlipX:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionFlipX:create(float_t, Scene_s)
end
...
function cc.TransitionFlipY:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionFlipY:create(float_t, Scene_s)
end
...
function cc.TransitionFlipAngular:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionFlipAngular:create(float_t, Scene_s)
end
...
function cc.TransitionZoomFlipX:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionZoomFlipX:create(float_t, Scene_s)
end
...
function cc.TransitionZoomFlipY:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionZoomFlipY:create(float_t, Scene_s)
end
...
function cc.TransitionZoomFlipAngular:create(float_t, Scene_s, Orientation_o)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionZoomFlipAngular:create(float_t, Scene_s)
end
...
function cc.TransitionFade:initWithDuration(float_t, Scenescene, const_Color3B_color)
end
--[[
...
function cc.TransitionFade:create(float_duration, Scene_scene, const_Color3B_color)
end
--[[
...
function cc.TransitionFade:create(float_duration, Scene_scene)
end
...
function cc.TransitionCrossFade:create(float_t, Scene_scene)
end
...
function cc.TransitionTurnOffTiles:easeActionWithAction(ActionInterval__action)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionTurnOffTiles:create(float_t, Scene_scene)
end
...
function cc.TransitionSplitCols:easeActionWithAction(ActionInterval__action)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionSplitCols:create(float_t, Scene_scene)
end
...
function cc.TransitionSplitRows:create(float_t, Scene_scene)
end
...
function cc.TransitionFadeTR:easeActionWithAction(ActionInterval__action)
end
--[[
...
function cc.TransitionFadeTR:actionWithSize(const_Size_size)
end
--[[
	Creates a transition with duration and incoming scene.
	@param t Duration time, in seconds.
...
function cc.TransitionFadeTR:create(float_t, Scene_scene)
end
...
function cc.TransitionFadeBL:create(float_t, Scene_scene)
end
...
function cc.TransitionFadeUp:create(float_t, Scene_scene)
end
...
function cc.TransitionFadeDown:create(float_t, Scene_scene)
end
...
function cc.TransitionPageTurn:actionWithSize(const_Size_vector)
end
--[[
	Creates a base transition with duration and incoming scene.
...
function cc.TransitionPageTurn:initWithDuration(float_t, Scene_scene, bool_backwards)
end
--[[
	Creates a base transition with duration and incoming scene.
	If back is true then the effect is reversed to appear as if the incoming
...
function cc.TransitionPageTurn:create(float_t, Scene_scene, bool_backwards)
end
...
function cc.TransitionProgress:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressRadialCCW:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressRadialCW:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressHorizontal:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressVertical:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressInOut:create(float_t, Scene_scene)
end
...
function cc.TransitionProgressOutIn:create(float_t, Scene_scene)
end
...
function cc.Camera:setBackgroundBrush(CameraBackgroundBrush_clearBrush)
end
--[[
...
function cc.Camera:lookAt(const_Vec3_target, const_Vec3_up)
end
--[[
...
function cc.Camera:getBackgroundBrush()
end
--[[
...
function cc.Camera:isBrushValid()
end
--[[
	Get object depth towards camera
	@return float
]]
function cc.Camera:getDepthInView(const_Mat4_transform)
end
function cc.Camera:restoreViewport()
end
--[[
	Before rendering scene with this camera, the background need to be cleared. It clears the depth buffer with max depth by default. Use setBackgroundBrush to modify the default behavior
]]
function cc.Camera:clearBackground()
end
--[[
	set additional matrix for the projection matrix, it multiplies mat to projection matrix when called, used by WP
]]
function cc.Camera:setAdditionalProjection(const_Mat4_mat)
end
--[[
	Set Viewport for camera.
]]
function cc.Camera:setViewport(const_experimental_Viewport_vp)
end
--[[
	init camera
	@return bool
...
function cc.Camera:initOrthographic(float_zoomX, float_zoomY, float_nearPlane, float_farPlane)
end
--[[
	get rendered order
	@return int
...
function cc.Camera:isVisibleInFrustum(const_AABB_aabb)
end
--[[
	set depth, camera with larger depth is drawn on top of camera with smaller depth, the depth of camera with CameraFlag::DEFAULT is 0, user defined camera is -1 by default
]]
function cc.Camera:setDepth(int8_t_depth)
end
--[[
	Set the scene,this method shall not be invoke manually
]]
function cc.Camera:setScene(Scene_scene)
end
--[[
...
function cc.Camera:projectGL(const_Vec3_src)
end
function cc.Camera:restoreFrameBufferObject()
end
--[[
...
function cc.Camera:project(const_Vec3_src)
end
function cc.Camera:setCameraFlag(CameraFlag_flag)
end
--[[
...
function cc.Camera:setFrameBufferObject(experimental_FrameBuffer_fbo)
end
--[[
...
function cc.Camera:isViewProjectionUpdated()
end
--[[
	@return bool
]]
function cc.Camera:initPerspective(float_fieldOfView, float_aspectRatio, float_nearPlane, float_farPlane)
end
--[[
...
function cc.Camera:createOrthographic(float_zoomX, float_zoomY, float_nearPlane, float_farPlane)
end
--[[
...
function cc.Camera:createPerspective(float_fieldOfView, float_aspectRatio, float_nearPlane, float_farPlane)
end
--[[
...
function cc.Camera:setDefaultViewport(const_experimental_Viewport_vp)
end
--[[
...
function cc.CameraBackgroundBrush:getBrushType()
end
function cc.CameraBackgroundBrush:drawBackground(Camera_camera)
end
--[[
	@return bool
]]
function cc.CameraBackgroundBrush:init()
end
--[[
	@return bool
]]
function cc.CameraBackgroundBrush:isValid()
end
--[[
...
function cc.CameraBackgroundBrush:createColorBrush(const_Color4F_color, float_depth)
end
--[[
	Creates a none brush, it does nothing when clear the background
	@return [luaIde#cc.CameraBackgroundBrush]   Created brush.
]]
function cc.CameraBackgroundBrush:createNoneBrush()
end
--[[
...
function cc.CameraBackgroundBrush:createDepthBrush(float_depth)
end
...
function cc.CameraBackgroundDepthBrush:setDepth(float_depth)
end
--[[
...
function cc.CameraBackgroundDepthBrush:create(float_depth)
end
...
function cc.CameraBackgroundColorBrush:setColor(const_Color4F_color)
end
--[[
...
function cc.CameraBackgroundColorBrush:create(const_Color4F_color, float_depth)
end
...
function cc.CameraBackgroundSkyBoxBrush:setTextureValid(bool_valid)
end
--[[
	Set skybox texture
	@param texture Skybox texture
]]
function cc.CameraBackgroundSkyBoxBrush:setTexture(TextureCube__texture)
end
function cc.CameraBackgroundSkyBoxBrush:setActived(bool_actived)
end
--[[
	@return bool
]]
function cc.CameraBackgroundSkyBoxBrush:isActived()
end
--[[
	Creates a Skybox brush with 6 textures.
	@return [luaIde#cc.CameraBackgroundSkyBoxBrush]
]]
function cc.CameraBackgroundSkyBoxBrush:create()
end
...
function cc.GridBase:setGridSize(const_Size_gridSize)
end
--[[
	@brief Set the effect grid rect.
	@param rect The effect grid rect.
]]
function cc.GridBase:setGridRect(const_Rect_rect)
end
...
function cc.GridBase:getGridRect()
end
function cc.GridBase:afterDraw(Node_target)
end
--[[
	@{
...
function cc.GridBase:setStep(const_Vec2_step)
end
--[[
	Set the texture flipped or not
]]
function cc.GridBase:setTextureFlipped(bool_flipped)
end
--[[
...
function cc.GridBase:setActive(bool_active)
end
--[[
...
function cc.GridBase:initWithSize(const_Size_gridSize)
end
--[[
	@return bool
]]
function cc.GridBase:initWithSize(const_Size_gridSize, Texture2D_texture, bool_flipped)
end
--[[
	@{
...
function cc.GridBase:setReuseGrid(int_reuseGrid)
end
--[[
	@{
...
function cc.GridBase:create(const_Size_gridSize, Texture2D_texture, bool_flipped)
end
--[[
	create one Grid
	@return [luaIde#cc.GridBase]
]]
function cc.GridBase:create(const_Size_gridSize)
end
...
function cc.Grid3D:setNeedDepthTestForBlit(bool_neededDepthTest)
end
--[[
	create one Grid.
	@return [luaIde#cc.Grid3D]
]]
function cc.Grid3D:create(const_Size_gridSize)
end
--[[
	create one Grid.
	@return [luaIde#cc.Grid3D]
]]
function cc.Grid3D:create(const_Size_gridSize, const_Rect_rect)
end
--[[
	create one Grid.
	@return [luaIde#cc.Grid3D]
]]
function cc.Grid3D:create(const_Size_gridSize, Texture2D_texture, bool_flipped)
end
--[[
	create one Grid.
	@return [luaIde#cc.Grid3D]
]]
function cc.Grid3D:create(const_Size_gridSize, Texture2D_texture, bool_flipped, const_Rect_rect)
end
...
function cc.TiledGrid3D:create(const_Size_gridSize)
end
--[[
	Create one Grid.
	@return [luaIde#cc.TiledGrid3D]
]]
function cc.TiledGrid3D:create(const_Size_gridSize, const_Rect_rect)
end
--[[
	Create one Grid.
	@return [luaIde#cc.TiledGrid3D]
]]
function cc.TiledGrid3D:create(const_Size_gridSize, Texture2D_texture, bool_flipped)
end
--[[
	Create one Grid.
	@return [luaIde#cc.TiledGrid3D]
]]
function cc.TiledGrid3D:create(const_Size_gridSize, Texture2D_texture, bool_flipped, const_Rect_rect)
end
...
function cc.BaseLight:setEnabled(bool_enabled)
end
--[[
...
function cc.BaseLight:setLightFlag(LightFlag_flag)
end
function cc.BaseLight:setIntensity(float_intensity)
end
--[[
...
function cc.DirectionLight:setDirection(const_Vec3_dir)
end
--[[
...
function cc.DirectionLight:create(const_Vec3_direction, const_Color3B_color)
end
...
function cc.PointLight:setRange(float_range)
end
--[[
...
function cc.PointLight:create(const_Vec3_position, const_Color3B_color, float_range)
end
...
function cc.SpotLight:setDirection(const_Vec3_dir)
end
--[[
	get cos innerAngle
	@return float
...
function cc.SpotLight:setOuterAngle(float_outerAngle)
end
--[[
	Sets the inner angle of a spot light (in radians).
	@param angle The angle of spot light (in radians).
]]
function cc.SpotLight:setInnerAngle(float_angle)
end
--[[
	Returns direction in world.
	@return [luaIde#cc.Vec3]
...
function cc.SpotLight:setRange(float_range)
end
--[[
...
function cc.SpotLight:create(const_Vec3_direction, const_Vec3_position, const_Color3B_color, float_innerAngle, float_outerAngle, float_range)
end
...
function cc.AmbientLight:create(const_Color3B_color)
end
...
function cc.GLProgram:initWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray)
end
--[[
	@return bool
]]
function cc.GLProgram:initWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray, const_std_string_compileTimeDefines)
end
--[[
	@return bool
]]
function cc.GLProgram:initWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray, const_std_string_compileTimeHeaders, const_std_string_compileTimeDefines)
end
--[[
	@return bool
]]
function cc.GLProgram:initWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename)
end
--[[
	@return bool
]]
function cc.GLProgram:initWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename, const_std_string_compileTimeDefines)
end
--[[
	@return bool
]]
function cc.GLProgram:initWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename, const_std_string_compileTimeHeaders, const_std_string_compileTimeDefines)
end
--[[
...
function cc.GLProgram:setUniformsForBuiltins(const_Mat4_modelView)
end
--[[
	Update the builtin uniforms if they are different than the previous call for this same shader program.
]]
...
function cc.GLProgram:bindAttribLocation(const_std_string_attributeName, GLuint_index)
end
--[[
	Calls glGetAttribLocation.
	@return [luaIde#GLint]
]]
function cc.GLProgram:getAttribLocation(const_std_string_attributeName)
end
--[[
	links the glProgram
	@return bool
...
function cc.GLProgram:createWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray)
end
--[[
	@return [luaIde#cc.GLProgram]
]]
function cc.GLProgram:createWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray, const_std_string_compileTimeDefines)
end
--[[
	@{
...
function cc.GLProgram:createWithByteArrays(const_GLchar_vShaderByteArray, const_GLchar_fShaderByteArray, const_std_string_compileTimeHeaders, const_std_string_compileTimeDefines)
end
--[[
	@{
...
function cc.GLProgram:createWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename)
end
--[[
	@return [luaIde#cc.GLProgram]
]]
function cc.GLProgram:createWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename, const_std_string_compileTimeDefines)
end
--[[
	@{
...
function cc.GLProgram:createWithFilenames(const_std_string_vShaderFilename, const_std_string_fShaderFilename, const_std_string_compileTimeHeaders, const_std_string_compileTimeDefines)
end
...
function cc.GLProgramCache:reloadDefaultGLProgramsRelativeToLights()
end
--[[
	adds a GLProgram to the cache for a given name
]]
function cc.GLProgramCache:addGLProgram(GLProgram_program, const_std_string_key)
end
--[[
...
function cc.GLProgramCache:getGLProgram(const_std_string_key)
end
--[[
...
function cc.RenderState:setTexture(Texture2D_texture)
end
--[[
	Returns the topmost RenderState in the hierarchy below the given RenderState.
	@return [luaIde#cc.RenderState]
]]
function cc.RenderState:getTopmost(RenderState_below)
end
--[[
...
function cc.RenderState:bind(Pass_pass)
end
--[[
...
function cc.RenderState:setParent(RenderState_parent)
end
--[[
...
function cc.Pass:bind(const_Mat4_modelView)
end
--[[
...
function cc.Pass:setVertexAttribBinding(VertexAttribBinding_binding)
end
--[[
	@return [luaIde#cc.Pass]
]]
function cc.Pass:create(Technique_parent)
end
--[[
	Creates a Pass with a GLProgramState.
	@return [luaIde#cc.Pass]
]]
function cc.Pass:createWithGLProgramState(Technique_parent, GLProgramState_programState)
end
...
function cc.Technique:addPass(Pass_pass)
end
--[[
...
function cc.Technique:getPassByIndex(ssize_t_index)
end
--[[
	@return [luaIde#cc.Technique]
]]
function cc.Technique:create(Material_parent)
end
--[[
...
function cc.Technique:createWithGLProgramState(Material_parent, GLProgramState_state)
end
...
function cc.Material:setName(const_std_string_name)
end
--[[
...
function cc.Material:getTechniqueByIndex(ssize_t_index)
end
--[[
	@return std_string
]]
...
function cc.Material:setTechnique(const_std_string_techniqueName)
end
--[[
...
function cc.Material:getTechniqueByName(const_std_string_name)
end
--[[
	Adds a Technique into the Material
]]
function cc.Material:addTechnique(Technique_technique)
end
--[[
...
function cc.Material:createWithFilename(const_std_string_path)
end
--[[
...
function cc.Material:createWithGLStateProgram(GLProgramState_programState)
end
--[[
...
function cc.Material:createWithProperties(Properties_materialProperties)
end
...
function cc.TextureCache:reloadTexture(const_std_string_fileName)
end
--[[
...
function cc.TextureCache:removeTextureForKey(const_std_string_key)
end
--[[
...
function cc.TextureCache:addImage(const_std_string_filepath)
end
--[[
...
function cc.TextureCache:addImage(Image_image, const_std_string_key)
end
--[[
...
function cc.TextureCache:unbindImageAsync(const_std_string_filename)
end
--[[
...
function cc.TextureCache:getTextureForKey(const_std_string_key)
end
--[[
...
function cc.TextureCache:getTextureFilePath(Texture2D_texture)
end
--[[
...
function cc.TextureCache:renameTextureWithKey(const_std_string_srcName, const_std_string_dstName)
end
--[[
...
function cc.TextureCache:removeTexture(Texture2D_texture)
end
--[[
...
function cc.TextureCache:setETC1AlphaFileSuffix(const_std_string_suffix)
end
--[[
	@return std_string
]]
function cc.TextureCache:getETC1AlphaFileSuffix()
end
...
function cc.Device:setAccelerometerEnabled(bool_isEnabled)
end
--[[
	Sets the interval of accelerometer.
]]
function cc.Device:setAccelerometerInterval(float_interval)
end
--[[
	Controls whether the screen should remain on.
	@param keepScreenOn One flag indicating that the screen should remain on.
]]
function cc.Device:setKeepScreenOn(bool_keepScreenOn)
end
--[[
...
function cc.Device:vibrate(float_duration)
end
--[[
...
function cc.Application:openURL(const_std_string_url)
end
--[[
	@brief Get application version.
	@return std_string
]]
function cc.Application:getVersion()
end
--[[
	@brief    Callback by Director to limit FPS.
	@param interval The time, expressed in seconds, between current frame and next.
]]
function cc.Application:setAnimationInterval(float_interval)
end
--[[
...
function cc.GLViewImpl:createWithRect(const_std_string_viewName, Rect_rect, float_frameZoomFactor)
end
--[[
	static function
	@return [luaIde#cc.GLViewImpl]
]]
function cc.GLViewImpl:create(const_std_string_viewname)
end
--[[
	@return [luaIde#cc.GLViewImpl]
]]
function cc.GLViewImpl:createWithFullScreen(const_std_string_viewName)
end
...
function cc.AnimationCache:getAnimation(const_std_string_name)
end
--[[
...
function cc.AnimationCache:addAnimation(Animation_animation, const_std_string_name)
end
--[[
	@return bool
]]
...
function cc.AnimationCache:addAnimationsWithDictionary(const_ValueMap_dictionary, const_std_string_plist)
end
--[[
	Deletes a Animation from the cache.
	@param name The name of animation.
]]
function cc.AnimationCache:removeAnimation(const_std_string_name)
end
--[[
...
function cc.SpriteBatchNode:appendChild(Sprite_sprite)
end
--[[
	Sprites use this to start sortChildren, don't call this manually.
]]
function cc.SpriteBatchNode:reorderBatch(bool_reorder)
end
--[[
	@return [luaIde#cc.Texture2D]
]]
...
function cc.SpriteBatchNode:setTexture(Texture2D_texture)
end
--[[
...
function cc.SpriteBatchNode:removeChildAtIndex(ssize_t_index, bool_doCleanup)
end
--[[
	Remove a sprite from Atlas.
	@param sprite A Sprite.
]]
function cc.SpriteBatchNode:removeSpriteFromAtlas(Sprite_sprite)
end
--[[
...
function cc.SpriteBatchNode:addSpriteWithoutQuad(Sprite_child, int_z, int_aTag)
end
--[[
...
function cc.SpriteBatchNode:atlasIndexForChild(Sprite_sprite, int_z)
end
--[[
...
function cc.SpriteBatchNode:lowestAtlasIndexInChild(Sprite_sprite)
end
--[[
	@lua NA
	@return [luaIde#cc.BlendFunc]
...
function cc.SpriteBatchNode:initWithTexture(Texture2D_tex, ssize_t_capacity)
end
--[[
	Sets the TextureAtlas object.
	@param textureAtlas The TextureAtlas object.
]]
function cc.SpriteBatchNode:setTextureAtlas(TextureAtlas_textureAtlas)
end
--[[
...
function cc.SpriteBatchNode:reserveCapacity(ssize_t_newCapacity)
end
--[[
	@js NA
]]
function cc.SpriteBatchNode:removeAllChildrenWithCleanup(bool_cleanup)
end
--[[
...
function cc.SpriteBatchNode:insertQuadFromSprite(Sprite_sprite, ssize_t_index)
end
--[[
...
function cc.SpriteBatchNode:initWithFile(const_std_string_fileImage, ssize_t_capacity)
end
--[[
	@code
	When this function bound into js or lua,the parameter will be changed.
...
function cc.SpriteBatchNode:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function cc.SpriteBatchNode:rebuildIndexInOrder(Sprite_parent, ssize_t_index)
end
--[[
...
function cc.SpriteBatchNode:highestAtlasIndexInChild(Sprite_sprite)
end
--[[
...
function cc.SpriteBatchNode:create(const_std_string_fileImage, ssize_t_capacity)
end
--[[
...
function cc.SpriteBatchNode:createWithTexture(Texture2D_tex, ssize_t_capacity)
end
...
function cc.SpriteFrameCache:reloadTexture(const_std_string_plist)
end
--[[
...
function cc.SpriteFrameCache:addSpriteFramesWithFileContent(const_std_string_plist_content, Texture2D_texture)
end
--[[
...
function cc.SpriteFrameCache:addSpriteFrame(SpriteFrame_frame, const_std_string_frameName)
end
--[[
...
function cc.SpriteFrameCache:removeSpriteFramesFromFile(const_std_string_plist)
end
...
function cc.SpriteFrameCache:removeSpriteFramesFromFileContent(const_std_string_plist_content)
end
--[[
	Deletes an sprite frame from the sprite frame cache.
	@param name The name of the sprite frame that needs to removed.
]]
function cc.SpriteFrameCache:removeSpriteFrameByName(const_std_string_name)
end
--[[
...
function cc.SpriteFrameCache:isSpriteFramesWithFileLoaded(const_std_string_plist)
end
--[[
...
function cc.SpriteFrameCache:removeSpriteFramesFromTexture(Texture2D_texture)
end
--[[
...
function cc.ParallaxNode:addChild(Node__child, int_z, const_Vec2_parallaxRatio, const_Vec2_positionOffset)
end
--[[
	
]]
function cc.ParallaxNode:addChild(Node__child, int_zOrder, int_tag)
end
function cc.ParallaxNode:removeAllChildrenWithCleanup(bool_cleanup)
end
--[[
...
function cc.TMXObjectGroup:setPositionOffset(const_Vec2_offset)
end
--[[
...
function cc.TMXObjectGroup:getProperty(const_std_string_propertyName)
end
--[[
...
function cc.TMXObjectGroup:getObject(const_std_string_objectName)
end
--[[
...
function cc.TMXObjectGroup:setGroupName(const_std_string_groupName)
end
--[[
...
function cc.TMXObjectGroup:setProperties(const_ValueMap_properties)
end
--[[
	Sets the array of the objects.
	@param objects The array of the objects.
]]
function cc.TMXObjectGroup:setObjects(const_ValueVector_objects)
end
...
cc.TMXLayerInfo = {}
function cc.TMXLayerInfo:setProperties(ValueMap_properties)
end
--[[
	@return [luaIde#ValueMap]
]]
...
function cc.TMXTilesetInfo:getRectForGID(uint32_t_gid)
end

cc.TMXMapInfo = {}
function cc.TMXMapInfo:setCurrentString(const_std_string_currentString)
end
--[[
	@return int
]]
function cc.TMXMapInfo:getHexSideLength()
end
function cc.TMXMapInfo:setTileSize(const_Size_tileSize)
end
--[[
	initializes a TMX format with a  tmx file
	@return bool
]]
function cc.TMXMapInfo:initWithTMXFile(const_std_string_tmxFile)
end
--[[
	@return int
]]
...
function cc.TMXMapInfo:setObjectGroups()
end
function cc.TMXMapInfo:setLayers()
end
--[[
	initializes parsing of an XML file, either a tmx (Map) file or tsx (Tileset) file
	@return bool
]]
function cc.TMXMapInfo:parseXMLFile(const_std_string_xmlFilename)
end
--[[
	@return int
]]
...
function cc.TMXMapInfo:setTMXFileName(const_std_string_fileName)
end
--[[
	initializes parsing of an XML string, either a tmx (Map) string or tsx (Tileset) string
	@return bool
]]
function cc.TMXMapInfo:parseXMLString(const_std_string_xmlString)
end
--[[
...
function cc.TMXMapInfo:getStaggerAxis()
end
function cc.TMXMapInfo:setHexSideLength(int_hexSideLength)
end
--[[
...
function cc.TMXMapInfo:setParentElement(int_element)
end
--[[
	initializes a TMX format with an XML string and a TMX resource path
	@return bool
]]
function cc.TMXMapInfo:initWithXML(const_std_string_tmxString, const_std_string_resourcePath)
end
function cc.TMXMapInfo:setParentGID(int_gid)
end
--[[
	@return int
]]
...
function cc.TMXMapInfo:getExternalTilesetFileName()
end
--[[
...
function cc.TMXMapInfo:setStaggerIndex(int_staggerIndex)
end
function cc.TMXMapInfo:setProperties(const_ValueMap_properties)
end
function cc.TMXMapInfo:setOrientation(int_orientation)
end
function cc.TMXMapInfo:setTileProperties(const_ValueMapIntKey_tileProperties)
end
function cc.TMXMapInfo:setMapSize(const_Size_mapSize)
end
--[[
	@return std_string
]]
...
function cc.TMXMapInfo:setStoringCharacters(bool_storingCharacters)
end
function cc.TMXMapInfo:setStaggerAxis(int_staggerAxis)
end
--[[
	@return [luaIde#cc.Size]
]]
...
function cc.TMXMapInfo:setTilesets()
end
--[[
	@return [luaIde#ValueMap]
]]
...
function cc.TMXMapInfo:getStaggerIndex()
end
function cc.TMXMapInfo:setLayerAttribs(int_layerAttribs)
end
--[[
	creates a TMX Format with a tmx file
	@return [luaIde#cc.TMXMapInfo]
]]
function cc.TMXMapInfo:create(const_std_string_tmxFile)
end
--[[
	creates a TMX Format with an XML string and a TMX resource path
	@return [luaIde#cc.TMXMapInfo]
]]
function cc.TMXMapInfo:createWithXML(const_std_string_tmxString, const_std_string_resourcePath)
end
...
function cc.TMXLayer:getPositionAt(const_Vec2_tileCoordinate)
end
--[[
...
function cc.TMXLayer:setLayerOrientation(int_orientation)
end
--[[
	Size of the layer in tiles.
	@return [luaIde#cc.Size]   Size of the layer in tiles.
]]
function cc.TMXLayer:getLayerSize()
end
--[[
	Set the size of the map's tile.
	@param size The new size of the map's tile.
]]
function cc.TMXLayer:setMapTileSize(const_Size_size)
end
--[[
	Layer orientation, which is the same as the map orientation.
	@return int   Layer orientation, which is the same as the map orientation.
]]
function cc.TMXLayer:getLayerOrientation()
end
--[[
	Set the properties to the layer.
	@param properties The properties to the layer.
]]
function cc.TMXLayer:setProperties(const_ValueMap_properties)
end
--[[
	Set the tile layer name.
	@param layerName The new layer name.
]]
function cc.TMXLayer:setLayerName(const_std_string_layerName)
end
--[[
	Removes a tile at given tile coordinate.
	@param tileCoordinate The tile Coordinate.
]]
function cc.TMXLayer:removeTileAt(const_Vec2_tileCoordinate)
end
--[[
	@return bool
]]
function cc.TMXLayer:initWithTilesetInfo(TMXTilesetInfo_tilesetInfo, TMXLayerInfo_layerInfo, TMXMapInfo_mapInfo)
end
--[[
	Creates the tiles.
]]
function cc.TMXLayer:setupTiles()
end
--[[
...
function cc.TMXLayer:setTileGID(int_gid, const_Vec2_tileCoordinate)
end
--[[
	Sets the tile gid (gid = tile global id) at a given tile coordinate.
	The Tile GID can be obtained by using the method "tileGIDAt" or by using the TMX editor -> Tileset Mgr +1.
...
function cc.TMXLayer:setTileGID(int_gid, const_Vec2_tileCoordinate, TMXTileFlags_flags)
end
--[[
	Size of the map's tile (could be different from the tile's size).
	@return [luaIde#cc.Size]   Size of the map's tile (could be different from the tile's size).
]]
function cc.TMXLayer:getMapTileSize()
end
--[[
	Return the value for the specific property name.
...
function cc.TMXLayer:getTileAt(const_Vec2_tileCoordinate)
end
--[[
...
function cc.TMXLayer:create(TMXTilesetInfo_tilesetInfo, TMXLayerInfo_layerInfo, TMXMapInfo_mapInfo)
end
--[[
...
function cc.TMXLayer:setupTileSprite(Sprite_sprite, const_Vec2_pos, uint32_t_gid)
end
...
function cc.TMXTiledMap:setObjectGroups()
end
--[[
	Return the value for the specific property name.
	@return [luaIde#Value]   Return the value for the specific property name.
]]
function cc.TMXTiledMap:getProperty(const_std_string_propertyName)
end
--[[
	Set the map's size property measured in tiles.
	@param mapSize The map's size property measured in tiles.
]]
function cc.TMXTiledMap:setMapSize(const_Size_mapSize)
end
--[[
	Return the TMXObjectGroup for the specific group.
	@return [luaIde#cc.TMXObjectGroup]   Return the TMXObjectGroup for the specific group.
]]
function cc.TMXTiledMap:getObjectGroup(const_std_string_groupName)
end
--[[
	Get object groups.
	@return [luaIde#Vector__TMXObjectGroup__]   Object groups.
]]
function cc.TMXTiledMap:getObjectGroups()
end
--[[
	initializes a TMX Tiled Map with a TMX file
	@return bool
]]
function cc.TMXTiledMap:initWithTMXFile(const_std_string_tmxFile)
end
--[[
	The tiles's size property measured in pixels.
	@return [luaIde#cc.Size]   The tiles's size property measured in pixels.
]]
function cc.TMXTiledMap:getTileSize()
end
--[[
	The map's size property measured in tiles.
	@return [luaIde#cc.Size]   The map's size property measured in tiles.
]]
function cc.TMXTiledMap:getMapSize()
end
--[[
	initializes a TMX Tiled Map with a TMX formatted XML string and a path to TMX resources
	@return bool
]]
function cc.TMXTiledMap:initWithXML(const_std_string_tmxString, const_std_string_resourcePath)
end
--[[
	Get properties.
	@return [luaIde#ValueMap]   Properties.
]]
function cc.TMXTiledMap:getProperties()
end
--[[
	Set the tiles's size property measured in pixels.
	@param tileSize The tiles's size property measured in pixels.
]]
function cc.TMXTiledMap:setTileSize(const_Size_tileSize)
end
--[[
	Set properties.
	@param properties An ValueMap Properties.
]]
function cc.TMXTiledMap:setProperties(const_ValueMap_properties)
end
--[[
	Return the FastTMXLayer for the specific layer.
	@return [luaIde#cc.TMXLayer]   Return the FastTMXLayer for the specific layer.
]]
function cc.TMXTiledMap:getLayer(const_std_string_layerName)
end
--[[
	Get map orientation.
	@return int   The map orientation.
]]
function cc.TMXTiledMap:getMapOrientation()
end
--[[
	Set map orientation.
	@param mapOrientation The map orientation.
]]
function cc.TMXTiledMap:setMapOrientation(int_mapOrientation)
end
--[[
	Creates a TMX Tiled Map with a TMX file.
	@return [luaIde#cc.TMXTiledMap]   An autorelease object.
]]
function cc.TMXTiledMap:create(const_std_string_tmxFile)
end
--[[
	Initializes a TMX Tiled Map with a TMX formatted XML string and a path to TMX resources.
...
function cc.TMXTiledMap:createWithXML(const_std_string_tmxString, const_std_string_resourcePath)
end
--[[
	Return properties dictionary for tile GID.
	@return [luaIde#Value]   Return properties dictionary for tile GID.
]]
function cc.TMXTiledMap:getPropertiesForGID(int_GID)
end
...
function cc.TileMapAtlas:initWithTileFile(const_std_string_tile, const_std_string_mapFile, int_tileWidth, int_tileHeight)
end
--[[
...
function cc.TileMapAtlas:getTileAt(const_Vec2_position)
end
--[[
	sets a tile at position x,y.
	For the moment only channel R is used
]]
function cc.TileMapAtlas:setTile(const_Color3B_tile, const_Vec2_position)
end
--[[
...
function cc.TileMapAtlas:create(const_std_string_tile, const_std_string_mapFile, int_tileWidth, int_tileHeight)
end
...
function cc.MotionStreak3D:reset()
end
function cc.MotionStreak3D:setTexture(Texture2D_texture)
end
--[[
	@return [luaIde#cc.Texture2D]
]]
function cc.MotionStreak3D:getTexture()
end
--[[
	Color used for the tint.
	@param colors The color used for the tint.
]]
function cc.MotionStreak3D:tintWithColor(const_Color3B_colors)
end
--[[
	Get the direction of sweeping line segment
	@return [luaIde#cc.Vec3]
]]
function cc.MotionStreak3D:getSweepAxis()
end
--[[
	@js NA
	@lua NA
]]
function cc.MotionStreak3D:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	Sets the starting position initialized or not.
	@param bStartingPositionInitialized True if initialized the starting position.
]]
function cc.MotionStreak3D:setStartingPositionInitialized(bool_bStartingPositionInitialized)
end
--[[
	@js NA
	@lua NA
...
function cc.MotionStreak3D:getBlendFunc()
end
--[[
	Is the starting position initialized or not.
	@return bool   True if the starting position is initialized.
]]
function cc.MotionStreak3D:isStartingPositionInitialized()
end
--[[
	Get stroke.
	@return float   float stroke.
]]
function cc.MotionStreak3D:getStroke()
end
--[[
	initializes a motion streak with fade in seconds, minimum segments, stroke's width, color and texture filename
	@return bool
]]
function cc.MotionStreak3D:initWithFade(float_fade, float_minSeg, float_stroke, const_Color3B_color, const_std_string_path)
end
--[[
	initializes a motion streak with fade in seconds, minimum segments, stroke's width, color and texture
	@return bool
]]
function cc.MotionStreak3D:initWithFade(float_fade, float_minSeg, float_stroke, const_Color3B_color, Texture2D_texture)
end
--[[
	Set the direction of sweeping line segment.
	@param sweepAxis Direction of sweeping line segment
]]
function cc.MotionStreak3D:setSweepAxis(const_Vec3_sweepAxis)
end
--[[
	Set stroke.
	@param stroke The width of stroke.
]]
function cc.MotionStreak3D:setStroke(float_stroke)
end
--[[
	Creates and initializes a motion streak with fade in seconds, minimum segments, stroke's width, color, texture filename.
...
function cc.MotionStreak3D:create(float_fade, float_minSeg, float_stroke, const_Color3B_color, const_std_string_path)
end
--[[
	Creates and initializes a motion streak with fade in seconds, minimum segments, stroke's width, color, texture.
	@param fade The fade time, in seconds.
...
function cc.MotionStreak3D:create(float_fade, float_minSeg, float_stroke, const_Color3B_color, Texture2D_texture)
end
...
function cc.ComponentLua:getScriptObject()
end
function cc.ComponentLua:update(float_dt)
end
--[[
	@return [luaIde#cc.ComponentLua]
]]
function cc.ComponentLua:create(const_std_string_scriptFileName)
end
...
function cc.CCBAnimationManager:moveAnimationsFromNode(cocos2d_Node_fromNode, cocos2d_Node_toNode)
end
function cc.CCBAnimationManager:setAutoPlaySequenceId(int_autoPlaySequenceId)
end
--[[
...
function cc.CCBAnimationManager:actionForSoundChannel(CCBSequenceProperty_channel)
end
function cc.CCBAnimationManager:setBaseValue(const_cocos2d_Value_value, cocos2d_Node_pNode, const_std_string_propName)
end
--[[
...
function cc.CCBAnimationManager:setRootNode(cocos2d_Node_pRootNode)
end
function cc.CCBAnimationManager:runAnimationsForSequenceNamedTweenDuration(const_char_pName, float_fTweenDuration)
end
function cc.CCBAnimationManager:addDocumentOutletName(std_string_name)
end
--[[
...
function cc.CCBAnimationManager:setDocumentControllerName(const_std_string_name)
end
function cc.CCBAnimationManager:setObject(cocos2d_Ref_obj, cocos2d_Node_pNode, const_std_string_propName)
end
--[[
	@return [luaIde#cocos2d_Size]
]]
function cc.CCBAnimationManager:getContainerSize(cocos2d_Node_pNode)
end
--[[
	@return [luaIde#cocos2d_Sequence]
]]
function cc.CCBAnimationManager:actionForCallbackChannel(CCBSequenceProperty_channel)
end
--[[
	@return [luaIde#cocos2d_ValueVector]
]]
...
function cc.CCBAnimationManager:addDocumentCallbackControlEvents(cocos2d_extension_Control_EventType_eventType)
end
--[[
	@return bool
]]
...
function cc.CCBAnimationManager:setRootContainerSize(const_cocos2d_Size_rootContainerSize)
end
function cc.CCBAnimationManager:runAnimationsForSequenceIdTweenDuration(int_nSeqId, float_fTweenDuraiton)
end
--[[
	@return char
]]
...
function cc.CCBAnimationManager:addDocumentCallbackName(std_string_name)
end
--[[
...
function cc.CCBAnimationManager:addDocumentOutletNode(cocos2d_Node_node)
end
--[[
	@return float
]]
function cc.CCBAnimationManager:getSequenceDuration(const_char_pSequenceName)
end
function cc.CCBAnimationManager:addDocumentCallbackNode(cocos2d_Node_node)
end
function cc.CCBAnimationManager:runAnimationsForSequenceNamed(const_char_pName)
end
--[[
	@return int
]]
function cc.CCBAnimationManager:getSequenceId(const_char_pSequenceName)
end
--[[
	@return [luaIde#cocos2d_Vector__cocos2d_Node__]
]]
...
function cc.CCBAnimationManager:setSequences()
end
...
cc.CCBReader = {}
function cc.CCBReader:addOwnerOutletName(std_string_name)
end
--[[
	@return [luaIde#cocos2d_ValueVector]
]]
...
function cc.CCBReader:addDocumentCallbackControlEvents(cocos2d_extension_Control_EventType_eventType)
end
function cc.CCBReader:setCCBRootPath(const_char_ccbRootPath)
end
function cc.CCBReader:addOwnerOutletNode(cocos2d_Node_node)
end
--[[
	@return [luaIde#cocos2d_Vector__cocos2d_Node__]
]]
...
function cc.CCBReader:readSoundKeyframesForSeq(CCBSequence_seq)
end
--[[
	@return std_string
]]
...
function cc.CCBReader:addOwnerCallbackControlEvents(cocos2d_extension_Control_EventType_type)
end
--[[
	@return [luaIde#cocos2d_ValueVector]
]]
...
function cc.CCBReader:readCallbackKeyframesForSeq(CCBSequence_seq)
end
--[[
...
function cc.CCBReader:setResolutionScale(float_scale)
end
...
function cc.SimpleAudioEngine:preloadEffect(const_char_filePath)
end
--[[
...
function cc.SimpleAudioEngine:pauseEffect(unsigned_int_soundId)
end
--[[
...
function cc.SimpleAudioEngine:playEffect(const_char_filePath, bool_loop, float_pitch, float_pan, float_gain)
end
--[[
...
function cc.SimpleAudioEngine:setEffectsVolume(float_volume)
end
--[[
	Stop playing sound effect.
	@param soundId The return value of function playEffect.
]]
function cc.SimpleAudioEngine:stopEffect(unsigned_int_soundId)
end
--[[
...
function cc.SimpleAudioEngine:unloadEffect(const_char_filePath)
end
--[[
	Resume playing sound effect.
	@param soundId The return value of function playEffect.
]]
function cc.SimpleAudioEngine:resumeEffect(unsigned_int_soundId)
end
--[[
...
function cc.Controller:receiveExternalKeyEvent(int_externalKeyCode, bool_receive)
end
--[[
...
function cc.Controller:setTag(int_tag)
end
--[[
...
function cc.Controller:getControllerByDeviceId(int_deviceId)
end
--[[
...
function cc.Controller:getControllerByTag(int_tag)
end
...
function cc.CSLoader:createNodeFromJson(const_std_string_filename)
end
--[[
	@return [luaIde#cocos2d_Node]
]]
function cc.CSLoader:createNodeWithFlatBuffersFile(const_std_string_filename)
end
--[[
	@return [luaIde#cocos2d_Node]
]]
function cc.CSLoader:createNodeWithFlatBuffersFile(const_std_string_filename, const_ccNodeLoadCallback_callback)
end
--[[
	@return [luaIde#cocos2d_Node]
]]
function cc.CSLoader:loadNodeWithFile(const_std_string_fileName)
end
function cc.CSLoader:setJsonPath(std_string_jsonPath)
end
...
function cc.CSLoader:loadNodeWithContent(const_std_string_content)
end
--[[
	@return bool
]]
...
function cc.CSLoader:setRecordJsonPath(bool_record)
end
--[[
	@return [luaIde#cocos2d_Node]
]]
function cc.CSLoader:createNodeWithFlatBuffersForSimulator(const_std_string_filename)
end
...
function cc.CSLoader:createNodeWithVisibleSize(const_std_string_filename)
end
--[[
...
function ccexp.VideoPlayer:isUserInputEnabled()
end
--[[
...
function ccexp.VideoPlayer:setKeepAspectRatioEnabled(bool_enable)
end
--[[
	Stops playback.
]]
...
function ccexp.VideoPlayer:setFullScreenEnabled(bool_fullscreen)
end
--[[
	Sets a file path as a video source for VideoPlayer.
]]
function ccexp.VideoPlayer:setFileName(const_std_string_videoPath)
end
--[[
	Sets a URL as a video source for VideoPlayer.
]]
function ccexp.VideoPlayer:setURL(const_std_string__videoURL)
end
--[[
	Set the style of the player
	@param style The corresponding style
]]
function ccexp.VideoPlayer:setStyle(StyleType_style)
end
--[[
	Seeks to specified time position.
	@param sec   The offset in seconds from the start to seek to.
]]
function ccexp.VideoPlayer:seekTo(float_sec)
end
--[[
...
function ccexp.VideoPlayer:onPlayEvent(int_event)
end
--[[
...
--[[
	...
	@return bool   true if the videoplayer is set to loop, false otherwise.
]]
function ccexp.VideoPlayer:isLooping()
end
--[[
...
function ccexp.VideoPlayer:setLooping(bool_looping)
end
--[[
...
function ccexp.VideoPlayer:setUserInputEnabled(bool_enableInput)
end
...
function ccexp.WebView:setOpacityWebView(float_opacity)
end
--[[
...
function ccexp.WebView:loadHTMLString(const_std_string_string, const_std_string_baseURL)
end
--[[
...
function ccexp.WebView:setScalesPageToFit(const_bool_scalesPageToFit)
end
--[[
	Loads the given fileName.
	@param fileName Content fileName.
]]
function ccexp.WebView:loadFile(const_std_string_fileName)
end
--[[
	Loads the given URL. It doesn't clean cached data.
	@param url Content URL.
]]
function ccexp.WebView:loadURL(const_std_string_url)
end
--[[
...
function ccexp.WebView:loadURL(const_std_string_url, bool_cleanCachedData)
end
--[[
	Set whether the webview bounces at end of scroll of WebView.
]]
function ccexp.WebView:setBounces(bool_bounce)
end
--[[
	Evaluates JavaScript in the context of the currently displayed page.
]]
function ccexp.WebView:evaluateJS(const_std_string_js)
end
--[[
	set the background transparent
]]
function ccexp.WebView:setBackgroundTransparent()
end
--[[
...
function ccexp.WebView:getOpacityWebView()
end
--[[
...
function ccexp.WebView:setJavascriptInterfaceScheme(const_std_string_scheme)
end
--[[
...
function cc.Control:setEnabled(bool_bEnabled)
end
--[[
...
function cc.Control:sendActionsForControlEvents(EventType_controlEvents)
end
--[[
	A Boolean value that determines the control selected state.
]]
function cc.Control:setSelected(bool_bSelected)
end
--[[
	@return bool
]]
...
function cc.Control:isTouchInside(Touch__touch)
end
--[[
	A Boolean value that determines whether the control is highlighted.
]]
function cc.Control:setHighlighted(bool_bHighlighted)
end
--[[
...
function cc.Control:getTouchLocation(Touch_touch)
end
--[[
	@return bool
]]
...
function cc.ControlButton:setTitleLabelForState(Node_label, State_state)
end
function cc.ControlButton:setAdjustBackgroundImage(bool_adjustBackgroundImage)
end
--[[
...
function cc.ControlButton:setTitleForState(const_std_string_title, State_state)
end
--[[
	@return bool
]]
function cc.ControlButton:initWithBackgroundSprite(cocos2d_ui_Scale9Sprite_sprite)
end
--[[
	@return float
]]
function cc.ControlButton:getTitleTTFSizeForState(State_state)
end
function cc.ControlButton:setTitleTTFForState(const_std_string_fntFile, State_state)
end
function cc.ControlButton:setTitleTTFSizeForState(float_size, State_state)
end
--[[
...
function cc.ControlButton:getBackgroundSpriteForState(State_state)
end
--[[
	@return bool
]]
function cc.ControlButton:initWithTitleAndFontNameAndFontSize(const_std_string_title, const_std_string_fontName, float_fontSize)
end
--[[
...
function cc.ControlButton:setTitleBMFontForState(const_std_string_fntFile, State_state)
end
--[[
	@return std_string
]]
function cc.ControlButton:getTitleTTFForState(State_state)
end
--[[
...
function cc.ControlButton:getTitleColorForState(State_state)
end
--[[
...
function cc.ControlButton:setTitleColorForState(const_Color3B_color, State_state)
end
--[[
...
function cc.ControlButton:setBackgroundSpriteFrameForState(SpriteFrame__spriteFrame, State_state)
end
--[[
...
function cc.ControlButton:setBackgroundSpriteForState(cocos2d_ui_Scale9Sprite_sprite, State_state)
end
--[[
	@return std_string
]]
function cc.ControlButton:getTitleBMFontForState(State_state)
end
--[[
...
function cc.ControlButton:getTitleLabelForState(State_state)
end
--[[
	set the margins at once (so we only have to do one call of needsLayout)
]]
function cc.ControlButton:setMargins(int_marginH, int_marginV)
end
--[[
	@return std_string
]]
...
function cc.ControlButton:initWithLabelAndBackgroundSprite(Node_label, cocos2d_ui_Scale9Sprite_backgroundSprite, bool_adjustBackGroundSize)
end
--[[
...
function cc.ControlButton:getTitleForState(State_state)
end
--[[
	@return [luaIde#cc.ControlButton]
]]
function cc.ControlButton:create()
end
--[[
	@return [luaIde#cc.ControlButton]
]]
function cc.ControlButton:create(Node_label, cocos2d_ui_Scale9Sprite_backgroundSprite)
end
--[[
	@return [luaIde#cc.ControlButton]
]]
function cc.ControlButton:create(Node_label, cocos2d_ui_Scale9Sprite_backgroundSprite, bool_adjustBackGroundSize)
end
...
function cc.ControlHuePicker:initWithTargetAndPos(Node_target, Vec2_pos)
end
function cc.ControlHuePicker:setHue(float_val)
end
function cc.ControlHuePicker:setHuePercentage(float_val)
end
--[[
	@return [luaIde#cc.ControlHuePicker]
]]
function cc.ControlHuePicker:create(Node_target, Vec2_pos)
end
...
function cc.ControlSaturationBrightnessPicker:initWithTargetAndPos(Node_target, Vec2_pos)
end
--[[
	@return [luaIde#cc.ControlSaturationBrightnessPicker]
]]
function cc.ControlSaturationBrightnessPicker:create(Node_target, Vec2_pos)
end
...
function cc.ControlColourPicker:hueSliderValueChanged(Ref__sender, Control_EventType_controlEvent)
end
function cc.ControlColourPicker:colourSliderValueChanged(Ref__sender, Control_EventType_controlEvent)
end
--[[
...
function cc.ControlPotentiometer:setValue(float_value)
end
--[[
	@return float
]]
...
function cc.ControlPotentiometer:potentiometerBegan(Vec2_location)
end
function cc.ControlPotentiometer:setMaximumValue(float_maximumValue)
end
--[[
	@return float
]]
...
function cc.ControlPotentiometer:distanceBetweenPointAndPoint(Vec2_point1, Vec2_point2)
end
function cc.ControlPotentiometer:potentiometerEnded(Vec2_location)
end
function cc.ControlPotentiometer:setMinimumValue(float_minimumValue)
end
--[[
...
function cc.ControlPotentiometer:initWithTrackSprite_ProgressTimer_ThumbSprite(Sprite_trackSprite, ProgressTimer_progressTimer, Sprite_thumbSprite)
end
function cc.ControlPotentiometer:potentiometerMoved(Vec2_location)
end
--[[
	Creates potentiometer with a track filename and a progress filename.
	@return [luaIde#cc.ControlPotentiometer]
]]
function cc.ControlPotentiometer:create(const_char_backgroundFile, const_char_progressFile, const_char_thumbFile)
end
...
function cc.ControlSlider:initWithSprites(Sprite__backgroundSprite, Sprite_progressSprite, Sprite_thumbSprite)
end
--[[
	Initializes a slider with a background sprite, a progress bar and a thumb
	item.
...
function cc.ControlSlider:initWithSprites(Sprite__backgroundSprite, Sprite_progressSprite, Sprite_thumbSprite, Sprite_selectedThumbSprite)
end
function cc.ControlSlider:setMaximumValue(float_val)
end
function cc.ControlSlider:setValue(float_val)
end
--[[
	@return [luaIde#cc.Vec2]
]]
function cc.ControlSlider:locationFromTouch(Touch_touch)
end
function cc.ControlSlider:setMinimumValue(float_val)
end
--[[
...
function cc.ControlSlider:create(const_char_bgFile, const_char_progressFile, const_char_thumbFile)
end
--[[
...
function cc.ControlSlider:create(Sprite__backgroundSprite, Sprite_pogressSprite, Sprite_thumbSprite)
end
--[[
...
function cc.ControlSlider:create(const_char_bgFile, const_char_progressFile, const_char_thumbFile, const_char_selectedThumbSpriteFile)
end
--[[
...
function cc.ControlSlider:create(Sprite__backgroundSprite, Sprite_pogressSprite, Sprite_thumbSprite, Sprite_selectedThumbSprite)
end
...
cc.ControlStepper = {}
function cc.ControlStepper:setValue(double_value)
end
function cc.ControlStepper:setStepValue(double_stepValue)
end
--[[
	@return bool
]]
function cc.ControlStepper:initWithMinusSpriteAndPlusSprite(Sprite_minusSprite, Sprite_plusSprite)
end
--[[
	Set the numeric value of the stepper. If send is true, the Control::EventType::VALUE_CHANGED is sent.
]]
function cc.ControlStepper:setValueWithSendingEvent(double_value, bool_send)
end
function cc.ControlStepper:setMaximumValue(double_maximumValue)
end
function cc.ControlStepper:setWraps(bool_wraps)
end
--[[
...
function cc.ControlStepper:updateLayoutUsingTouchLocation(Vec2_location)
end
--[[
	@return bool
]]
...
function cc.ControlStepper:setMinimumValue(double_minimumValue)
end
--[[
	@return double
]]
...
function cc.ControlStepper:create(Sprite_minusSprite, Sprite_plusSprite)
end
...
function cc.ControlSwitch:setOn(bool_isOn, bool_animated)
end
--[[
	@return [luaIde#cc.Vec2]
]]
function cc.ControlSwitch:locationFromTouch(Touch_touch)
end
--[[
	@return bool
]]
...
function cc.ControlSwitch:initWithMaskSprite(Sprite_maskSprite, Sprite__onSprite, Sprite__offSprite, Sprite__thumbSprite)
end
--[[
	Initializes a switch with a mask sprite, on/off sprites for on/off states, a thumb sprite and an on/off labels.
	@return bool
]]
function cc.ControlSwitch:initWithMaskSprite(Sprite_maskSprite, Sprite__onSprite, Sprite__offSprite, Sprite__thumbSprite, Label_onLabel, Label_offLabel)
end
--[[
	@return bool
]]
...
function cc.ControlSwitch:create(Sprite_maskSprite, Sprite__onSprite, Sprite__offSprite, Sprite__thumbSprite, Label_onLabel, Label_offLabel)
end
--[[
	Creates a switch with a mask sprite, on/off sprites for on/off states and a thumb sprite.
	@return [luaIde#cc.ControlSwitch]
]]
function cc.ControlSwitch:create(Sprite_maskSprite, Sprite__onSprite, Sprite__offSprite, Sprite__thumbSprite)
end
...
function cc.ScrollView:setDirection(Direction_dir)
end
--[[
...
function cc.ScrollView:scrollToTop(float_timeInSec, bool_attenuated)
end
--[[
...
function cc.ScrollView:scrollToPercentHorizontal(float_percent, float_timeInSec, bool_attenuated)
end
--[[
	@brief Set the scroll bar's opacity
	@param the scroll bar's opacity
]]
function cc.ScrollView:setScrollBarOpacity(GLubyte_opacity)
end
--[[
	@brief Toggle scroll bar enabled.
	@param enabled True if enable scroll bar, false otherwise.
]]
function cc.ScrollView:setScrollBarEnabled(bool_enabled)
end
--[[
	@brief Query inertia scroll state.
	@return bool   True if inertia is enabled, false otherwise.
]]
function cc.ScrollView:isInertiaScrollEnabled()
end
--[[
...
function cc.ScrollView:scrollToBottom(float_timeInSec, bool_attenuated)
end
--[[
	@return [luaIde#cc.Vec2]   How far the scroll view is scrolled in both axes, combined as a Vec2
]]
function cc.ScrollView:getScrolledPercentBothDirection()
end
--[[
	@brief Set the scroll bar's color
	@param the scroll bar's color
]]
function cc.ScrollView:setScrollBarColor(const_Color3B_color)
end
--[[
...
function cc.ScrollView:scrollToBottomLeft(float_timeInSec, bool_attenuated)
end
--[[
...
function cc.ScrollView:getInnerContainer()
end
--[[
	Move inner container to bottom boundary of scrollview.
]]
function cc.ScrollView:jumpToBottom()
end
--[[
	Set inner container position
	@param pos Inner container position.
]]
function cc.ScrollView:setInnerContainerPosition(const_Vec2_pos)
end
--[[
...
function cc.ScrollView:scrollToTopLeft(float_timeInSec, bool_attenuated)
end
--[[
	Move inner container to top and right boundary of scrollview.
]]
function cc.ScrollView:jumpToTopRight()
end
--[[
...
function cc.ScrollView:scrollToPercentBothDirection(const_Vec2_percent, float_timeInSec, bool_attenuated)
end
--[[
...
function cc.ScrollView:setInnerContainerSize(const_Size_size)
end
--[[
	Get inner container position
	@return [luaIde#cc.Vec2]   The inner container position.
]]
function cc.ScrollView:getInnerContainerPosition()
end
--[[
	Move inner container to top boundary of scrollview.
]]
function cc.ScrollView:jumpToTop()
end
--[[
	@return float   How far the scroll view is scrolled in the vertical axis
]]
function cc.ScrollView:getScrolledPercentVertical()
end
--[[
	@brief Query bounce state.
	@return bool   True if bounce is enabled, false otherwise.
]]
function cc.ScrollView:isBounceEnabled()
end
--[[
	Move inner container to vertical percent position of scrollview.
	@param percent A value between 0 and 100.
]]
function cc.ScrollView:jumpToPercentVertical(float_percent)
end
--[[
...
function cc.ScrollView:addEventListener(const_ccScrollViewCallback_callback)
end
--[[
	@brief Set scroll bar auto hide time
	@param scroll bar auto hide time
]]
function cc.ScrollView:setScrollBarAutoHideTime(float_autoHideTime)
end
--[[
	Immediately stops inner container scroll (auto scrolling is not affected).
]]
function cc.ScrollView:stopScroll()
end
--[[
...
function cc.ScrollView:scrollToTopRight(float_timeInSec, bool_attenuated)
end
--[[
	@return bool   Whether the user is currently dragging the ScrollView to scroll it
]]
function cc.ScrollView:isScrolling()
end
--[[
...
function cc.ScrollView:scrollToLeft(float_timeInSec, bool_attenuated)
end
--[[
	Move inner container to both direction percent position of scrollview.
	@param percent   A value between 0 and 100.
]]
function cc.ScrollView:jumpToPercentBothDirection(const_Vec2_percent)
end
--[[
	Immediately stops inner container scroll if any.
]]
function cc.ScrollView:stopOverallScroll()
end
--[[
...
function cc.ScrollView:scrollToPercentVertical(float_percent, float_timeInSec, bool_attenuated)
end
--[[
	@brief Set the scroll bar's width
	@param width The scroll bar's width
]]
function cc.ScrollView:setScrollBarWidth(float_width)
end
--[[
	@brief Get the scroll bar's opacity
	@return [luaIde#GLubyte]   the scroll bar's opacity
]]
function cc.ScrollView:getScrollBarOpacity()
end
--[[
...
function cc.ScrollView:scrollToBottomRight(float_timeInSec, bool_attenuated)
end
--[[
...
function cc.ScrollView:setScrollBarPositionFromCorner(const_Vec2_positionFromCorner)
end
--[[
...
function cc.ScrollView:setScrollBarPositionFromCornerForVertical(const_Vec2_positionFromCorner)
end
--[[
	@brief Get the scroll bar's auto hide time
	@return float   the scroll bar's auto hide time
]]
function cc.ScrollView:getScrollBarAutoHideTime()
end
--[[
	Move inner container to left boundary of scrollview.
]]
function cc.ScrollView:jumpToLeft()
end
--[[
...
function cc.ScrollView:scrollToRight(float_timeInSec, bool_attenuated)
end
--[[
	@brief Get the vertical scroll bar's position from right-top corner.
	@return [luaIde#cc.Vec2]   positionFromCorner
]]
function cc.ScrollView:getScrollBarPositionFromCornerForVertical()
end
--[[
	@brief Get the scroll bar's width
	@return float   the scroll bar's width
]]
function cc.ScrollView:getScrollBarWidth()
end
--[[
	@brief Query scroll bar auto hide state
	@return bool   True if scroll bar auto hide is enabled, false otherwise.
]]
function cc.ScrollView:isScrollBarAutoHideEnabled()
end
--[[
	Move inner container to bottom and left boundary of scrollview.
]]
function cc.ScrollView:jumpToBottomLeft()
end
--[[
	Move inner container to right boundary of scrollview.
]]
function cc.ScrollView:jumpToRight()
end
--[[
...
function cc.ScrollView:getInnerContainerSize()
end
--[[
	Move inner container to horizontal percent position of scrollview.
	@param percent   A value between 0 and 100.
]]
function cc.ScrollView:jumpToPercentHorizontal(float_percent)
end
...
function cc.TableViewCell:setIdx(ssize_t_uIdx)
end
...
function cc.TableView:updateCellAtIndex(ssize_t_idx)
end
--[[
	determines how cell is ordered and filled in the view.
]]
function cc.TableView:setVerticalFillOrder(VerticalFillOrder_order)
end
function cc.TableView:scrollViewDidZoom(ScrollView_view)
end
...
function cc.TableView:removeCellAtIndex(ssize_t_idx)
end
--[[
	@return bool
]]
function cc.TableView:initWithViewSize(Size_size, Node_container)
end
--[[
	Overrides
]]
function cc.TableView:scrollViewDidScroll(ScrollView_view)
end
--[[
...
function cc.TableView:insertCellAtIndex(ssize_t_idx)
end
--[[
...
function cc.TableView:cellAtIndex(ssize_t_idx)
end
--[[
...
function cc.AssetsManager:setStoragePath(const_char_storagePath)
end
--[[
	@brief Sets package url.
]]
function cc.AssetsManager:setPackageUrl(const_char_packageUrl)
end
--[[
...
function cc.AssetsManager:setConnectionTimeout(unsigned_int_timeout)
end
--[[
	@brief Gets version file url.
]]
function cc.AssetsManager:setVersionFileUrl(const_char_versionFileUrl)
end
--[[
...
function cc.AssetsManager:create(
    const_char_packageUrl,
    const_char_versionFileUrl,
    const_char_storagePath,
    ErrorCallback_errorCallback,
    ProgressCallback_progressCallback,
    SuccessCallback_successCallback)
end
...
function cc.AssetsManagerEx:getMaxConcurrentTask()
end
--[[
...
function cc.AssetsManagerEx:setVerifyCallback()
end
--[[
	@brief Gets storage path.
	@return std_string
...
function cc.AssetsManagerEx:setVersionCompareHandle()
end
--[[
	@brief Function for setting the max concurrent task count
]]
function cc.AssetsManagerEx:setMaxConcurrentTask(const_int_max)
end
--[[
...
function cc.AssetsManagerEx:create(const_std_string_manifestUrl, const_std_string_storagePath)
end
...
function cc.EventListenerAssetsManagerEx:init(const_AssetsManagerEx_AssetsManagerEx)
end
...
function cc.ParticleSystem3D:removeAffector(int_index)
end
--[[
	resume particle
]]
...
function cc.ParticleSystem3D:addAffector(Particle3DAffector_affector)
end
--[[
...
function cc.ParticleSystem3D:getRender()
end
--[[
	set emitter for particle system, can set your own particle emitter
]]
function cc.ParticleSystem3D:setEmitter(Particle3DEmitter_emitter)
end
--[[
	@return bool
]]
...
function cc.ParticleSystem3D:setParticleQuota(unsigned_int_quota)
end
--[[
	override function
]]
function cc.ParticleSystem3D:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	set particle render, can set your own particle render
]]
function cc.ParticleSystem3D:setRender(Particle3DRender_render)
end
--[[
	stop particle
]]
...
function cc.ParticleSystem3D:setKeepLocal(bool_keepLocal)
end
...
function cc.PUParticleSystem3D:initWithFilePath(const_std_string_filePath)
end
--[[
...
function cc.PUParticleSystem3D:setEmittedSystemQuota(unsigned_int_quota)
end
--[[
...
function cc.PUParticleSystem3D:forceUpdate(float_delta)
end
--[[
	@return float
]]
...
function cc.PUParticleSystem3D:forceEmission(PUEmitter_emitter, unsigned_requested)
end
function cc.PUParticleSystem3D:addListener(PUListener_listener)
end
--[[
	@return bool
]]
...
function cc.PUParticleSystem3D:setEmittedEmitterQuota(unsigned_int_quota)
end
function cc.PUParticleSystem3D:setMarkedForEmission(bool_isMarked)
end
--[[
...
function cc.PUParticleSystem3D:addEmitter(PUEmitter_emitter)
end
function cc.PUParticleSystem3D:addBehaviourTemplate(PUBehaviour_behaviour)
end
function cc.PUParticleSystem3D:setDefaultWidth(const_float_width)
end
function cc.PUParticleSystem3D:copyAttributesTo(PUParticleSystem3D_system)
end
function cc.PUParticleSystem3D:setMaterialName(const_std_string_name)
end
--[[
	@return [luaIde#cc.PUParticleSystem3D]
]]
...
function cc.PUParticleSystem3D:removeListener(PUListener_listener)
end
--[[
	Set the maximum velocity a particle can have.
]]
function cc.PUParticleSystem3D:setMaxVelocity(float_maxVelocity)
end
--[[
...
function cc.PUParticleSystem3D:rotationOffset(Vec3_pos)
end
function cc.PUParticleSystem3D:removeAllEmitter()
end
function cc.PUParticleSystem3D:setParticleSystemScaleVelocity(float_scaleVelocity)
end
--[[
	@return [luaIde#cc.Vec3]
]]
...
function cc.PUParticleSystem3D:setDefaultHeight(const_float_height)
end
...
function cc.PUParticleSystem3D:initSystem(const_std_string_filePath)
end
--[[
	@return bool
]]
function cc.PUParticleSystem3D:makeParticleLocal(PUParticle3D_particle)
end
function cc.PUParticleSystem3D:removerAllObserver()
end
function cc.PUParticleSystem3D:setDefaultDepth(const_float_depth)
end
function cc.PUParticleSystem3D:addObserver(PUObserver_observer)
end
--[[
	@return [luaIde#cc.PUParticleSystem3D]
]]
function cc.PUParticleSystem3D:create()
end
--[[
	@return [luaIde#cc.PUParticleSystem3D]
]]
function cc.PUParticleSystem3D:create(const_std_string_filePath, const_std_string_materialPath)
end
...
function cc.NavMeshAgent:setMaxSpeed(float_maxSpeed)
end
--[[
...
function cc.NavMeshAgent:setAutoTraverseOffMeshLink(bool_isAuto)
end
--[[
...
function cc.NavMeshAgent:setSeparationWeight(float_weight)
end
--[[
	pause movement
]]
...
function cc.NavMeshAgent:setAutoOrientation(bool_isAuto)
end
--[[
	get agent height
	@return float
...
function cc.NavMeshAgent:setSyncFlag(const_NavMeshAgentSyncFlag_flag)
end
--[[
...
function cc.NavMeshAgent:setMaxAcceleration(float_maxAcceleration)
end
--[[
	Set the reference axes of agent's orientation
	@param rotRefAxes The value of reference axes in local coordinate system.
]]
function cc.NavMeshAgent:setOrientationRefAxes(const_Vec3_rotRefAxes)
end
--[[
...
function cc.NavMeshAgent:setHeight(float_height)
end
function cc.NavMeshAgent:setUserData(void_data)
end
--[[
...
function cc.NavMeshAgent:setRadius(float_radius)
end
--[[
	set obstacle avoidance type
]]
function cc.NavMeshAgent:setObstacleAvoidanceType(unsigned_char_type)
end
--[[
	@return std_string
]]
...
function cc.NavMeshAgent:create(const_NavMeshAgentParam_param)
end
...
function cc.NavMeshObstacle:initWith(float_radius, float_height)
end
--[[
...
function cc.NavMeshObstacle:setSyncFlag(const_NavMeshObstacleSyncFlag_flag)
end
--[[
...
function cc.NavMeshObstacle:create(float_radius, float_height)
end
--[[
	@return std_string
]]
...
function cc.NavMesh:removeNavMeshObstacle(NavMeshObstacle_obstacle)
end
--[[
	remove a agent from navmesh.
]]
function cc.NavMesh:removeNavMeshAgent(NavMeshAgent_agent)
end
--[[
	update navmesh.
]]
function cc.NavMesh:update(float_dt)
end
--[[
...
function cc.NavMesh:addNavMeshAgent(NavMeshAgent_agent)
end
--[[
	add a obstacle to navmesh.
]]
function cc.NavMesh:addNavMeshObstacle(NavMeshObstacle_obstacle)
end
--[[
	Enable debug draw or disable.
]]
function cc.NavMesh:setDebugDrawEnable(bool_enable)
end
--[[
	Internal method, the updater of debug drawing, need called each frame.
]]
function cc.NavMesh:debugDraw(Renderer_renderer)
end
--[[
	Create navmesh
...
function cc.NavMesh:create(const_std_string_navFilePath, const_std_string_geomFilePath)
end
...
function cc.Physics3DShape:initSphere(float_radius)
end
--[[
	@return bool
]]
function cc.Physics3DShape:initBox(const_cocos2d_Vec3_ext)
end
--[[
	@return bool
]]
function cc.Physics3DShape:initCapsule(float_radius, float_height)
end
--[[
	@return bool
]]
function cc.Physics3DShape:initCylinder(float_radius, float_height)
end
--[[
	get shape type
...
function cc.Physics3DShape:createBox(const_cocos2d_Vec3_extent)
end
--[[
...
function cc.Physics3DShape:createCylinder(float_radius, float_height)
end
--[[
	create convex hull
...
function cc.Physics3DShape:createConvexHull(const_cocos2d_Vec3_points, int_numPoints)
end
--[[
...
function cc.Physics3DShape:createCapsule(float_radius, float_height)
end
--[[
	create sphere shape
...
function cc.Physics3DShape:createSphere(float_radius)
end
...
function cc.Physics3DObject:setUserData(void_userData)
end
--[[
	Get the user data.
]]
...
function cc.Physics3DObject:setPhysicsWorld(Physics3DWorld_world)
end
--[[
...
function cc.Physics3DObject:setMask(unsigned_int_mask)
end
--[[
...
function cc.Physics3DRigidBody:setGravity(const_cocos2d_Vec3_acceleration)
end
--[[
	Get friction.
	@return float
...
function cc.Physics3DRigidBody:setAngularFactor(const_cocos2d_Vec3_angFac)
end
--[[
	Set the angular factor, use unified factor.
]]
function cc.Physics3DRigidBody:setAngularFactor(float_angFac)
end
function cc.Physics3DRigidBody:addConstraint(Physics3DConstraint_constraint)
end
--[[
...
function cc.Physics3DRigidBody:applyCentralForce(const_cocos2d_Vec3_force)
end
--[[
	Set mass and inertia.
]]
function cc.Physics3DRigidBody:setMassProps(float_mass, const_cocos2d_Vec3_inertia)
end
--[[
	Set friction.
]]
function cc.Physics3DRigidBody:setFriction(float_frict)
end
--[[
	Set kinematic object.
]]
function cc.Physics3DRigidBody:setKinematic(bool_kinematic)
end
--[[
	Set linear damping and angular damping.
]]
function cc.Physics3DRigidBody:setDamping(float_lin_damping, float_ang_damping)
end
--[[
	Apply a impulse.
...
function cc.Physics3DRigidBody:applyImpulse(const_cocos2d_Vec3_impulse, const_cocos2d_Vec3_rel_pos)
end
--[[
...
function cc.Physics3DRigidBody:applyTorque(const_cocos2d_Vec3_torque)
end
--[[
	Set motion threshold, don't do continuous collision detection if the motion (in one step) is less then ccdMotionThreshold
]]
function cc.Physics3DRigidBody:setCcdMotionThreshold(float_ccdMotionThreshold)
end
--[[
	Set rolling friction.
]]
function cc.Physics3DRigidBody:setRollingFriction(float_frict)
end
--[[
...
function cc.Physics3DRigidBody:applyDamping(float_timeStep)
end
--[[
...
function cc.Physics3DRigidBody:init(Physics3DRigidBodyDes_info)
end
--[[
	Apply a torque impulse.
	@param   torque the value of the torque
]]
function cc.Physics3DRigidBody:applyTorqueImpulse(const_cocos2d_Vec3_torque)
end
--[[
	Active or inactive.
]]
function cc.Physics3DRigidBody:setActive(bool_active)
end
--[[
	Set the linear factor.
]]
function cc.Physics3DRigidBody:setLinearFactor(const_cocos2d_Vec3_linearFactor)
end
--[[
	Set the linear velocity.
]]
function cc.Physics3DRigidBody:setLinearVelocity(const_cocos2d_Vec3_lin_vel)
end
--[[
...
function cc.Physics3DRigidBody:setCcdSweptSphereRadius(float_radius)
end
--[[
	Apply a force.
	@param   force the value of the force
...
function cc.Physics3DRigidBody:applyForce(const_cocos2d_Vec3_force, const_cocos2d_Vec3_rel_pos)
end
--[[
	Set the angular velocity.
]]
function cc.Physics3DRigidBody:setAngularVelocity(const_cocos2d_Vec3_ang_vel)
end
--[[
	Apply a central impulse.
	@param   impulse the value of the impulse
]]
function cc.Physics3DRigidBody:applyCentralImpulse(const_cocos2d_Vec3_impulse)
end
--[[
...
function cc.Physics3DRigidBody:setCenterOfMassTransform(const_cocos2d_Mat4_xform)
end
--[[
	Set the inverse of local inertia.
]]
function cc.Physics3DRigidBody:setInvInertiaDiagLocal(const_cocos2d_Vec3_diagInvInertia)
end
function cc.Physics3DRigidBody:removeConstraint(Physics3DConstraint_constraint)
end
--[[
	Get total torque.
	@return [luaIde#cocos2d_Vec3]
...
function cc.Physics3DRigidBody:getConstraint(unsigned_int_idx)
end
--[[
	Get restitution.
	@return float
...
function cc.Physics3DRigidBody:setRestitution(float_rest)
end
--[[
	Set hit friction.
]]
function cc.Physics3DRigidBody:setHitFraction(float_hitFraction)
end
--[[
	Get linear damping.
	@return float
...
function cc.Physics3DComponent:addToPhysicsWorld(Physics3DWorld_world)
end
--[[
...
function cc.Physics3DComponent:setPhysics3DObject(Physics3DObject_physicsObj)
end
--[[
	synchronization between node and physics is time consuming, you can skip some synchronization using this function
]]
function cc.Physics3DComponent:setSyncFlag(PhysicsSyncFlag_syncFlag)
end
--[[
...
function cc.PhysicsSprite3D:setSyncFlag(Physics3DComponent_PhysicsSyncFlag_syncFlag)
end
...
function cc.Physics3DWorld:setGravity(const_Vec3_gravity)
end
--[[
	Simulate one frame.
]]
function cc.Physics3DWorld:stepSimulate(float_dt)
end
--[[
	@return bool
]]
...
function cc.Physics3DWorld:setGhostPairCallback()
end
--[[
...
function cc.Physics3DWorld:removePhysics3DConstraint(Physics3DConstraint_constraint)
end
--[[
	Add a Physics3DObject.
]]
function cc.Physics3DWorld:addPhysics3DObject(Physics3DObject_physicsObj)
end
--[[
	Enable or disable debug drawing.
]]
function cc.Physics3DWorld:setDebugDrawEnable(bool_enableDebugDraw)
end
--[[
	Remove a Physics3DObject.
]]
function cc.Physics3DWorld:removePhysics3DObject(Physics3DObject_physicsObj)
end
--[[
	Add a Physics3DConstraint.
]]
function cc.Physics3DWorld:addPhysics3DConstraint(Physics3DConstraint_constraint, bool_disableCollisionsBetweenLinkedObjs)
end
--[[
	Internal method, the updater of debug drawing, need called each frame.
]]
function cc.Physics3DWorld:debugDraw(cocos2d_Renderer_renderer)
end
...
function cc.Physics3DConstraint:setEnabled(bool_enabled)
end
--[[
	set the impulse that break the constraint
]]
function cc.Physics3DConstraint:setBreakingImpulse(float_impulse)
end
--[[
	get user data
]]
...
function cc.Physics3DConstraint:setOverrideNumSolverIterations(int_overrideNumIterations)
end
--[[
	get constraint type
...
function cc.Physics3DConstraint:setUserData(void_userData)
end
--[[
...
function cc.Physics3DPointToPointConstraint:init(Physics3DRigidBody_rbA, const_cocos2d_Vec3_pivotPointInA)
end
--[[
	set pivot point in A's local space
]]
function cc.Physics3DPointToPointConstraint:setPivotPointInA(const_cocos2d_Vec3_pivotA)
end
--[[
	set pivot point in B's local space
]]
function cc.Physics3DPointToPointConstraint:setPivotPointInB(const_cocos2d_Vec3_pivotB)
end
--[[
...
function cc.Physics3DPointToPointConstraint:create(Physics3DRigidBody_rbA, const_cocos2d_Vec3_pivotPointInA)
end
--[[
...
function cc.Physics3DPointToPointConstraint:create(Physics3DRigidBody_rbA, Physics3DRigidBody_rbB, const_cocos2d_Vec3_pivotPointInA, const_cocos2d_Vec3_pivotPointInB)
end
...
function cc.Physics3DHingeConstraint:getHingeAngle()
end
--[[
	get hinge angl
	@return float
]]
function cc.Physics3DHingeConstraint:getHingeAngle(const_cocos2d_Mat4_transA, const_cocos2d_Mat4_transB)
end
--[[
...
function cc.Physics3DHingeConstraint:setMaxMotorImpulse(float_maxMotorImpulse)
end
--[[
	enable angular motor
]]
function cc.Physics3DHingeConstraint:enableAngularMotor(bool_enableMotor, float_targetVelocity, float_maxMotorImpulse)
end
--[[
	get upper limi
	@return float
...
function cc.Physics3DHingeConstraint:setUseFrameOffset(bool_frameOffsetOnOff)
end
--[[
...
function cc.Physics3DHingeConstraint:enableMotor(bool_enableMotor)
end
--[[
	get B's fram
	@return [luaIde#cocos2d_Mat4]
...
function cc.Physics3DHingeConstraint:setFrames(const_cocos2d_Mat4_frameA, const_cocos2d_Mat4_frameB)
end
--[[
...
function cc.Physics3DHingeConstraint:setAngularOnly(bool_angularOnly)
end
--[[
	set limit
]]
function cc.Physics3DHingeConstraint:setLimit(float_low, float_high, float__softness, float__biasFactor, float__relaxationFactor)
end
--[[
	get angular onl
	@return bool
...
function cc.Physics3DHingeConstraint:setAxis(const_cocos2d_Vec3_axisInA)
end
--[[
	get A's frame
	@return [luaIde#cocos2d_Mat4]
...
function cc.Physics3DHingeConstraint:create(Physics3DRigidBody_rbA, const_cocos2d_Mat4_rbAFrame, bool_useReferenceFrameA)
end
--[[
	create hinge constraint
	@param rbA rigid body A
...
function cc.Physics3DHingeConstraint:create(Physics3DRigidBody_rbA, const_cocos2d_Vec3_pivotInA, const_cocos2d_Vec3_axisInA, bool_useReferenceFrameA)
end
--[[
	create hinge constraint
	@param rbA rigid body A
...
function cc.Physics3DHingeConstraint:create(
    Physics3DRigidBody_rbA,
    Physics3DRigidBody_rbB,
    const_cocos2d_Vec3_pivotInA,
    const_cocos2d_Vec3_pivotInB,
    cocos2d_Vec3_axisInA,
    cocos2d_Vec3_axisInB,
    bool_useReferenceFrameA)
end
--[[
	create hinge constraint
	@param rbA rigid body A
...
function cc.Physics3DHingeConstraint:create(Physics3DRigidBody_rbA, Physics3DRigidBody_rbB, const_cocos2d_Mat4_rbAFrame, const_cocos2d_Mat4_rbBFrame, bool_useReferenceFrameA)
end
...
function cc.Physics3DSliderConstraint:setPoweredAngMotor(bool_onOff)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setRestitutionOrthoLin(float_restitutionOrthoLin)
end
function cc.Physics3DSliderConstraint:setRestitutionDirLin(float_restitutionDirLin)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setPoweredLinMotor(bool_onOff)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setSoftnessOrthoLin(float_softnessOrthoLin)
end
function cc.Physics3DSliderConstraint:setSoftnessLimLin(float_softnessLimLin)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setRestitutionLimAng(float_restitutionLimAng)
end
--[[
	set upper linear limi
]]
function cc.Physics3DSliderConstraint:setUpperLinLimit(float_upperLimit)
end
function cc.Physics3DSliderConstraint:setDampingDirLin(float_dampingDirLin)
end
--[[
...
function cc.Physics3DSliderConstraint:setLowerAngLimit(float_lowerLimit)
end
--[[
	set upper angular limi
]]
function cc.Physics3DSliderConstraint:setUpperAngLimit(float_upperLimit)
end
function cc.Physics3DSliderConstraint:setTargetLinMotorVelocity(float_targetLinMotorVelocity)
end
function cc.Physics3DSliderConstraint:setDampingLimAng(float_dampingLimAng)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setUseFrameOffset(bool_frameOffsetOnOff)
end
--[[
	set lower linear limi
]]
function cc.Physics3DSliderConstraint:setLowerLinLimit(float_lowerLimit)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setDampingOrthoAng(float_dampingOrthoAng)
end
function cc.Physics3DSliderConstraint:setSoftnessDirAng(float_softnessDirAng)
end
--[[
	@return bool
]]
...
function cc.Physics3DSliderConstraint:setRestitutionOrthoAng(float_restitutionOrthoAng)
end
function cc.Physics3DSliderConstraint:setDampingDirAng(float_dampingDirAng)
end
--[[
	set frames for rigid body A and
]]
function cc.Physics3DSliderConstraint:setFrames(const_cocos2d_Mat4_frameA, const_cocos2d_Mat4_frameB)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setMaxLinMotorForce(float_maxLinMotorForce)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setTargetAngMotorVelocity(float_targetAngMotorVelocity)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setRestitutionDirAng(float_restitutionDirAng)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setRestitutionLimLin(float_restitutionLimLin)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setDampingOrthoLin(float_dampingOrthoLin)
end
function cc.Physics3DSliderConstraint:setSoftnessOrthoAng(float_softnessOrthoAng)
end
function cc.Physics3DSliderConstraint:setDampingLimLin(float_dampingLimLin)
end
function cc.Physics3DSliderConstraint:setSoftnessDirLin(float_softnessDirLin)
end
function cc.Physics3DSliderConstraint:setMaxAngMotorForce(float_maxAngMotorForce)
end
--[[
	@return float
]]
...
function cc.Physics3DSliderConstraint:setSoftnessLimAng(float_softnessLimAng)
end
--[[
...
function cc.Physics3DSliderConstraint:create(Physics3DRigidBody_rbA, Physics3DRigidBody_rbB, const_cocos2d_Mat4_frameInA, const_cocos2d_Mat4_frameInB, bool_useLinearReferenceFrameA)
end
...
function cc.Physics3DConeTwistConstraint:setFixThresh(float_fixThresh)
end
--[[
	get B's frame offse
	@return [luaIde#cocos2d_Mat4]
...
function cc.Physics3DConeTwistConstraint:setMaxMotorImpulse(float_maxMotorImpulse)
end
--[[
	set A and B's fram
]]
function cc.Physics3DConeTwistConstraint:setFrames(const_cocos2d_Mat4_frameA, const_cocos2d_Mat4_frameB)
end
--[[
	get twist angl
	@return float
...
function cc.Physics3DConeTwistConstraint:GetPointForAngle(float_fAngleInRadians, float_fLength)
end
--[[
	set max motor impulse normaliz
]]
function cc.Physics3DConeTwistConstraint:setMaxMotorImpulseNormalized(float_maxMotorImpulse)
end
--[[
	get twist spa
	@return float
...
function cc.Physics3DConeTwistConstraint:setDamping(float_damping)
end
--[[
	set limits
...
function cc.Physics3DConeTwistConstraint:setLimit(float_swingSpan1, float_swingSpan2, float_twistSpan, float_softness, float_biasFactor, float_relaxationFactor)
end
--[[
	get A's fram
	@return [luaIde#cocos2d_Mat4]
...
function cc.Physics3DConeTwistConstraint:enableMotor(bool_b)
end
--[[
...
function cc.Physics3DConeTwistConstraint:create(Physics3DRigidBody_rbA, const_cocos2d_Mat4_frameA)
end
--[[
	create cone twist constraint
	rbA rigid body A
...
function cc.Physics3DConeTwistConstraint:create(Physics3DRigidBody_rbA, Physics3DRigidBody_rbB, const_cocos2d_Mat4_frameA, const_cocos2d_Mat4_frameB)
end
...
function cc.Physics3D6DofConstraint:setLinearLowerLimit(const_cocos2d_Vec3_linearLower)
end
--[[
...
function cc.Physics3D6DofConstraint:setAngularLowerLimit(const_cocos2d_Vec3_angularLower)
end
--[[
	is limited?
...
function cc.Physics3D6DofConstraint:isLimited(int_limitIndex)
end
--[[
	set use frame offse
]]
function cc.Physics3D6DofConstraint:setUseFrameOffset(bool_frameOffsetOnOff)
end
--[[
	set linear upper limi
]]
function cc.Physics3D6DofConstraint:setLinearUpperLimit(const_cocos2d_Vec3_linearUpper)
end
--[[
...
function cc.Physics3D6DofConstraint:setAngularUpperLimit(const_cocos2d_Vec3_angularUpper)
end
--[[
...
function cc.Physics3D6DofConstraint:create(Physics3DRigidBody_rbA, Physics3DRigidBody_rbB, const_cocos2d_Mat4_frameInA, const_cocos2d_Mat4_frameInB, bool_useLinearReferenceFrameA)
end
--[[
	create 6 dof constraint
	@param rbB rigid body B
...
function cc.Physics3D6DofConstraint:create(Physics3DRigidBody_rbB, const_cocos2d_Mat4_frameInB, bool_useLinearReferenceFrameB)
end
...
function cc.PhysicsShape:setGroup(int_group)
end
--[[
...
function cc.PhysicsShape:setDensity(float_density)
end
--[[
...
function cc.PhysicsShape:setSensor(bool_sensor)
end
--[[
...
function cc.PhysicsShape:setCategoryBitmask(int_bitmask)
end
--[[
...
function cc.PhysicsShape:setMoment(float_moment)
end
--[[
...
function cc.PhysicsShape:containsPoint(const_Vec2_point)
end
--[[
...
function cc.PhysicsShape:setMass(float_mass)
end
--[[
...
function cc.PhysicsShape:setCollisionBitmask(int_bitmask)
end
--[[
...
function cc.PhysicsShape:setFriction(float_friction)
end
--[[
...
function cc.PhysicsShape:setMaterial(const_PhysicsMaterial_material)
end
--[[
	Set this shape's tag.
	@param tag An integer number that identifies a shape object.
]]
function cc.PhysicsShape:setTag(int_tag)
end
--[[
...
function cc.PhysicsShape:setContactTestBitmask(int_bitmask)
end
--[[
...
function cc.PhysicsShape:setRestitution(float_restitution)
end
--[[
...
function cc.PhysicsShapeCircle:create(float_radius, const_PhysicsMaterial_material, const_Vec2_offset)
end
--[[
...
function cc.PhysicsShapeCircle:calculateArea(float_radius)
end
--[[
	@return float
]]
function cc.PhysicsShapeCircle:calculateArea()
end
--[[
...
function cc.PhysicsShapeCircle:calculateMoment(float_mass, float_radius, const_Vec2_offset)
end
...
function cc.PhysicsShapePolygon:getPoint(int_i)
end
...
function cc.PhysicsShapeBox:create(const_Size_size, const_PhysicsMaterial_material, const_Vec2_offset, float_radius)
end
...
function cc.PhysicsShapeEdgeSegment:create(const_Vec2_a, const_Vec2_b, const_PhysicsMaterial_material, float_border)
end
...
function cc.PhysicsShapeEdgeBox:create(const_Size_size, const_PhysicsMaterial_material, float_border, const_Vec2_offset)
end
...
function cc.PhysicsBody:setGroup(int_group)
end
--[[
	Get the body mass.
	@return float
...
function cc.PhysicsBody:applyImpulse(const_Vec2_impulse, const_Vec2_offset)
end
--[[
	set body rotation offset, it's the rotation witch relative to node
]]
function cc.PhysicsBody:setRotationOffset(float_rotation)
end
--[[
...
function cc.PhysicsBody:applyForce(const_Vec2_force, const_Vec2_offset)
end
--[[
...
function cc.PhysicsBody:addShape(PhysicsShape_shape, bool_addMassAndMoment)
end
--[[
	Applies a torque force to body.
	@param torque The torque is applies to this body.
]]
function cc.PhysicsBody:applyTorque(float_torque)
end
--[[
...
function cc.PhysicsBody:setAngularVelocityLimit(float_limit)
end
--[[
...
function cc.PhysicsBody:removeAllShapes(bool_reduceMassAndMoment)
end
--[[
	Set angular damping.
...
function cc.PhysicsBody:setAngularDamping(float_damping)
end
--[[
	set the max of velocity
]]
function cc.PhysicsBody:setVelocityLimit(float_limit)
end
--[[
	set body to rest
]]
function cc.PhysicsBody:setResting(bool_rest)
end
--[[
...
function cc.PhysicsBody:setCategoryBitmask(int_bitmask)
end
--[[
...
function cc.PhysicsBody:setGravityEnable(bool_enable)
end
--[[
...
function cc.PhysicsBody:setMoment(float_moment)
end
--[[
	Get the body's tag.
	@return int
...
function cc.PhysicsBody:local2World(const_Vec2_point)
end
--[[
	Return bitmask of first shape.
	@return int   If there is no shape in body, return default value.(0xFFFFFFFF)
...
function cc.PhysicsBody:setDynamic(bool_dynamic)
end
--[[
...
function cc.PhysicsBody:setAngularVelocity(float_velocity)
end
--[[
	Convert the world point to local.
	@return [luaIde#cc.Vec2]
]]
function cc.PhysicsBody:world2Local(const_Vec2_point)
end
--[[
...
function cc.PhysicsBody:removeShape(PhysicsShape_shape, bool_reduceMassAndMoment)
end
--[[
	@brief Remove a shape from body.
...
function cc.PhysicsBody:removeShape(int_tag, bool_reduceMassAndMoment)
end
--[[
...
function cc.PhysicsBody:setMass(float_mass)
end
--[[
...
function cc.PhysicsBody:addMoment(float_moment)
end
--[[
	Set the velocity of a body.
	@param velocity The velocity is set to this body.
]]
function cc.PhysicsBody:setVelocity(const_Vec2_velocity)
end
--[[
	Set linear damping.
	it is used to simulate fluid or air friction forces on the body.
...
function cc.PhysicsBody:setLinearDamping(float_damping)
end
--[[
	A mask that defines which categories of physics bodies can collide with this physics body.
	When two physics bodies contact each other, a collision may occur. This body's collision mask is compared to the other body's category mask by performing a logical AND operation. If the result is a non-zero value, then this body is affected by the collision. Each body independently chooses whether it wants to be affected by the other body. For example, you might use this to avoid collision calculations that would make negligible changes to a body's velocity.
...
function cc.PhysicsBody:setCollisionBitmask(int_bitmask)
end
--[[
	set body position offset, it's the position witch relative to node
]]
function cc.PhysicsBody:setPositionOffset(const_Vec2_position)
end
--[[
	Set the body is allow rotation or not
]]
function cc.PhysicsBody:setRotationEnable(bool_enable)
end
--[[
...
function cc.PhysicsBody:getVelocityAtLocalPoint(const_Vec2_point)
end
--[[
...
function cc.PhysicsBody:addMass(float_mass)
end
--[[
...
function cc.PhysicsBody:getShape(int_tag)
end
--[[
	set the body's tag.
]]
function cc.PhysicsBody:setTag(int_tag)
end
--[[
	get the angular velocity of a body at a world point
	@return [luaIde#cc.Vec2]
]]
function cc.PhysicsBody:getVelocityAtWorldPoint(const_Vec2_point)
end
--[[
	A mask that defines which categories of bodies cause intersection notifications with this physics body.
	When two bodies share the same space, each body's category mask is tested against the other body's contact mask by performing a logical AND operation. If either comparison results in a non-zero value, an PhysicsContact object is created and passed to the physics world’s delegate. For best performance, only set bits in the contacts mask for interactions you are interested in.
...
function cc.PhysicsBody:setContactTestBitmask(int_bitmask)
end
--[[
...
function cc.PhysicsBody:createBox(const_Size_size, const_PhysicsMaterial_material, const_Vec2_offset)
end
--[[
...
function cc.PhysicsBody:createEdgeSegment(const_Vec2_a, const_Vec2_b, const_PhysicsMaterial_material, float_border)
end
--[[
...
function cc.PhysicsBody:create()
end
--[[
...
function cc.PhysicsBody:create(float_mass)
end
--[[
...
function cc.PhysicsBody:create(float_mass, float_moment)
end
--[[
...
function cc.PhysicsBody:createEdgeBox(const_Size_size, const_PhysicsMaterial_material, float_border, const_Vec2_offset)
end
--[[
...
function cc.PhysicsBody:createCircle(float_radius, const_PhysicsMaterial_material, const_Vec2_offset)
end
...
function cc.PhysicsContactPreSolve:setFriction(float_friction)
end
--[[
...
function cc.PhysicsContactPreSolve:setSurfaceVelocity(const_Vec2_velocity)
end
--[[
	Set the restitution
]]
function cc.PhysicsContactPreSolve:setRestitution(float_restitution)
end
...
function cc.EventListenerPhysicsContactWithBodies:hitTest(PhysicsShape_shapeA, PhysicsShape_shapeB)
end
--[[
	Create the listener.
	@return [luaIde#cc.EventListenerPhysicsContactWithBodies]
]]
function cc.EventListenerPhysicsContactWithBodies:create(PhysicsBody_bodyA, PhysicsBody_bodyB)
end
...
function cc.EventListenerPhysicsContactWithShapes:hitTest(PhysicsShape_shapeA, PhysicsShape_shapeB)
end
--[[
	Create the listener.
	@return [luaIde#cc.EventListenerPhysicsContactWithShapes]
]]
function cc.EventListenerPhysicsContactWithShapes:create(PhysicsShape_shapeA, PhysicsShape_shapeB)
end
...
function cc.EventListenerPhysicsContactWithGroup:hitTest(PhysicsShape_shapeA, PhysicsShape_shapeB)
end
--[[
	Create the listener.
	@return [luaIde#cc.EventListenerPhysicsContactWithGroup]
]]
function cc.EventListenerPhysicsContactWithGroup:create(int_group)
end
...
function cc.PhysicsJoint:setMaxForce(float_force)
end
--[[
...
function cc.PhysicsJoint:setEnable(bool_enable)
end
--[[
	Enable/disable the collision between two bodies.
]]
function cc.PhysicsJoint:setCollisionEnable(bool_enable)
end
--[[
...
function cc.PhysicsJoint:setTag(int_tag)
end
--[[
...
function cc.PhysicsJointFixed:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr)
end
...
function cc.PhysicsJointLimit:setAnchr2(const_Vec2_anchr2)
end
--[[
	Set the anchor point on body a
]]
function cc.PhysicsJointLimit:setAnchr1(const_Vec2_anchr1)
end
--[[
	Set the max distance of the anchor points
]]
function cc.PhysicsJointLimit:setMax(float_max)
end
--[[
...
function cc.PhysicsJointLimit:setMin(float_min)
end
--[[
...
function cc.PhysicsJointLimit:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr1, const_Vec2_anchr2)
end
--[[
	Create a limit joint.
	@param a A is the body to connect.
...
function cc.PhysicsJointLimit:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr1, const_Vec2_anchr2, float_min, float_max)
end
...
function cc.PhysicsJointPin:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_pivot)
end
--[[
	Create a pin joint.
	@param a A is the body to connect.
...
function cc.PhysicsJointPin:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr1, const_Vec2_anchr2)
end
...
function cc.PhysicsJointDistance:setDistance(float_distance)
end
--[[
...
function cc.PhysicsJointDistance:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr1, const_Vec2_anchr2)
end
...
function cc.PhysicsJointSpring:setAnchr2(const_Vec2_anchr2)
end
--[[
	Set the anchor point on body a
]]
function cc.PhysicsJointSpring:setAnchr1(const_Vec2_anchr1)
end
--[[
...
function cc.PhysicsJointSpring:setStiffness(float_stiffness)
end
--[[
	Get the distance of the anchor points
	@return float
...
function cc.PhysicsJointSpring:setRestLength(float_restLength)
end
--[[
	Set the spring soft constant
]]
function cc.PhysicsJointSpring:setDamping(float_damping)
end
--[[
	Create a fixed distance joint.
	@param a A is the body to connect.
...
function cc.PhysicsJointSpring:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_anchr1, const_Vec2_anchr2, float_stiffness, float_damping)
end
...
function cc.PhysicsJointGroove:setAnchr2(const_Vec2_anchr2)
end
--[[
	Set the line begin positio
]]
function cc.PhysicsJointGroove:setGrooveA(const_Vec2_grooveA)
end
--[[
	Set the line end positio
]]
function cc.PhysicsJointGroove:setGrooveB(const_Vec2_grooveB)
end
--[[
...
function cc.PhysicsJointGroove:construct(PhysicsBody_a, PhysicsBody_b, const_Vec2_grooveA, const_Vec2_grooveB, const_Vec2_anchr2)
end
...
function cc.PhysicsJointRotarySpring:setRestAngle(float_restAngle)
end
--[[
	Get the spring constant
	@return float
...
function cc.PhysicsJointRotarySpring:setStiffness(float_stiffness)
end
--[[
	Set the spring soft constant
]]
function cc.PhysicsJointRotarySpring:setDamping(float_damping)
end
--[[
...
function cc.PhysicsJointRotarySpring:construct(PhysicsBody_a, PhysicsBody_b, float_stiffness, float_damping)
end
...
function cc.PhysicsJointRotaryLimit:setMin(float_min)
end
--[[
	Set the max rotation limit
]]
function cc.PhysicsJointRotaryLimit:setMax(float_max)
end
--[[
...
function cc.PhysicsJointRotaryLimit:construct(PhysicsBody_a, PhysicsBody_b, float_min, float_max)
end
--[[
	Create a limit rotary joint.
	@param a A is the body to connect.
...
function cc.PhysicsJointRotaryLimit:construct(PhysicsBody_a, PhysicsBody_b)
end
...
function cc.PhysicsJointRatchet:setAngle(float_angle)
end
--[[
	@return bool
]]
...
function cc.PhysicsJointRatchet:setPhase(float_phase)
end
--[[
...
function cc.PhysicsJointRatchet:setRatchet(float_ratchet)
end
--[[
...
function cc.PhysicsJointRatchet:construct(PhysicsBody_a, PhysicsBody_b, float_phase, float_ratchet)
end
...
function cc.PhysicsJointGear:setRatio(float_ratchet)
end
--[[
...
function cc.PhysicsJointGear:setPhase(float_phase)
end
--[[
	@return bool
]]
...
function cc.PhysicsJointGear:construct(PhysicsBody_a, PhysicsBody_b, float_phase, float_ratio)
end
...
function cc.PhysicsJointMotor:setRate(float_rate)
end
--[[
...
function cc.PhysicsJointMotor:construct(PhysicsBody_a, PhysicsBody_b, float_rate)
end
...
function cc.PhysicsWorld:setGravity(const_Vec2_gravity)
end
--[[
...
function cc.PhysicsWorld:setFixedUpdateRate(int_updatesPerSecond)
end
--[[
...
function cc.PhysicsWorld:setSubsteps(int_steps)
end
--[[
...
function cc.PhysicsWorld:setAutoStep(bool_autoStep)
end
--[[
...
function cc.PhysicsWorld:addJoint(PhysicsJoint_joint)
end
--[[
...
function cc.PhysicsWorld:removeAllJoints(bool_destroy)
end
--[[
...
function cc.PhysicsWorld:setPreUpdateCallback()
end
--[[
...
function cc.PhysicsWorld:setPostUpdateCallback()
end
--[[
...
function cc.PhysicsWorld:removeBody(PhysicsBody_body)
end
--[[
	Remove body by tag.
...
function cc.PhysicsWorld:removeBody(int_tag)
end
--[[
...
function cc.PhysicsWorld:removeJoint(PhysicsJoint_joint, bool_destroy)
end
--[[
...
function cc.PhysicsWorld:getShapes(const_Vec2_point)
end
--[[
...
function cc.PhysicsWorld:step(float_delta)
end
--[[
...
function cc.PhysicsWorld:setDebugDrawMask(int_mask)
end
--[[
...
function cc.PhysicsWorld:setUpdateRate(int_rate)
end
--[[
	get the number of substeps
	@return int
]]
function cc.PhysicsWorld:getFixedUpdateRate()
end
--[[
...
function cc.PhysicsWorld:setSpeed(float_speed)
end
--[[
...
function cc.PhysicsWorld:getShape(const_Vec2_point)
end
--[[
	Get a body by tag.
	@param   tag   An integer number that identifies a PhysicsBody object.
...
function cc.PhysicsWorld:getBody(int_tag)
end
...
sp.SkeletonRenderer = {}
function sp.SkeletonRenderer:setTimeScale(float_scale)
end
--[[
	@return bool
]]
...
function sp.SkeletonRenderer:setDebugSlotsEnabled(bool_enabled)
end
function sp.SkeletonRenderer:setDebugMeshesEnabled(bool_enabled)
end
--[[
	Whether two color tinting is enabled
	@return bool
]]
function sp.SkeletonRenderer:isTwoColorTint()
end
function sp.SkeletonRenderer:setDebugBonesEnabled(bool_enabled)
end
--[[
	@return bool
]]
...
function sp.SkeletonRenderer:setTwoColorTint(bool_enabled)
end
--[[
	@return bool
]]
function sp.SkeletonRenderer:getDebugMeshesEnabled()
end
--[[
	Sets the vertex effect to be used, set to 0 to disable vertex effects
]]
function sp.SkeletonRenderer:setVertexEffect(spVertexEffect_effect)
end
--[[
...
function sp.SkeletonAnimation:findAnimation(const_std_string_name)
end
...
function ccs.ActionFrame:getAction(float_duration)
end
--[[
	Gets the ActionInterval of ActionFrame.
	@param duration   the duration time of ActionFrame
...
function ccs.ActionFrame:getAction(float_duration, ActionFrame_srcFrame)
end
--[[
...
function ccs.ActionFrame:setFrameTime(float_fTime)
end
--[[
	Changes the easing type.
	@param easingType the easing type.
]]
function ccs.ActionFrame:setEasingType(int_easingType)
end
--[[
...
function ccs.ActionMoveFrame:setPosition(cocos2d_Vec2_pos)
end
--[[
	Gets the ActionInterval of ActionFrame.
	@param duration   the duration time of ActionFrame
...
function ccs.ActionMoveFrame:getAction(float_duration)
end
--[[
...
function ccs.ActionScaleFrame:setScaleY(float_scaleY)
end
--[[
	Changes the scale action scaleX.
	@param the scale action scaleX.
]]
function ccs.ActionScaleFrame:setScaleX(float_scaleX)
end
--[[
...
function ccs.ActionScaleFrame:getAction(float_duration)
end
...
function ccs.ActionRotationFrame:setRotation(float_rotation)
end
--[[
	Gets the ActionInterval of ActionFrame.
	@param duration   the duration time of ActionFrame
...
function ccs.ActionRotationFrame:getAction(float_duration)
end
--[[
	Gets the ActionInterval of ActionFrame.
	@param duration   the duration time of ActionFrame
...
function ccs.ActionRotationFrame:getAction(float_duration, ActionFrame_srcFrame)
end
--[[
...
function ccs.ActionFadeFrame:getAction(float_duration)
end
--[[
	Changes the fade action opacity.
	@param opacity the fade action opacity
]]
function ccs.ActionFadeFrame:setOpacity(int_opacity)
end
...
function ccs.ActionTintFrame:getAction(float_duration)
end
--[[
	Changes the tint action color.
	@param ccolor the tint action color
]]
function ccs.ActionTintFrame:setColor(cocos2d_Color3B_ccolor)
end
...
function ccs.ActionObject:setCurrentTime(float_fTime)
end
--[[
	Pause the action.
]]
...
function ccs.ActionObject:setName(const_char_name)
end
--[[
	Sets the time interval of frame.
	@param fTime   the time interval of frame
]]
function ccs.ActionObject:setUnitTime(float_fTime)
end
--[[
...
function ccs.ActionObject:play()
end
--[[
	Play the action.
	@param func Action Call Back
]]
function ccs.ActionObject:play(cocos2d_CallFunc_func)
end
--[[
...
function ccs.ActionObject:removeActionNode(ActionNode_node)
end
--[[
...
function ccs.ActionObject:addActionNode(ActionNode_node)
end
--[[
...
function ccs.ActionObject:updateToFrameByTime(float_fTime)
end
--[[
	Sets if the action will loop play.
	@param bLoop     that if the action will loop play
]]
function ccs.ActionObject:setLoop(bool_bLoop)
end
--[[
	scheduler update functio
]]
function ccs.ActionObject:simulationActionUpdate(float_dt)
end
...
function ccs.ActionManagerEx:stopActionByName(const_char_jsonName, const_char_actionName)
end
--[[
...
function ccs.ActionManagerEx:getActionByName(const_char_jsonName, const_char_actionName)
end
--[[
	@return int
]]
function ccs.ActionManagerEx:getStudioVersionNumber()
end
--[[
...
function ccs.ActionManagerEx:playActionByName(const_char_jsonName, const_char_actionName)
end
--[[
	Play an Action with a name.
	@param jsonName  UI file name
...
function ccs.ActionManagerEx:playActionByName(const_char_jsonName, const_char_actionName, cocos2d_CallFunc_func)
end
--[[
	Release all actions.
]]
...
function ccs.BaseData:setColor(const_cocos2d_Color4B_color)
end
...
ccs.DisplayData = {}
function ccs.DisplayData:copy(DisplayData_displayData)
end
--[[
	@return std_string
]]
function ccs.DisplayData:changeDisplayToTexture(const_std_string_displayName)
end
...
function ccs.SpriteDisplayData:copy(DisplayData_displayData)
end
...
function ccs.ArmatureDisplayData:new()
end
...
function ccs.ParticleDisplayData:new()
end
...
function ccs.BoneData:getDisplayData(int_index)
end
--[[
	@return bool
]]
...
function ccs.BoneData:addDisplayData(DisplayData_displayData)
end
...
ccs.ArmatureData = {}
function ccs.ArmatureData:addBoneData(BoneData_boneData)
end
--[[
	@return bool
]]
...
function ccs.ArmatureData:getBoneData(const_std_string_boneName)
end
...
ccs.FrameData = {}
function ccs.FrameData:copy(const_BaseData_baseData)
end
...
function ccs.MovementBoneData:getFrameData(int_index)
end
function ccs.MovementBoneData:addFrameData(FrameData_frameData)
end
...
function ccs.MovementData:getMovementBoneData(const_std_string_boneName)
end
function ccs.MovementData:addMovementBoneData(MovementBoneData_movBoneData)
end
...
function ccs.AnimationData:getMovement(const_std_string_movementName)
end
--[[
	@return ssize_t
]]
...
function ccs.AnimationData:addMovement(MovementData_movData)
end
...
function ccs.ContourData:addVertex(cocos2d_Vec2_vertex)
end
...
function ccs.TextureData:getContourData(int_index)
end
--[[
	@return bool
]]
...
function ccs.TextureData:addContourData(ContourData_contourData)
end
...
function ccs.Tween:gotoAndPause(int_frameIndex)
end
--[[
	Start the Process
...
function ccs.Tween:play(MovementBoneData_movementBoneData, int_durationTo, int_durationTween, int_loop, int_tweenEasing)
end
function ccs.Tween:gotoAndPlay(int_frameIndex)
end
--[[
	Init with a Bone
...
function ccs.Tween:init(Bone_bone)
end
function ccs.Tween:setAnimation(ArmatureAnimation_animation)
end
--[[
	Create with a Bone
	@param bone the Bone Tween will bind to
...
function ccs.Tween:create(Bone_bone)
end
...
function ccs.DisplayManager:removeDisplay(int_index)
end
function ccs.DisplayManager:setForceChangeDisplay(bool_force)
end
--[[
	@return bool
]]
function ccs.DisplayManager:init(Bone_bone)
end
--[[
	@return [luaIde#cocos2d_Size]
]]
...
function ccs.DisplayManager:addDisplay(DisplayData_displayData, int_index)
end
--[[
	Check if the position is inside the bone.
	@return bool
]]
function ccs.DisplayManager:containPoint(cocos2d_Vec2__point)
end
--[[
	Check if the position is inside the bone.
	@return bool
]]
function ccs.DisplayManager:containPoint(float_x, float_y)
end
--[[
...
function ccs.DisplayManager:changeDisplayWithIndex(int_index, bool_force)
end
function ccs.DisplayManager:changeDisplayWithName(const_std_string_name, bool_force)
end
--[[
	@return bool
]]
...
function ccs.DisplayManager:setVisible(bool_visible)
end
--[[
	@return [luaIde#ccs.DisplayManager]
]]
function ccs.DisplayManager:create(Bone_bone)
end
...
function ccs.Bone:setBlendFunc(const_cocos2d_BlendFunc_blendFunc)
end
--[[
	@return bool
]]
...
function ccs.Bone:addChildBone(Bone_child)
end
--[[
...
function ccs.Bone:setTransformDirty(bool_dirty)
end
--[[
	@return [luaIde#DisplayType]
]]
...
function ccs.Bone:removeDisplay(int_index)
end
function ccs.Bone:setBoneData(BoneData_boneData)
end
--[[
...
function ccs.Bone:init(const_std_string_name)
end
--[[
	Set parent bone.
...
function ccs.Bone:setParentBone(Bone_parent)
end
--[[
...
function ccs.Bone:addDisplay(DisplayData_displayData, int_index)
end
--[[
...
function ccs.Bone:removeFromParent(bool_recursion)
end
--[[
...
function ccs.Bone:changeDisplayWithIndex(int_index, bool_force)
end
function ccs.Bone:changeDisplayWithName(const_std_string_name, bool_force)
end
function ccs.Bone:setArmature(Armature_armature)
end
--[[
	Set if blend function is dirty
]]
function ccs.Bone:setBlendDirty(bool_dirty)
end
--[[
	Removes a child Bone
	@param     bone   the bone you want to remove
]]
function ccs.Bone:removeChildBone(Bone_bone, bool_recursion)
end
function ccs.Bone:setChildArmature(Armature_childArmature)
end
--[[
	@return [luaIde#cocos2d_Mat4]
]]
...
function ccs.Bone:create(const_std_string_name)
end
...
function ccs.ArmatureAnimation:play(const_std_string_animationName, int_durationTo, int_loop)
end
--[[
	Go to specified frame and pause current movement.
]]
function ccs.ArmatureAnimation:gotoAndPause(int_frameIndex)
end
function ccs.ArmatureAnimation:playWithIndexes(int_durationTo, bool_loop)
end
function ccs.ArmatureAnimation:setAnimationData(AnimationData_data)
end
--[[
	Scale animation play speed.
	@param animationScale Scale value
]]
function ccs.ArmatureAnimation:setSpeedScale(float_speedScale)
end
--[[
...
function ccs.ArmatureAnimation:gotoAndPlay(int_frameIndex)
end
--[[
...
function ccs.ArmatureAnimation:init(Armature_armature)
end
function ccs.ArmatureAnimation:playWithNames(int_durationTo, bool_loop)
end
--[[
	Get movement count
	@return ssize_t
...
function ccs.ArmatureAnimation:playWithIndex(int_animationIndex, int_durationTo, int_loop)
end
--[[
...
function ccs.ArmatureAnimation:create(Armature_armature)
end
...
function ccs.ArmatureDataManager:removeAnimationData(const_std_string_id)
end
--[[
	Add armature data
...
function ccs.ArmatureDataManager:addArmatureData(const_std_string_id, ArmatureData_armatureData, const_std_string_configFilePath)
end
--[[
	@brief    Add ArmatureFileInfo, it is managed by ArmatureDataManager.
]]
function ccs.ArmatureDataManager:addArmatureFileInfo(const_std_string_configFilePath)
end
--[[
	@brief    Add ArmatureFileInfo, it is managed by ArmatureDataManager.
]]
function ccs.ArmatureDataManager:addArmatureFileInfo(const_std_string_imagePath, const_std_string_plistPath, const_std_string_configFilePath)
end
function ccs.ArmatureDataManager:removeArmatureFileInfo(const_std_string_configFilePath)
end
--[[
...
function ccs.ArmatureDataManager:getTextureData(const_std_string_id)
end
--[[
...
function ccs.ArmatureDataManager:getArmatureData(const_std_string_id)
end
--[[
...
function ccs.ArmatureDataManager:getAnimationData(const_std_string_id)
end
--[[
...
function ccs.ArmatureDataManager:addAnimationData(const_std_string_id, AnimationData_animationData, const_std_string_configFilePath)
end
--[[
...
function ccs.ArmatureDataManager:removeArmatureData(const_std_string_id)
end
--[[
...
function ccs.ArmatureDataManager:removeTextureData(const_std_string_id)
end
--[[
...
function ccs.ArmatureDataManager:addTextureData(const_std_string_id, TextureData_textureData, const_std_string_configFilePath)
end
--[[
...
function ccs.ArmatureDataManager:addSpriteFrameFromFile(const_std_string_plistPath, const_std_string_imagePath, const_std_string_configFilePath)
end
...
function ccs.Armature:getBone(const_std_string_name)
end
--[[
...
function ccs.Armature:changeBoneParent(Bone_bone, const_std_string_parentName)
end
function ccs.Armature:setAnimation(ArmatureAnimation_animation)
end
--[[
	@return [luaIde#ccs.Bone]
]]
function ccs.Armature:getBoneAtPoint(float_x, float_y)
end
--[[
	@return bool
]]
...
function ccs.Armature:setVersion(float_version)
end
--[[
...
function ccs.Armature:removeBone(Bone_bone, bool_recursion)
end
--[[
	@return [luaIde#ccs.BatchNode]
]]
...
function ccs.Armature:init(const_std_string_name)
end
function ccs.Armature:setParentBone(Bone_parentBone)
end
function ccs.Armature:setBatchNode(BatchNode_batchNode)
end
function ccs.Armature:setArmatureData(ArmatureData_armatureData)
end
--[[
...
function ccs.Armature:addBone(Bone_bone, const_std_string_parentName)
end
--[[
...
function ccs.Armature:setBlendFunc(const_cocos2d_BlendFunc_blendFunc)
end
--[[
...
function ccs.Armature:create(const_std_string_name)
end
...
function ccs.Skin:setBone(Bone_bone)
end
--[[
	@return [luaIde#ccs.Skin]
]]
function ccs.Skin:create()
end
--[[
	@return [luaIde#ccs.Skin]
]]
function ccs.Skin:create(const_std_string_pszFileName)
end
--[[
	@return [luaIde#ccs.Skin]
]]
function ccs.Skin:createWithSpriteFrameName(const_std_string_pszSpriteFrameName)
end
...
function ccs.ComAttribute:getFloat(const_std_string_key, float_def)
end
--[[
	@return std_string
]]
function ccs.ComAttribute:getString(const_std_string_key, const_std_string_def)
end
function ccs.ComAttribute:setFloat(const_std_string_key, float_value)
end
function ccs.ComAttribute:setString(const_std_string_key, const_std_string_value)
end
--[[
	@return bool
]]
function ccs.ComAttribute:getBool(const_std_string_key, bool_def)
end
function ccs.ComAttribute:setInt(const_std_string_key, int_value)
end
--[[
	@return bool
]]
function ccs.ComAttribute:parse(const_std_string_jsonFile)
end
--[[
	@return int
]]
function ccs.ComAttribute:getInt(const_std_string_key, int_def)
end
function ccs.ComAttribute:setBool(const_std_string_key, bool_value)
end
--[[
...
function ccs.ComAudio:stopEffect(unsigned_int_nSoundId)
end
--[[
	@return float
]]
...
function ccs.ComAudio:setBackgroundMusicVolume(float_volume)
end
--[[
	play the effect sound path in _filePath
]]
function ccs.ComAudio:start()
end
function ccs.ComAudio:stopBackgroundMusic(bool_bReleaseData)
end
...
function ccs.ComAudio:preloadBackgroundMusic(const_char_pszFilePath)
end
function ccs.ComAudio:playBackgroundMusic(const_char_pszFilePath, bool_bLoop)
end
function ccs.ComAudio:playBackgroundMusic()
end
--[[
	stop the effect sound which started with latest start()
]]
function ccs.ComAudio:stop()
end
--[[
	@return int
]]
function ccs.ComAudio:playEffect(const_char_pszFilePath, bool_bLoop)
end
--[[
	@return int
]]
function ccs.ComAudio:playEffect()
end
function ccs.ComAudio:preloadEffect(const_char_pszFilePath)
end
function ccs.ComAudio:setLoop(bool_bLoop)
end
function ccs.ComAudio:unloadEffect(const_char_pszFilePath)
end
function ccs.ComAudio:rewindBackgroundMusic()
end
function ccs.ComAudio:pauseEffect(unsigned_int_nSoundId)
end
function ccs.ComAudio:resumeBackgroundMusic()
end
function ccs.ComAudio:setFile(const_char_pszFilePath)
end
function ccs.ComAudio:setEffectsVolume(float_volume)
end
--[[
	@return char
]]
...
function ccs.ComAudio:resumeEffect(unsigned_int_nSoundId)
end
--[[
...
ccs.ComRender = {}
function ccs.ComRender:setNode(cocos2d_Node_node)
end
--[[
	@return [luaIde#cocos2d_Node]
]]
...
ccs.GUIReader = {}
function ccs.GUIReader:setFilePath(const_std_string_strFilePath)
end
--[[
	@return [luaIde#cocos2d_ui_Widget]
]]
function ccs.GUIReader:widgetFromJsonFile(const_char_fileName)
end
--[[
	@return std_string
]]
...
function ccs.GUIReader:widgetFromBinaryFile(const_char_fileName)
end
--[[
	@return int
]]
function ccs.GUIReader:getVersionInteger(const_char_str)
end
...
ccs.SceneReader = {}
function ccs.SceneReader:setTarget()
end
--[[
	@return [luaIde#cocos2d_Node]
]]
function ccs.SceneReader:createNodeWithSceneFile(const_std_string_fileName, AttachComponentType_attachComponent)
end
--[[
...
function ccs.SceneReader:getNodeByTag(int_nTag)
end
--[[
	@js purge
...
function ccs.ActionTimelineCache:createActionFromJson(const_std_string_fileName)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
function ccs.ActionTimelineCache:createActionWithFlatBuffersFile(const_std_string_fileName)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
function ccs.ActionTimelineCache:loadAnimationActionWithFlatBuffersFile(const_std_string_fileName)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
function ccs.ActionTimelineCache:createActionFromContent(const_std_string_fileName, const_std_string_content)
end
...
function ccs.ActionTimelineCache:loadAnimationActionWithContent(const_std_stringfileName, const_std_string_content)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
function ccs.ActionTimelineCache:loadAnimationActionWithFile(const_std_string_fileName)
end
--[[
	Remove action with filename, and also remove other resource relate with this file
]]
function ccs.ActionTimelineCache:removeAction(const_std_string_fileName)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
function ccs.ActionTimelineCache:createActionWithFlatBuffersForSimulator(const_std_string_fileName)
end
--[[
...
function ccs.ActionTimelineCache:createAction(const_std_string_fileName)
end
...
function ccs.Frame:setTweenType()
end
function ccs.Frame:setNode()
end
function ccs.Frame:setTimeline()
end
...
function ccs.Frame:setEasingParams()
end
function ccs.Frame:getFrameIndex()
end
function ccs.Frame:apply()
end
function ccs.Frame:isTween()
end
function ccs.Frame:setFrameIndex()
end
function ccs.Frame:setTween()
end
...
function ccs.VisibleFrame:setVisible(bool_visible)
end
--[[
...
ccs.TextureFrame = {}
function ccs.TextureFrame:new()
end
function ccs.TextureFrame:getTextureName()
end
function ccs.TextureFrame:setTextureName()
end
...
ccs.RotationFrame = {}
function ccs.RotationFrame:setRotation(float_rotation)
end
--[[
	@return float
]]
...
function ccs.SkewFrame:setSkewX(float_skewx)
end
function ccs.SkewFrame:setSkewY(float_skewy)
end
--[[
	@return float
]]
...
function ccs.PositionFrame:setPosition(const_cocos2d_Point_position)
end
function ccs.PositionFrame:setX(float_x)
end
function ccs.PositionFrame:setY(float_y)
end
--[[
...
ccs.ScaleFrame = {}
function ccs.ScaleFrame:new()
end
function ccs.ScaleFrame:setScaleY()
end
function ccs.ScaleFrame:setScaleX()
end
function ccs.ScaleFrame:getScaleY()
end
function ccs.ScaleFrame:getScaleX()
end
function ccs.ScaleFrame:setScale()
end
...
function ccs.AnchorPointFrame:setAnchorPoint(const_cocos2d_Point_point)
end
--[[
	@return [luaIde#cocos2d_Point]
]]
...
function ccs.InnerActionFrame:new()
end
...
function ccs.InnerActionFrame:setEndFrameIndex()
end
function ccs.InnerActionFrame:setEnterWithName()
end
function ccs.InnerActionFrame:setSingleFrameIndex()
end
function ccs.InnerActionFrame:setStartFrameIndex()
end
function ccs.InnerActionFrame:getSingleFrameIndex()
end
function ccs.InnerActionFrame:setInnerActionType()
end
function ccs.InnerActionFrame:setAnimationName()
end
...
ccs.ColorFrame = {}
function ccs.ColorFrame:new()
end
function ccs.ColorFrame:getColor()
end
function ccs.ColorFrame:setColor()
end
...
function ccs.AlphaFrame:setAlpha(GLubyte_alpha)
end
--[[
...
ccs.EventFrame = {}
function ccs.EventFrame:new()
end
function ccs.EventFrame:setEvent()
end
...
function ccs.ZOrderFrame:setZOrder(int_zorder)
end
--[[
...
function ccs.BlendFuncFrame:setBlendFunc(cocos2d_BlendFunc_blendFunc)
end
--[[
...
function ccs.PlayableFrame:setPlayableAct(std_string_playact)
end
--[[
	@return std_string
]]
function ccs.PlayableFrame:getPlayableAct()
end
--[[
	@return [luaIde#ccs.PlayableFrame]
]]
function ccs.PlayableFrame:create()
end
...
function ccs.Timeline:gotoFrame(int_frameIndex)
end
function ccs.Timeline:setNode(cocos2d_Node_node)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
...
function ccs.Timeline:insertFrame(Frame_frame, int_index)
end
function ccs.Timeline:setActionTag(int_tag)
end
function ccs.Timeline:addFrame(Frame_frame)
end
--[[
...
function ccs.Timeline:removeFrame(Frame_frame)
end
function ccs.Timeline:setActionTimeline(ActionTimeline_action)
end
function ccs.Timeline:stepToFrame(int_frameIndex)
end
--[[
	@return [luaIde#ccs.Timeline]
]]
...
function ccs.ActionTimelineData:setActionTag(int_actionTag)
end
--[[
	@return bool
]]
function ccs.ActionTimelineData:init(int_actionTag)
end
--[[
	@return int
]]
...
function ccs.ActionTimelineData:create(int_actionTag)
end
...
function ccs.ActionTimeline:clearFrameEndCallFuncs()
end
--[[
...
function ccs.ActionTimeline:setAnimationEndCallFunc(const_std_string_animationName)
end
--[[
	add Timeline to ActionTimeline
]]
function ccs.ActionTimeline:addTimeline(Timeline_timeline)
end
--[[
	Get current frame.
	@return int
...
function ccs.ActionTimeline:start()
end
--[[
	@return bool
]]
...
function ccs.ActionTimeline:removeTimeline(Timeline_timeline)
end
...
function ccs.ActionTimeline:setLastFrameCallFunc()
end
--[[
...
function ccs.ActionTimeline:play(std_string_animationName, bool_loop)
end
--[[
	@return [luaIde#AnimationInfo]
]]
function ccs.ActionTimeline:getAnimationInfo(const_std_string_animationName)
end
--[[
...
function ccs.ActionTimeline:addFrameEndCallFunc(int_frameIndex, const_std_string_funcKey)
end
function ccs.ActionTimeline:removeAnimationInfo(std_string_animationName)
end
--[[
...
function ccs.ActionTimeline:addAnimationInfo(const_AnimationInfo_animationInfo)
end
--[[
	@return int
]]
...
function ccs.ActionTimeline:gotoFrameAndPause(int_startIndex)
end
--[[
...
function ccs.ActionTimeline:removeFrameEndCallFuncs(int_frameIndex)
end
--[[
	Goto the specified frame index, and start playing from this index.
	@param startIndex The animation will play from this index.
]]
function ccs.ActionTimeline:gotoFrameAndPlay(int_startIndex)
end
--[[
	Goto the specified frame index, and start playing from this index.
	@param startIndex The animation will play from this index.
...
function ccs.ActionTimeline:gotoFrameAndPlay(int_startIndex, bool_loop)
end
--[[
...
function ccs.ActionTimeline:gotoFrameAndPlay(int_startIndex, int_endIndex, bool_loop)
end
--[[
	Goto the specified frame index, and start playing from start index, end at end index.
	@param startIndex The animation will play from this index.
...
function ccs.ActionTimeline:gotoFrameAndPlay(int_startIndex, int_endIndex, int_currentFrameIndex, bool_loop)
end
--[[
	@return bool
]]
function ccs.ActionTimeline:IsAnimationInfoExists(const_std_string_animationName)
end
--[[
...
function ccs.ActionTimeline:setTimeSpeed(float_speed)
end
...
function ccs.ActionTimeline:setDuration(int_duration)
end
--[[
	Set current frame index, this will cause action plays to this frame.
]]
function ccs.ActionTimeline:setCurrentFrame(int_frameIndex)
end
--[[
	remove callback function after frameIndex which identified with funcKey
]]
function ccs.ActionTimeline:removeFrameEndCallFunc(int_frameIndex, const_std_string_funcKey)
end
--[[
	@return [luaIde#ccs.ActionTimeline]
]]
...
function ccs.ActionTimelineNode:setActionTimeline(ActionTimeline_action)
end
--[[
	@return bool
]]
...
function ccs.ActionTimelineNode:setRoot(cocos2d_Node_root)
end
--[[
	@return [luaIde#ccs.ActionTimelineNode]
]]
function ccs.ActionTimelineNode:create(cocos2d_Node_root, ActionTimeline_action)
end
...
function ccs.BoneNode:getDebugDrawWidth()
end
--[[
	get child bone list
	@return [luaIde#cocos2d_Vector__BoneNode__]
]]
function ccs.BoneNode:getChildBones()
end
function ccs.BoneNode:getBlendFunc()
end
--[[
	@brief: get all bones in this bone tree
	@return [luaIde#cocos2d_Vector__BoneNode__]
]]
function ccs.BoneNode:getAllSubBones()
end
--[[
	blendFunc
]]
function ccs.BoneNode:setBlendFunc(const_cocos2d_BlendFunc_blendFunc)
end
--[[
	when bone's added to skeleton, DebugDrawEnabled controlled by skeleton's DebugDrawEnabled
]]
function ccs.BoneNode:setDebugDrawEnabled(bool_isDebugDraw)
end
--[[
	get displayings rect in self transform
	@return [luaIde#cocos2d_Rect]
]]
function ccs.BoneNode:getVisibleSkinsRect()
end
--[[
	@brief: get all skins in this bone tree
	@return [luaIde#cocos2d_Vector__SkinNode__]
]]
function ccs.BoneNode:getAllSubSkins()
end
--[[
	@brief: display skin
	@param: hideOthers, set other skins invisible
]]
function ccs.BoneNode:displaySkin(SkinNode_skin, bool_hideOthers)
end
--[[
...
function ccs.BoneNode:displaySkin(const_std_string_skinName, bool_hideOthers)
end
--[[
	@return bool
]]
function ccs.BoneNode:isDebugDrawEnabled()
end
--[[
	@brief: add a skin
	@param: display, whether display this skin
]]
function ccs.BoneNode:addSkin(SkinNode_skin, bool_display)
end
--[[
	@brief: add a skin
	@param: display, whether display this skin
...
function ccs.BoneNode:addSkin(SkinNode_skin, bool_display, bool_hideOthers)
end
--[[
	get this bone's root skeleton, return null while bone is not in a skeleton
	@return [luaIde#ccs.SkeletonNode]
]]
function ccs.BoneNode:getRootSkeletonNode()
end
--[[
	bone's debug draw's length
]]
function ccs.BoneNode:setDebugDrawLength(float_length)
end
--[[
	get skins in this bone's children
	@return [luaIde#cocos2d_Vector__SkinNode__]
]]
function ccs.BoneNode:getSkins()
end
--[[
	@return [luaIde#cocos2d_Vector__SkinNode__]
]]
function ccs.BoneNode:getVisibleSkins()
end
--[[
	bone's debug draw's width
]]
function ccs.BoneNode:setDebugDrawWidth(float_width)
end
--[[
	@return float
]]
function ccs.BoneNode:getDebugDrawLength()
end
--[[
	bone's debug draw's width
]]
function ccs.BoneNode:setDebugDrawColor(const_cocos2d_Color4F_color)
end
--[[
	@return [luaIde#cocos2d_Color4F]
]]
function ccs.BoneNode:getDebugDrawColor()
end
--[[
	@return [luaIde#ccs.BoneNode]
]]
function ccs.BoneNode:create()
end
...
function ccs.SkeletonNode:getBoneNode(const_std_string_boneName)
end
--[[
	@brief: change displays
	@param: boneSkinNameMap, map <name of bone, name of skin to display which added to bone>
]]
function ccs.SkeletonNode:changeSkins(_boneSkinNameMap)
end
--[[
	@brief: change displays
	@param: skinGroupName have
]]
function ccs.SkeletonNode:changeSkins(const_std_string_skinGroupName)
end
--[[
...
function ccs.SkeletonNode:addSkinGroup(std_string_groupName, boneSkinNameMap)
end
--[[
	get All bones in this skeleton, <bone's name, BoneNode>
	@return [luaIde#BoneNode__]
]]
function ccs.SkeletonNode:getAllSubBonesMap()
end
--[[
	@return [luaIde#ccs.SkeletonNode]
]]
function ccs.SkeletonNode:create()
end
...
function ccs.ComExtensionData:setActionTag(int_actionTag)
end
--[[
	@return std_string
]]
function ccs.ComExtensionData:getCustomProperty()
end
--[[
	@return int
]]
function ccs.ComExtensionData:getActionTag()
end
function ccs.ComExtensionData:setCustomProperty(const_std_string_customProperty)
end
--[[
	@return [luaIde#ccs.ComExtensionData]
]]
function ccs.ComExtensionData:create()
end
...
function ccui.LayoutParameter:copyProperties(LayoutParameter_model)
end
--[[
...
function ccui.LinearLayoutParameter:setGravity(LinearGravity_gravity)
end
--[[
...
function ccui.RelativeLayoutParameter:setAlign(RelativeAlign_align)
end
--[[
	Set widget name your widget want to relative to.
	@param name Relative widget name.
]]
function ccui.RelativeLayoutParameter:setRelativeToWidgetName(const_std_string_name)
end
--[[
...
function ccui.RelativeLayoutParameter:setRelativeName(const_std_string_name)
end
--[[
...
function ccui.Widget:setLayoutComponentEnabled(bool_enable)
end
--[[
	Changes the percent that is widget's percent size
	@param percent that is widget's percent size
]]
function ccui.Widget:setSizePercent(const_Vec2_percent)
end
--[[
...
function ccui.Widget:setFlippedX(bool_flippedX)
end
--[[
	Set callback name.
	@param callbackName A string representation of callback name.
]]
function ccui.Widget:setCallbackName(const_std_string_callbackName)
end
--[[
...
function ccui.Widget:setPropagateTouchEvents(bool_isPropagate)
end
--[[
...
function ccui.Widget:setPositionPercent(const_Vec2_percent)
end
--[[
...
function ccui.Widget:setSwallowTouches(bool_swallow)
end
--[[
...
function ccui.Widget:setHighlighted(bool_highlight)
end
--[[
...
function ccui.Widget:setPositionType(PositionType_type)
end
--[[
...
function ccui.Widget:getLayoutParameter(LayoutParameter_Type_type)
end
--[[
...
function ccui.Widget:ignoreContentAdaptWithSize(bool_ignore)
end
--[[
...
function ccui.Widget:findNextFocusedWidget(FocusDirection_direction, Widget_current)
end
--[[
...
function ccui.Widget:setFocused(bool_focus)
end
--[[
	Set the tag of action.
	@param tag  A integer tag value.
]]
function ccui.Widget:setActionTag(int_tag)
end
--[[
...
function ccui.Widget:setTouchEnabled(bool_enabled)
end
--[[
	Sets whether the widget should be flipped vertically or not.
	@param flippedY true if the widget should be flipped vertically, false otherwise.
]]
function ccui.Widget:setFlippedY(bool_flippedY)
end
--[[
...
function ccui.Widget:setEnabled(bool_enabled)
end
--[[
...
function ccui.Widget:setBrightStyle(BrightStyle_style)
end
--[[
...
function ccui.Widget:setLayoutParameter(LayoutParameter_parameter)
end
--[[
...
function ccui.Widget:setFocusEnabled(bool_enable)
end
--[[
...
function ccui.Widget:dispatchFocusEvent(Widget_widgetLoseFocus, Widget_widgetGetFocus)
end
--[[
	Toggle use unify size.
	@param enable True to use unify size, false otherwise.
]]
function ccui.Widget:setUnifySizeEnabled(bool_enable)
end
--[[
...
function ccui.Widget:hitTest(const_Vec2_pt, const_Camera_camera, Vec3_p)
end
--[[
...
function ccui.Widget:updateSizeAndPosition()
end
--[[
	Update all children's contents size and position recursively.
]]
function ccui.Widget:updateSizeAndPosition(const_Size_parentSize)
end
--[[
...
function ccui.Widget:onFocusChange(Widget_widgetLostFocus, Widget_widgetGetFocus)
end
--[[
...
function ccui.Widget:propagateTouchEvent(TouchEventType_event, Widget_sender, Touch_touch)
end
--[[
...
function ccui.Widget:isClippingParentContainsPoint(const_Vec2_pt)
end
--[[
...
function ccui.Widget:setSizeType(SizeType_type)
end
--[[
...
function ccui.Widget:interceptTouchEvent(TouchEventType_event, Widget_sender, Touch_touch)
end
--[[
...
function ccui.Widget:setBright(bool_bright)
end
--[[
	Set callback type.
	@param callbackType A string representation of callback type.
]]
function ccui.Widget:setCallbackType(const_std_string_callbackType)
end
--[[
...
function ccui.Widget:enableDpadNavigation(bool_enable)
end
--[[
...
function ccui.Widget:getCurrentFocusedWidget(bool_isWidget)
end
--[[
	Return a current focused widget in your UI scene.
	No matter what widget object you call this method on , it will return you the exact one focused widget.
...
function ccui.Layout:setBackGroundColorVector(const_Vec2_vector)
end
--[[
...
function ccui.Layout:getRenderFile()
end
--[[
...
function ccui.Layout:setBackGroundImageOpacity(GLubyte_opacity)
end
--[[
...
function ccui.Layout:setBackGroundImage(const_std_string_fileName, TextureResType_texType)
end
--[[
...
function ccui.Layout:setBackGroundColor(const_Color3B_color)
end
--[[
...
function ccui.Layout:setBackGroundColor(const_Color3B_startColor, const_Color3B_endColor)
end
--[[
...
function ccui.Layout:setClippingEnabled(bool_enabled)
end
--[[
...
function ccui.Layout:setBackGroundColorOpacity(GLubyte_opacity)
end
--[[
...
function ccui.Layout:setBackGroundImageCapInsets(const_Rect_capInsets)
end
--[[
...
function ccui.Layout:setPassFocusToChild(bool_pass)
end
--[[
...
function ccui.Layout:setBackGroundImageScale9Enabled(bool_enabled)
end
--[[
	Change the layout type.
	@param type Layout type.
]]
function ccui.Layout:setLayoutType(Type_type)
end
--[[
...
function ccui.Button:setTitleLabel(Label_label)
end
--[[
	Change the font size of button's title
	@param size Title font size in float.
]]
function ccui.Button:setTitleFontSize(float_size)
end
function ccui.Button:resetPressedRender()
end
--[[
	Enable scale9 renderer.
	@param enable Set to true will use scale9 renderer, false otherwise.
]]
function ccui.Button:setScale9Enabled(bool_enable)
end
function ccui.Button:resetDisabledRender()
end
--[[
...
function ccui.Button:getRendererClicked()
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Button:getDisabledFile()
end
--[[
...
function ccui.Button:setTitleColor(const_Color3B_color)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Button:getNormalFile()
end
function ccui.Button:resetNormalRender()
end
--[[
...
function ccui.Button:setCapInsets(const_Rect_capInsets)
end
--[[
...
function ccui.Button:loadTextureDisabled(const_std_string_disabled, TextureResType_texType)
end
function ccui.Button:loadTextureDisabled(SpriteFrame_disabledSpriteFrame)
end
--[[
	@return bool
]]
...
function ccui.Button:setTitleText(const_std_string_text)
end
--[[
	Sets capInsets for button, only the normal state scale9 renderer will be affected.
	@param capInsets    capInsets in Rect.
]]
function ccui.Button:setCapInsetsNormalRenderer(const_Rect_capInsets)
end
--[[
...
function ccui.Button:loadTexturePressed(const_std_string_selected, TextureResType_texType)
end
function ccui.Button:loadTexturePressed(SpriteFrame_pressedSpriteFrame)
end
--[[
	Change the font name of button's title
	@param fontName a font name string.
]]
function ccui.Button:setTitleFontName(const_std_string_fontName)
end
--[[
...
function ccui.Button:setTitleAlignment(TextHAlignment_hAlignment)
end
--[[
...
function ccui.Button:setTitleAlignment(TextHAlignment_hAlignment, TextVAlignment_vAlignment)
end
--[[
...
function ccui.Button:loadTextureNormal(const_std_string_normal, TextureResType_texType)
end
function ccui.Button:loadTextureNormal(SpriteFrame_normalSpriteFrame)
end
--[[
	Sets capInsets for button, only the pressed state scale9 renderer will be affected.
	@param capInsets    capInsets in Rect
]]
function ccui.Button:setCapInsetsPressedRenderer(const_Rect_capInsets)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Button:getPressedFile()
end
--[[
	returns the current Label being used
	@return [luaIde#cc.Label]
]]
function ccui.Button:getTitleLabel()
end
--[[
...
function ccui.Button:getRendererNormal()
end
--[[
...
function ccui.Button:setPressedActionEnabled(bool_enabled)
end
--[[
...
function ccui.Button:setZoomScale(float_scale)
end
--[[
	Create a empty Button.
	@return [luaIde#ccui.Button]   A empty Button instance.
]]
function ccui.Button:create()
end
...
function ccui.AbstractCheckButton:getCrossDisabledFile()
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.AbstractCheckButton:getBackDisabledFile()
end
--[[
...
function ccui.AbstractCheckButton:loadTextureBackGroundSelected(const_std_string_backGroundSelected, TextureResType_texType)
end
function ccui.AbstractCheckButton:loadTextureBackGroundSelected(SpriteFrame_spriteFrame)
end
--[[
...
function ccui.AbstractCheckButton:loadTextureBackGroundDisabled(const_std_string_backGroundDisabled, TextureResType_texType)
end
function ccui.AbstractCheckButton:loadTextureBackGroundDisabled(SpriteFrame_spriteframe)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.AbstractCheckButton:getCrossNormalFile()
end
--[[
...
function ccui.AbstractCheckButton:setSelected(bool_selected)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.AbstractCheckButton:getBackPressedFile()
end
--[[
...
function ccui.AbstractCheckButton:getRendererFrontCrossDisabled()
end
--[[
	@brief Return the sprite instance of background
	@return [luaIde#cc.Sprite]   the sprite instance of background.
]]
function ccui.AbstractCheckButton:getRendererBackground()
end
--[[
...
function ccui.AbstractCheckButton:loadTextureFrontCross(const_std_string_crossTextureName, TextureResType_texType)
end
function ccui.AbstractCheckButton:loadTextureFrontCross(SpriteFrame_spriteframe)
end
--[[
...
function ccui.AbstractCheckButton:getRendererBackgroundDisabled()
end
--[[
	Query whether CheckBox is selected or not.
	@return bool   true means "selected", false otherwise.
]]
function ccui.AbstractCheckButton:isSelected()
end
--[[
	@return bool
]]
function ccui.AbstractCheckButton:init()
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.AbstractCheckButton:getBackNormalFile()
end
--[[
	@brief Return a zoom scale
...
function ccui.AbstractCheckButton:getRendererBackgroundSelected()
end
--[[
...
function ccui.AbstractCheckButton:loadTextureBackGround(const_std_string_backGround, TextureResType_type)
end
function ccui.AbstractCheckButton:loadTextureBackGround(SpriteFrame_spriteFrame)
end
--[[
...
function ccui.AbstractCheckButton:setZoomScale(float_scale)
end
--[[
...
function ccui.AbstractCheckButton:loadTextureFrontCrossDisabled(const_std_string_frontCrossDisabled, TextureResType_texType)
end
function ccui.AbstractCheckButton:loadTextureFrontCrossDisabled(SpriteFrame_spriteframe)
end
...
function ccui.CheckBox:addEventListener(const_ccCheckBoxCallback_callback)
end
--[[
	Create and return a empty CheckBox instance pointer.
	@return [luaIde#ccui.CheckBox]
]]
function ccui.CheckBox:create()
end
...
function ccui.RadioButton:addEventListener(const_ccRadioButtonCallback_callback)
end
--[[
	Create and return a empty RadioButton instance pointer.
	@return [luaIde#ccui.RadioButton]
]]
function ccui.RadioButton:create()
end
...
function ccui.RadioButtonGroup:removeRadioButton(RadioButton_radioButton)
end
--[[
...
function ccui.RadioButtonGroup:setAllowedNoSelection(bool_allowedNoSelection)
end
--[[
	Select a radio button by index without event dispatch.
	@param index of the radio button
]]
function ccui.RadioButtonGroup:setSelectedButtonWithoutEvent(int_index)
end
--[[
	Select a radio button by instance without event dispatch.
	@param radio button instance
]]
function ccui.RadioButtonGroup:setSelectedButtonWithoutEvent(RadioButton_radioButton)
end
--[[
	Add a callback function which would be called when radio button is selected or unselected.
	@param callback A std::function with type @see `ccRadioButtonGroupCallback`
]]
function ccui.RadioButtonGroup:addEventListener(const_ccRadioButtonGroupCallback_callback)
end
--[[
	Remove all radio button from this group.
]]
function ccui.RadioButtonGroup:removeAllRadioButtons()
end
--[[
...
function ccui.RadioButtonGroup:getRadioButtonByIndex(int_index)
end
--[[
	Get the number of radio buttons in this group.
	@return ssize_t   the number of radio buttons in this group
]]
function ccui.RadioButtonGroup:getNumberOfRadioButtons()
end
--[[
	Add a radio button into this group.
	@param radio button instance
]]
function ccui.RadioButtonGroup:addRadioButton(RadioButton_radioButton)
end
--[[
	Select a radio button by index.
	@param index of the radio button
]]
function ccui.RadioButtonGroup:setSelectedButton(int_index)
end
--[[
	Select a radio button by instance.
	@param radio button instance
]]
function ccui.RadioButtonGroup:setSelectedButton(RadioButton_radioButton)
end
--[[
	Create and return a empty RadioButtonGroup instance pointer.
	@return [luaIde#ccui.RadioButtonGroup]
]]
function ccui.RadioButtonGroup:create()
end
...
function ccui.ImageView:loadTexture(const_std_string_fileName, TextureResType_texType)
end
function ccui.ImageView:loadTexture(SpriteFrame_spriteframe)
end
--[[
...
function ccui.ImageView:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	@return bool
]]
...
function ccui.ImageView:setScale9Enabled(bool_enabled)
end
--[[
	Updates the texture rect of the ImageView in points.
	It will call setTextureRect:rotated:untrimmedSize with rotated = NO, and utrimmedSize = rect.size.
]]
function ccui.ImageView:setTextureRect(const_Rect_rect)
end
--[[
...
function ccui.ImageView:setCapInsets(const_Rect_capInsets)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.ImageView:getRenderFile()
end
--[[
...
function ccui.ImageView:create(const_std_string_imageFileName, TextureResType_texType)
end
...
function ccui.Text:disableEffect(LabelEffect_effect)
end
--[[
	Return current effect type.
	@return [luaIde#LabelEffect]
]]
function ccui.Text:getLabelEffectType()
end
--[[
	Gets text color.
...
function ccui.Text:setTextVerticalAlignment(TextVAlignment_alignment)
end
--[[
...
function ccui.Text:setFontName(const_std_string_name)
end
--[[
	Sets the touch scale enabled of label.
	@param enabled Touch scale enabled of label.
]]
function ccui.Text:setTouchScaleChangeEnabled(bool_enabled)
end
--[[
	Return shadow effect offset value.
	@return [luaIde#cc.Size]
]]
function ccui.Text:getShadowOffset()
end
function ccui.Text:setString(const_std_string_text)
end
--[[
	Return the outline effect size value.
	@return int
]]
function ccui.Text:getOutlineSize()
end
--[[
	@return bool
]]
...
function ccui.Text:getShadowBlurRadius()
end
--[[
...
function ccui.Text:setTextAreaSize(const_Size_size)
end
--[[
...
function ccui.Text:enableOutline(const_Color4B_outlineColor, int_outlineSize)
end
--[[
	Return current effect color value.
	@return [luaIde#Color4B]
]]
function ccui.Text:getEffectColor()
end
--[[
	Gets the font type.
...
function ccui.Text:isShadowEnabled()
end
--[[
	Sets the font size of label.
	@param size The font size.
]]
function ccui.Text:setFontSize(float_size)
end
--[[
	Return the shadow effect color value.
	@return [luaIde#Color4B]
]]
function ccui.Text:getShadowColor()
end
--[[
	Sets text color.
	@param color Text color.
]]
function ccui.Text:setTextColor(const_Color4B_color)
end
--[[
	Only support for TTF.
	@param glowColor The color of glow.
]]
function ccui.Text:enableGlow(const_Color4B_glowColor)
end
--[[
	Provides a way to treat each character like a Sprite.
	@warning No support system font.
...
function ccui.Text:getLetter(int_lettetIndex)
end
--[[
	Sets the source blending function.
	@param blendFunc A structure with source and destination factor to specify pixel arithmetic. e.g. {GL_ONE, GL_ONE}, {GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA}.
...
function ccui.Text:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
...
function ccui.Text:setTextHorizontalAlignment(TextHAlignment_alignment)
end
--[[
	Create a Text object.
	@return [luaIde#ccui.Text]   An autoreleased Text object.
]]
function ccui.Text:create()
end
...
function ccui.TextAtlas:setString(const_std_string_value)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.TextAtlas:getRenderFile()
end
--[[
	@js NA
]]
...
function ccui.TextAtlas:create()
end
...
function ccui.LoadingBar:setPercent(float_percent)
end
--[[
...
function ccui.LoadingBar:loadTexture(const_std_string_texture, TextureResType_texType)
end
function ccui.LoadingBar:loadTexture(SpriteFrame_spriteframe)
end
--[[
...
function ccui.LoadingBar:setDirection(Direction_direction)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.LoadingBar:getRenderFile()
end
--[[
	Enable scale9 renderer.
	@param enabled Set to true will use scale9 renderer, false otherwise.
]]
function ccui.LoadingBar:setScale9Enabled(bool_enabled)
end
--[[
...
function ccui.LoadingBar:setCapInsets(const_Rect_capInsets)
end
--[[
...
function ccui.LoadingBar:create(const_std_string_textureName, float_percentage)
end
...
function ccui.ListView:setGravity(Gravity_gravity)
end
--[[
...
function ccui.ListView:getLeftPadding()
end
--[[
	@brief Query the center item
	@return [luaIde#ccui.Widget]   An item instance.
]]
function ccui.ListView:getCenterItemInCurrentView()
end
--[[
...
function ccui.ListView:getScrollDuration()
end
--[[
	Query whether the magnetic out of boundary is allowed.
	@return bool
]]
function ccui.ListView:getMagneticAllowedOutOfBoundary()
end
--[[
...
function ccui.ListView:scrollToItem(ssize_t_itemIndex, const_Vec2_positionRatioInView, const_Vec2_itemAnchorPoint)
end
--[[
...
function ccui.ListView:jumpToItem(ssize_t_itemIndex, const_Vec2_positionRatioInView, const_Vec2_itemAnchorPoint)
end
--[[
	Change padding with top padding
	@param t Top padding in float
]]
function ccui.ListView:setTopPadding(float_t)
end
--[[
...
function ccui.ListView:addEventListener(const_ccListViewCallback_callback)
end
--[[
	override methods
]]
...
function ccui.ListView:getTopmostItemInCurrentView()
end
--[[
...
function ccui.ListView:setPadding(float_l, float_t, float_r, float_b)
end
--[[
...
function ccui.ListView:getRightPadding()
end
--[[
	@brief Query the bottommost item in horizontal list
	@return [luaIde#ccui.Widget]   An item instance.
]]
function ccui.ListView:getBottommostItemInCurrentView()
end
--[[
...
function ccui.ListView:getLeftmostItemInCurrentView()
end
--[[
	Set the margin between each item in ListView.
	@param margin A margin in float.
]]
function ccui.ListView:setItemsMargin(float_margin)
end
--[[
	Get magnetic type of ListView.
	@return [luaIde#MagneticType]
]]
function ccui.ListView:getMagneticType()
end
--[[
...
function ccui.ListView:getItem(ssize_t_index)
end
--[[
	Remove an item at given index.
	@param index A given index in ssize_t.
]]
function ccui.ListView:removeItem(ssize_t_index)
end
--[[
	Get the top padding in ListView
	@return float   Top padding in float
]]
function ccui.ListView:getTopPadding()
end
--[[
...
function ccui.ListView:setLeftPadding(float_l)
end
--[[
...
function ccui.ListView:getClosestItemToPosition(const_Vec2_targetPosition, const_Vec2_itemAnchorPoint)
end
--[[
	Change padding with bottom padding
	@param b Bottom padding in float
]]
function ccui.ListView:setBottomPadding(float_b)
end
--[[
...
function ccui.ListView:setScrollDuration(float_time)
end
--[[
...
function ccui.ListView:getClosestItemToPositionInCurrentView(const_Vec2_positionRatioInView, const_Vec2_itemAnchorPoint)
end
--[[
	@brief Query the rightmost item in horizontal list
	@return [luaIde#ccui.Widget]   An item instance.
]]
function ccui.ListView:getRightmostItemInCurrentView()
end
--[[
	Change padding with right padding
	@param r Right padding in float
]]
function ccui.ListView:setRightPadding(float_r)
end
--[[
...
function ccui.ListView:setItemModel(Widget_model)
end
--[[
	Get the bottom padding in ListView
	@return float   Bottom padding in float
]]
function ccui.ListView:getBottomPadding()
end
--[[
...
function ccui.ListView:insertCustomItem(Widget_item, ssize_t_index)
end
--[[
...
function ccui.Slider:setPercent(int_percent)
end
--[[
...
function ccui.Slider:getMaxPercent()
end
--[[
...
function ccui.Slider:loadSlidBallTextureNormal(const_std_string_normal, TextureResType_resType)
end
function ccui.Slider:loadSlidBallTextureNormal(SpriteFrame_spriteframe)
end
--[[
...
function ccui.Slider:loadProgressBarTexture(const_std_string_fileName, TextureResType_resType)
end
function ccui.Slider:loadProgressBarTexture(SpriteFrame_spriteframe)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Slider:getBallNormalFile()
end
--[[
	@return [luaIde#cc.Sprite]
]]
function ccui.Slider:getSlidBallDisabledRenderer()
end
--[[
	Sets if slider is using scale9 renderer.
	@param able True that using scale9 renderer, false otherwise.
]]
function ccui.Slider:setScale9Enabled(bool_able)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Slider:getBallPressedFile()
end
--[[
	@brief Return a zoom scale
	@since v3.3
...
function ccui.Slider:setCapInsetProgressBarRenderer(const_Rect_capInsets)
end
--[[
	@return [luaIde#cc.Node]
]]
function ccui.Slider:getSlidBallRenderer()
end
--[[
	Add call back function called when slider's percent has changed to slider.
	@param callback An given call back function called when slider's percent has changed to slider.
]]
function ccui.Slider:addEventListener(const_ccSliderCallback_callback)
end
--[[
...
function ccui.Slider:setMaxPercent(int_percent)
end
--[[
...
function ccui.Slider:loadBarTexture(const_std_string_fileName, TextureResType_resType)
end
function ccui.Slider:loadBarTexture(SpriteFrame_spriteframe)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Slider:getProgressBarFile()
end
--[[
...
function ccui.Slider:updateVisualSlider()
end
--[[
...
function ccui.Slider:getCapInsetsProgressBarRenderer()
end
--[[
	@return [luaIde#cc.Sprite]
]]
function ccui.Slider:getSlidBallPressedRenderer()
end
--[[
...
function ccui.Slider:loadSlidBallTexturePressed(const_std_string_pressed, TextureResType_resType)
end
function ccui.Slider:loadSlidBallTexturePressed(SpriteFrame_spriteframe)
end
--[[
	@return [luaIde#ResourceData]
]]
function ccui.Slider:getBackFile()
end
--[[
...
function ccui.Slider:getBallDisabledFile()
end
--[[
	Sets capinsets for bar slider, if slider is using scale9 renderer.
	@param capInsets Capinsets for bar slider.
]]
function ccui.Slider:setCapInsetsBarRenderer(const_Rect_capInsets)
end
--[[
...
function ccui.Slider:setCapInsets(const_Rect_capInsets)
end
--[[
...
function ccui.Slider:loadSlidBallTextureDisabled(const_std_string_disabled, TextureResType_resType)
end
function ccui.Slider:loadSlidBallTextureDisabled(SpriteFrame_spriteframe)
end
--[[
	@return [luaIde#cc.Sprite]
]]
function ccui.Slider:getSlidBallNormalRenderer()
end
--[[
...
function ccui.Slider:setZoomScale(float_scale)
end
--[[
...
function ccui.TextField:setAttachWithIME(bool_attach)
end
--[[
...
function ccui.TextField:setPasswordStyleText(const_char_styleText)
end
--[[
...
function ccui.TextField:setFontName(const_std_string_name)
end
--[[
...
function ccui.TextField:setInsertText(bool_insertText)
end
--[[
	Change content of TextField.
	@param text A string content.
]]
function ccui.TextField:setString(const_std_string_text)
end
--[[
...
function ccui.TextField:setTextVerticalAlignment(TextVAlignment_alignment)
end
--[[
...
function ccui.TextField:addEventListener(const_ccTextFieldCallback_callback)
end
--[[
...
function ccui.TextField:setTextAreaSize(const_Size_size)
end
--[[
...
function ccui.TextField:setPasswordEnabled(bool_enable)
end
--[[
...
function ccui.TextField:setMaxLengthEnabled(bool_enable)
end
--[[
...
function ccui.TextField:setDeleteBackward(bool_deleteBackward)
end
--[[
	Set cursor position, if enabled
	@js NA
]]
function ccui.TextField:setCursorPosition(std_size_t_cursorPosition)
end
--[[
...
function ccui.TextField:setFontSize(int_size)
end
--[[
	@brief Set placeholder of TextField.
	@param value The string value of placeholder.
]]
function ccui.TextField:setPlaceHolder(const_std_string_value)
end
--[[
	Set cursor position to hit letter, if enabled
	@js NA
]]
function ccui.TextField:setCursorFromPoint(const_Vec2_point, const_Camera_camera)
end
--[[
	@brief Change the placeholder color.
	@param color A color value in `Color3B`.
]]
function ccui.TextField:setPlaceHolderColor(const_Color3B_color)
end
--[[
	@brief Change the placeholder color.
	@param color A color value in `Color4B`.
]]
function ccui.TextField:setPlaceHolderColor(const_Color4B_color)
end
--[[
	@brief Change horizontal text alignment.
	@param alignment A alignment arguments in @see `TextHAlignment`.
]]
function ccui.TextField:setTextHorizontalAlignment(TextHAlignment_alignment)
end
--[[
	@brief Change the text color.
	@param textColor The color value in `Color4B`.
]]
function ccui.TextField:setTextColor(const_Color4B_textColor)
end
--[[
	Set char showing cursor.
	@js NA
]]
function ccui.TextField:setCursorChar(char_cursor)
end
--[[
...
function ccui.TextField:setDetachWithIME(bool_detach)
end
--[[
	@brief Inquire the horizontal alignment
...
function ccui.TextField:setTouchAreaEnabled(bool_enable)
end
--[[
	@brief Change maximize input length limitation.
	@param length A character count in integer.
]]
function ccui.TextField:setMaxLength(int_length)
end
--[[
	Set enable cursor use.
	@js NA
]]
function ccui.TextField:setCursorEnabled(bool_enabled)
end
--[[
...
function ccui.TextField:setTouchSize(const_Size_size)
end
--[[
...
function ccui.TextBMFont:getRenderFile()
end
--[[
	init a bitmap font atlas with an initial string and the FNT file
]]
function ccui.TextBMFont:setFntFile(const_std_string_fileName)
end
--[[
	reset TextBMFont inner label
]]
function ccui.TextBMFont:resetRender()
end
--[[
	Allocates and initializes.
	@return [luaIde#ccui.TextBMFont]
]]
function ccui.TextBMFont:create()
end
...
function ccui.PageView:setIndicatorSpaceBetweenIndexNodes(float_spaceBetweenIndexNodes)
end
--[[
...
function ccui.PageView:insertPage(Widget_page, int_idx)
end
--[[
	@brief Set opacity of page indicator's index nodes.
	@param opacity New indicator node opacity.
]]
function ccui.PageView:setIndicatorIndexNodesOpacity(GLubyte_opacity)
end
--[[
	@brief Set opacity of page indicator's selected index.
	@param color New opacity for selected (current) index.
]]
function ccui.PageView:setIndicatorSelectedIndexOpacity(GLubyte_opacity)
end
--[[
...
function ccui.PageView:addEventListener(const_ccPageViewCallback_callback)
end
--[[
	@brief Get the page indicator's position.
	@return [luaIde#cc.Vec2]   positionAsAnchorPoint
]]
function ccui.PageView:getIndicatorPosition()
end
--[[
...
function ccui.PageView:scrollToPage(ssize_t_idx, float_time)
end
--[[
	@brief Set the page indicator's position using anchor point.
	@param positionAsAnchorPoint The position as anchor point.
]]
function ccui.PageView:setIndicatorPositionAsAnchorPoint(const_Vec2_positionAsAnchorPoint)
end
--[[
	Scroll to a page with a given index.
	@param itemIndex   A given index in the PageView. Index start from 0 to pageCount -1.
]]
function ccui.PageView:scrollToItem(ssize_t_itemIndex)
end
--[[
...
function ccui.PageView:scrollToItem(ssize_t_idx, float_time)
end
--[[
	@brief Set color of page indicator's index nodes.
	@param color New indicator node color.
]]
function ccui.PageView:setIndicatorIndexNodesColor(const_Color3B_color)
end
--[[
	@brief Get the opacity of page indicator's index nodes.
	@return [luaIde#GLubyte]   opacity
]]
function ccui.PageView:getIndicatorIndexNodesOpacity()
end
--[[
	@brief Get the page indicator's position as anchor point.
	@return [luaIde#cc.Vec2]   positionAsAnchorPoint
]]
function ccui.PageView:getIndicatorPositionAsAnchorPoint()
end
--[[
	Gets current displayed page index.
	@return ssize_t   current page index.
]]
function ccui.PageView:getCurrentPageIndex()
end
--[[
	Remove a page of PageView.
	@param page  Page to be removed.
]]
function ccui.PageView:removePage(Widget_page)
end
--[[
...
function ccui.PageView:setIndicatorIndexNodesTexture(const_std_string_texName, Widget_TextureResType_texType)
end
--[[
	@brief Query page indicator state.
	@return bool   True if page indicator is enabled, false otherwise.
]]
function ccui.PageView:getIndicatorEnabled()
end
--[[
	Remove a page at a given index of PageView.
	@param index  A given index.
]]
function ccui.PageView:removePageAtIndex(ssize_t_index)
end
--[[
	@brief Get the space between page indicator's index nodes.
	@return float   spaceBetweenIndexNodes
]]
function ccui.PageView:getIndicatorSpaceBetweenIndexNodes()
end
--[[
	Insert a page into the end of PageView.
	@param page Page to be inserted.
]]
function ccui.PageView:addPage(Widget_page)
end
--[[
...
function ccui.Helper:convertBoundingBoxToScreen(Node_node)
end
--[[
	Change the active property of Layout's @see `LayoutComponent`
	@param active A boolean value.
]]
function ccui.Helper:changeLayoutSystemActiveState(bool_active)
end
--[[
...
function ccui.Helper:seekActionWidgetByActionTag(Widget_root, int_tag)
end
--[[
...
function ccui.Helper:seekWidgetByName(Widget_root, const_std_string_name)
end
--[[
...
function ccui.Helper:seekWidgetByTag(Widget_root, int_tag)
end
--[[
...
function ccui.Helper:restrictCapInsetRect(const_Rect_capInsets, const_Size_textureSize)
end
--[[
	Refresh object and it's children layout state
	@param rootNode   A Node* or Node* descendant instance pointer.
]]
function ccui.Helper:doLayout(Node_rootNode)
end
...
function ccui.RichElement:equalType(Type_type)
end
--[[
...
function ccui.RichElement:init(int_tag, const_Color3B_color, GLubyte_opacity)
end
function ccui.RichElement:setColor(const_Color3B_color)
end
...
function ccui.RichElementText:new()
end
function ccui.RichElementText:init()
end
function ccui.RichElementText:create()
end
...
function ccui.RichElementImage:setHeight(int_height)
end
--[[
...
function ccui.RichElementImage:init(int_tag, const_Color3B_color, GLubyte_opacity, const_std_string_filePath, const_std_string_url, Widget_TextureResType_texType)
end
function ccui.RichElementImage:setWidth(int_width)
end
function ccui.RichElementImage:setUrl(const_std_string_url)
end
--[[
...
function ccui.RichElementImage:create(int_tag, const_Color3B_color, GLubyte_opacity, const_std_string_filePath, const_std_string_url, Widget_TextureResType_texType)
end
...
function ccui.RichElementCustomNode:init(int_tag, const_Color3B_color, GLubyte_opacity, Node_customNode)
end
--[[
...
function ccui.RichElementCustomNode:create(int_tag, const_Color3B_color, GLubyte_opacity, Node_customNode)
end
...
function ccui.RichElementNewLine:create(int_tag, const_Color3B_color, GLubyte_opacity)
end
...
function ccui.RichText:insertElement(RichElement_element, int_index)
end
--[[
	@brief enable the outline of a-tag
]]
function ccui.RichText:setAnchorTextOutline(bool_enable, const_Color3B_outlineColor, int_outlineSize)
end
--[[
	!< Set the font size. @param size the font size.
	@return float
]]
function ccui.RichText:getFontSize()
end
--[[
	@brief Add a RichElement at the end of RichText.
	@param element A RichElement instance.
]]
function ccui.RichText:pushBackElement(RichElement_element)
end
--[[
	!< return the current font color of a-tag
]]
function ccui.RichText:setAnchorTextBold(bool_enable)
end
--[[
	!< Set the font color of a-tag. @param face the font color.
	@return std_string
]]
function ccui.RichText:getAnchorFontColor()
end
--[[
	!< return the current text shadow offset of a-tag
	@return int
]]
function ccui.RichText:getAnchorTextShadowBlurRadius()
end
--[[
	@brief enable the shadow of a-tag
]]
function ccui.RichText:setAnchorTextShadow(bool_enable, const_Color3B_shadowColor, const_Size_offset, int_blurRadius)
end
--[[
	!< enable italic text of a-tag
	@return bool
]]
function ccui.RichText:isAnchorTextItalicEnabled()
end
--[[
	!< return the current font face
]]
function ccui.RichText:setAnchorFontColor(const_std_string_color)
end
--[[
	!< return the current font size
]]
function ccui.RichText:setFontFace(const_std_string_face)
end
--[[
	!< return the current text shadow blur radius of a-tag
]]
function ccui.RichText:setAnchorTextGlow(bool_enable, const_Color3B_glowColor)
end
--[[
	!< sets the horizontal alignment mode: LEFT, CENTER, or RIGHT
	@return [luaIde#HorizontalAlignment]
]]
function ccui.RichText:getHorizontalAlignment()
end
--[[
	!< returns the current wrapping mode
]]
function ccui.RichText:setHorizontalAlignment(HorizontalAlignment_a)
end
--[[
	!< valid style is italic text of a-tag?
]]
function ccui.RichText:setAnchorTextDel(bool_enable)
end
--[[
	!< valid outline of a-tag?
	@return [luaIde#Color3B]
]]
function ccui.RichText:getAnchorTextOutlineColor3B()
end
--[[
	!< convert a Color3B into a color string.
	@return std_string
]]
function ccui.RichText:stringWithColor4B(const_cocos2d_Color4B_color4b)
end
--[[
	@return bool
]]
function ccui.RichText:initWithXML(const_std_string_xml, const_ValueMap_defaults, const_OpenUrlHandler_handleOpenUrl)
end
--[[
	!< return the current font color of a-tag
	@return [luaIde#cocos2d_Color3B]
]]
function ccui.RichText:getAnchorFontColor3B()
end
--[[
...
function ccui.RichText:getAnchorTextGlowColor3B()
end
function ccui.RichText:openUrl(const_std_string_url)
end
--[[
	!< Set the font face. @param face the font face.
	@return std_string
]]
function ccui.RichText:getFontFace()
end
--[[
	!< returns the current horizontal alignment mode
]]
function ccui.RichText:setFontColor(const_std_string_color)
end
--[[
	!< enable the glow of a-tag
	@return bool
]]
function ccui.RichText:isAnchorTextGlowEnabled()
end
--[[
	!< set the default values
	@return [luaIde#ValueMap]
]]
function ccui.RichText:getDefaults()
end
--[[
	!< enable the underline of a-tag
	@return bool
]]
function ccui.RichText:isAnchorTextUnderlineEnabled()
end
--[[
	!< Set the font color. @param color the #RRGGBB hexadecimal notation.
	@return std_string
]]
function ccui.RichText:getFontColor()
end
--[[
	@return bool
]]
function ccui.RichText:isAnchorTextShadowEnabled()
end
--[[
	!< return the current text outline color of a-tag
	@return int
]]
function ccui.RichText:getAnchorTextOutlineSize()
end
--[[
	@brief Set vertical space between each RichElement.
	@param space Point in float.
]]
function ccui.RichText:setVerticalSpace(float_space)
end
--[[
	!< enable the strikethrough of a-tag
	@return bool
]]
function ccui.RichText:isAnchorTextDelEnabled()
end
--[[
	!< return the current text glow color of a-tag
]]
function ccui.RichText:setDefaults(const_ValueMap_defaults)
end
function ccui.RichText:setWrapMode(WrapMode_wrapMode)
end
--[[
	!< return the current font color
]]
function ccui.RichText:setFontSize(float_size)
end
--[[
	@brief Remove a RichElement at a given index.
	@param index A integer index value.
]]
function ccui.RichText:removeElement(int_index)
end
--[[
	@brief Remove specific RichElement.
	@param element A RichElement type.
]]
function ccui.RichText:removeElement(RichElement_element)
end
--[[
	!< valid style is bold text of a-tag?
]]
function ccui.RichText:setAnchorTextItalic(bool_enable)
end
--[[
	!< return the current text shadow color of a-tag
	@return [luaIde#cc.Size]
]]
function ccui.RichText:getAnchorTextShadowOffset()
end
--[[
	!< enable bold text of a-tag
	@return bool
]]
function ccui.RichText:isAnchorTextBoldEnabled()
end
--[[
	!< valid shadow of a-tag?
	@return [luaIde#Color3B]
]]
function ccui.RichText:getAnchorTextShadowColor3B()
end
--[[
	!< convert a color string into a Color3B.
	@return std_string
]]
function ccui.RichText:stringWithColor3B(const_cocos2d_Color3B_color3b)
end
--[[
	@return bool
]]
function ccui.RichText:isAnchorTextOutlineEnabled()
end
--[[
	!< return the current font color
	@return [luaIde#Color3B]
]]
function ccui.RichText:getFontColor3B()
end
--[[
	!< sets the wrapping mode: WRAP_PER_CHAR or WRAP_PER_WORD
	@return [luaIde#WrapMode]
]]
function ccui.RichText:getWrapMode()
end
--[[
	!< valid strikethrough of a-tag?
]]
function ccui.RichText:setAnchorTextUnderline(bool_enable)
end
--[[
	!< returns the default values
	@return [luaIde#cocos2d_Color3B]
]]
function ccui.RichText:color3BWithString(const_std_string_color)
end
--[[
...
function ccui.RichText:createWithXML(const_std_string_xml, const_ValueMap_defaults, const_OpenUrlHandler_handleOpenUrl)
end
...
function ccui.HBox:create(const_Size_size)
end
...
function ccui.VBox:create(const_Size_size)
end
...
function ccui.RelativeBox:create(const_Size_size)
end
...
function ccui.Scale9Sprite:resizableSpriteWithCapInsets(const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:setState(State_state)
end
--[[
	@brief Change the bottom sprite's cap inset.
	@param bottomInset The values to use for the cap inset.
]]
function ccui.Scale9Sprite:setInsetBottom(float_bottomInset)
end
--[[
...
function ccui.Scale9Sprite:initWithSpriteFrameName(const_std_string_spriteFrameName, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:initWithSpriteFrameName(const_std_string_spriteFrameName)
end
--[[
	@brief Change the top sprite's cap inset.
	@param topInset The values to use for the cap inset.
]]
function ccui.Scale9Sprite:setInsetTop(float_topInset)
end
--[[
	@return bool
]]
...
function ccui.Scale9Sprite:init(Sprite_sprite, const_Rect_rect, bool_rotated, const_Rect_capInsets)
end
--[[
	@brief Initializes a 9-slice sprite with an sprite instance.
	Once the sprite is created, you can then call its "setContentSize:" method
...
function ccui.Scale9Sprite:init(Sprite_sprite, const_Rect_rect, const_Rect_capInsets)
end
--[[
	@brief Change the preferred size of Scale9Sprite.
	@param size A delimitation zone.
]]
function ccui.Scale9Sprite:setPreferredSize(const_Size_size)
end
--[[
...
function ccui.Scale9Sprite:setSpriteFrame(SpriteFrame__spriteFrame, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:setScale9Enabled(bool_enabled)
end
--[[
...
function ccui.Scale9Sprite:initWithFile(const_std_string_file, const_Rect_rect, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:initWithFile(const_Rect_capInsets, const_std_string_file)
end
--[[
...
function ccui.Scale9Sprite:initWithFile(const_std_string_file, const_Rect_rect)
end
--[[
...
function ccui.Scale9Sprite:initWithFile(const_std_string_file)
end
--[[
...
function ccui.Scale9Sprite:setInsetLeft(float_leftInset)
end
--[[
...
function ccui.Scale9Sprite:initWithSpriteFrame(SpriteFrame_spriteFrame, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:setInsetRight(float_rightInset)
end
--[[
	@brief Create an empty Scale9Sprite.
	@return [luaIde#ccui.Scale9Sprite]   A Scale9Sprite instance.
]]
function ccui.Scale9Sprite:create()
end
--[[
...
function ccui.Scale9Sprite:create(const_std_string_file, const_Rect_rect, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:create(const_Rect_capInsets, const_std_string_file)
end
--[[
...
function ccui.Scale9Sprite:create(const_std_string_file, const_Rect_rect)
end
--[[
	Creates a 9-slice sprite with a texture file. The whole texture will be
	broken down into a 3×3 grid of equal blocks.
...
function ccui.Scale9Sprite:create(const_std_string_file)
end
--[[
...
function ccui.Scale9Sprite:createWithSpriteFrameName(const_std_string_spriteFrameName)
end
--[[
...
function ccui.Scale9Sprite:createWithSpriteFrameName(const_std_string_spriteFrameName, const_Rect_capInsets)
end
--[[
...
function ccui.Scale9Sprite:createWithSpriteFrame(SpriteFrame_spriteFrame)
end
--[[
...
function ccui.Scale9Sprite:createWithSpriteFrame(SpriteFrame_spriteFrame, const_Rect_capInsets)
end
...
ccui.EditBox = {}
function ccui.EditBox:new()
end
function ccui.EditBox:getFontSize()
end
function ccui.EditBox:keyboardDidShow()
end
function ccui.EditBox:setMaxLength()
end
function ccui.EditBox:openKeyboard()
end
function ccui.EditBox:setFontSize()
end
function ccui.EditBox:getText()
end
function ccui.EditBox:getInputMode()
end
function ccui.EditBox:initWithSizeAndBackgroundSprite()
end
function ccui.EditBox:getPlaceholderFontName()
end
function ccui.EditBox:keyboardDidHide()
end
function ccui.EditBox:setPlaceholderFontName()
end
function ccui.EditBox:getPlaceholderFontSize()
end
function ccui.EditBox:getCapInsetsDisabledRenderer()
end
function ccui.EditBox:getPlaceHolder()
end
function ccui.EditBox:setFontName()
end
function ccui.EditBox:registerScriptEditBoxHandler()
end
function ccui.EditBox:setCapInsetsDisabledRenderer()
end
function ccui.EditBox:setPlaceholderFontSize()
end
function ccui.EditBox:loadTextureDisabled()
end
function ccui.EditBox:setInputMode()
end
function ccui.EditBox:unregisterScriptEditBoxHandler()
end
function ccui.EditBox:keyboardWillShow()
end
function ccui.EditBox:setPlaceholderFontColor()
end
function ccui.EditBox:getReturnType()
end
function ccui.EditBox:setFontColor()
end
function ccui.EditBox:getFontName()
end
function ccui.EditBox:keyboardWillHide()
end
function ccui.EditBox:setCapInsetsNormalRenderer()
end
function ccui.EditBox:loadTexturePressed()
end
function ccui.EditBox:getFontColor()
end
function ccui.EditBox:getInputFlag()
end
function ccui.EditBox:initWithSizeAndTexture()
end
function ccui.EditBox:getTextHorizontalAlignment()
end
function ccui.EditBox:getCapInsetsNormalRenderer()
end
function ccui.EditBox:getCapInsetsPressedRenderer()
end
function ccui.EditBox:getScriptEditBoxHandler()
end
function ccui.EditBox:loadTextures()
end
function ccui.EditBox:setPlaceHolder()
end
function ccui.EditBox:setInputFlag()
end
function ccui.EditBox:setReturnType()
end
function ccui.EditBox:loadTextureNormal()
end
function ccui.EditBox:getMaxLength()
end
function ccui.EditBox:setCapInsetsPressedRenderer()
end
function ccui.EditBox:setText()
end
function ccui.EditBox:setPlaceholderFont()
end
function ccui.EditBox:getPlaceholderFontColor()
end
function ccui.EditBox:setCapInsets()
end
function ccui.EditBox:setFont()
end
function ccui.EditBox:setTextHorizontalAlignment()
end
function ccui.EditBox:create()
end
...
function ccui.LayoutComponent:setStretchWidthEnabled(bool_isUsed)
end
--[[
	Change percent width of owner.
	@param percentWidth Percent Width in float.
]]
function ccui.LayoutComponent:setPercentWidth(float_percentWidth)
end
--[[
...
function ccui.LayoutComponent:setAnchorPosition(const_Point_point)
end
--[[
...
function ccui.LayoutComponent:setVerticalEdge(VerticalEdge_vEage)
end
--[[
...
function ccui.LayoutComponent:setSizeWidth(float_width)
end
--[[
...
function ccui.LayoutComponent:setPercentWidthEnabled(bool_isUsed)
end
--[[
...
function ccui.LayoutComponent:setLeftMargin(float_margin)
end
--[[
...
function ccui.LayoutComponent:setPositionPercentYEnabled(bool_isUsed)
end
--[[
...
function ccui.LayoutComponent:setTopMargin(float_margin)
end
--[[
...
function ccui.LayoutComponent:setPositionPercentY(float_percentMargin)
end
--[[
	Change position percent X value.
	@param percentMargin Margin in float.
]]
function ccui.LayoutComponent:setPositionPercentX(float_percentMargin)
end
--[[
	Change right margin of owner relative to its parent.
	@param margin Margin in float.
]]
function ccui.LayoutComponent:setRightMargin(float_margin)
end
--[[
...
function ccui.LayoutComponent:setPercentHeight(float_percentHeight)
end
--[[
	Toggle enable percent only.
	@param enable True if percent only is enabled, false otherwise.
]]
function ccui.LayoutComponent:setPercentOnlyEnabled(bool_enable)
end
--[[
	Change element's horizontal dock type.
	@param hEage Horizontal dock type @see `HorizontalEdge`
]]
function ccui.LayoutComponent:setHorizontalEdge(HorizontalEdge_hEage)
end
function ccui.LayoutComponent:setPosition(const_Point_position)
end
--[[
...
function ccui.LayoutComponent:setUsingPercentContentSize(bool_isUsed)
end
--[[
...
function ccui.LayoutComponent:setSizeHeight(float_height)
end
--[[
...
function ccui.LayoutComponent:setPercentHeightEnabled(bool_isUsed)
end
--[[
...
function ccui.LayoutComponent:setPercentContentSize(const_Vec2_percent)
end
--[[
...
function ccui.LayoutComponent:setBottomMargin(float_margin)
end
--[[
	Change the content size of owner.
	@param size Content size in @see `Size`.
]]
function ccui.LayoutComponent:setSize(const_Size_size)
end
--[[
...
function ccui.LayoutComponent:bindLayoutComponent(Node_node)
end
...
function ccui.TabControl:insertTab(int_index, TabHeader_header, Layout_container)
end
--[[
...
function ccui.TabControl:ignoreHeadersTextureSize(bool_ignore)
end
--[[
	get tab header's width
	@return float   header's width
]]
function ccui.TabControl:getHeaderWidth()
end
--[[
	the header dock place of header in TabControl
	@param dockPlace The strip place
]]
function ccui.TabControl:setHeaderDockPlace(TabControl_Dock_dockPlace)
end
--[[
	set tab selected, switch the current selected tab and visible container
	@param index The index of tab
]]
function ccui.TabControl:setSelectTab(int_index)
end
--[[
	set tab selected, switch the current selected tab and visible container
	@param tabHeader The tab instance
]]
function ccui.TabControl:setSelectTab(TabHeader_tabHeader)
end
--[[
	get TabHeader
	@param index The index of tab
...
function ccui.TabControl:getTabHeader(int_index)
end
--[[
...
function ccui.TabControl:isIgnoreHeadersTextureSize()
end
--[[
...
function ccui.TabControl:setTabChangedEventListener(const_ccTabControlCallback_callback)
end
--[[
	set the delta zoom of selected tab
	@param zoom The delta zoom
]]
function ccui.TabControl:setHeaderSelectedZoom(float_zoom)
end
--[[
	set header height, affect all tab
	@param headerHeight each tab header's height
]]
function ccui.TabControl:setHeaderHeight(float_headerHeight)
end
--[[
...
function ccui.TabControl:indexOfTabHeader(const_TabHeader_tabCell)
end
--[[
	get Container
	@param index The index of tab
...
function ccui.TabControl:getTabContainer(int_index)
end
--[[
	get the delta zoom of selected tab
	@return float   zoom, the delta zoom
]]
function ccui.TabControl:getHeaderSelectedZoom()
end
--[[
	get tab header's height
	@return int   header's height
]]
function ccui.TabControl:getHeaderHeight()
end
--[[
	@return [luaIde#ccui.TabControl]
]]
function ccui.TabControl:create()
end
...
function cc.AABB:reset()
end
--[[
	Sets this bounding box to the specified values.
]]
function cc.AABB:set(const_Vec3_min, const_Vec3_max)
end
--[[
	Transforms the bounding box by the given transformation matrix.
]]
function cc.AABB:transform(const_Mat4_mat)
end
--[[
	Gets the center point of the bounding box.
	@return [luaIde#cc.Vec3]
]]
function cc.AABB:getCenter()
end
--[[
	check the AABB object is empty(reset).
	@return bool
]]
function cc.AABB:isEmpty()
end
--[[
...
function cc.AABB:getCorners(Vec3_dst)
end
--[[
	update the _min and _max from the given point.
]]
function cc.AABB:updateMinMax(const_Vec3_point, ssize_t_num)
end
--[[
	check whether the point is in.
	@return bool
]]
function cc.AABB:containPoint(const_Vec3_point)
end
...
function cc.OBB:reset()
end
--[[
	Specify obb values
]]
function cc.OBB:set(const_Vec3_center, const_Vec3__xAxis, const_Vec3__yAxis, const_Vec3__zAxis, const_Vec3__extents)
end
--[[
	Transforms the obb by the given transformation matrix.
]]
function cc.OBB:transform(const_Mat4_mat)
end
--[[
	Check point in
	@return bool
]]
function cc.OBB:containPoint(const_Vec3_point)
end
--[[
	Check intersect with other
	@return bool
]]
function cc.OBB:intersects(const_OBB_box)
end
--[[
...
function cc.OBB:getCorners(Vec3_verts)
end
...
function cc.Ray:set(const_Vec3_origin, const_Vec3_direction)
end
--[[
	Transforms this ray by the given transformation matrix.
	@param matrix The transformation matrix to transform by.
]]
function cc.Ray:transform(const_Mat4_matrix)
end
--[[
	Check whether this ray intersects with the specified AABB.
	@return bool
]]
function cc.Ray:intersects(const_AABB_aabb, float_distance)
end
--[[
	Check whether this ray intersects with the specified OBB.
	@return bool
]]
function cc.Ray:intersects(const_OBB_obb, float_distance)
end
--[[
	@return [luaIde#cc.Vec3]
]]
function cc.Ray:intersects(const_Plane_plane)
end
...
function cc.GLNode:setShaderProgram()
end
...
function ScriptHandlerMgr:removeObjectAllHandlers(void_object)
end

CCPoint = {}
function CCPoint:new()
end
function CCPoint:new_local()
end

CCRect = {}
function CCRect:new()
end
function CCRect:new_local()
end

CCSize = {}
function CCSize:new()
end
function CCSize:new_local()
end
...
function CCArray:createWithObject()
end
function CCArray:createWithArray()
end
function CCArray:createWithCapacity()
end
function CCArray:createWithContentsOfFile()
end
function CCArray:count()
end
function CCArray:capacity()
end
function CCArray:indexOfObject()
end
function CCArray:objectAtIndex()
end
function CCArray:lastObject()
end
function CCArray:randomObject()
end
function CCArray:isEqualToArray()
end
function CCArray:containsObject()
end
function CCArray:addObject()
end
function CCArray:addObjectsFromArray()
end
function CCArray:insertObject()
end
function CCArray:removeLastObject()
end
function CCArray:removeObject()
end
function CCArray:removeObjectAtIndex()
end
function CCArray:removeObjectsInArray()
end
function CCArray:removeAllObjects()
end
function CCArray:fastRemoveObject()
end
function CCArray:fastRemoveObjectAtIndex()
end
function CCArray:exchangeObject()
end
function CCArray:exchangeObjectAtIndex()
end
function CCArray:reverseObjects()
end
function CCArray:reduceMemoryFootprint()
end
function CCArray:replaceObjectAtIndex()
end
...
CCString = {}
function CCString:intValue()
end
function CCString:uintValue()
end
function CCString:floatValue()
end
function CCString:doubleValue()
end
function CCString:boolValue()
end
function CCString:getCString()
end
function CCString:length()
end
function CCString:compare()
end
function CCString:isEqual()
end
function CCString:create()
end
function CCString:createWithData()
end
function CCString:createWithContentsOfFile()
end
...
cc.LabelBMFont = {}
function cc.LabelBMFont:setLineBreakWithoutSpace(bool_breakWithoutSpace)
end
--[[
	@return bool
]]
function cc.LabelBMFont:isOpacityModifyRGB()
end
--[[
	@return [luaIde#cc.Sprite]
]]
function cc.LabelBMFont:getLetter(int_ID)
end
--[[
	@return std_string
]]
function cc.LabelBMFont:getString()
end
function cc.LabelBMFont:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	super method
]]
function cc.LabelBMFont:setString(const_std_string_newString)
end
--[[
	init a bitmap font atlas with an initial string and the FNT file
	@return bool
]]
function cc.LabelBMFont:initWithString(const_std_string_str, const_std_string_fntFile, float_width, TextHAlignment_alignment, const_Vec2_imageOffset)
end
function cc.LabelBMFont:setOpacityModifyRGB(bool_isOpacityModifyRGB)
end
--[[
	@return std_string
]]
function cc.LabelBMFont:getFntFile()
end
function cc.LabelBMFont:setFntFile(const_std_string_fntFile, const_Vec2_imageOffset)
end
function cc.LabelBMFont:setAlignment(TextHAlignment_alignment)
end
function cc.LabelBMFont:setWidth(float_width)
end
--[[
	creates a bitmap font atlas with an initial string and the FNT file
	@return [luaIde#cc.LabelBMFont]
]]
function cc.LabelBMFont:create(const_std_string_str, const_std_string_fntFile, float_width, TextHAlignment_alignment, const_Vec2_imageOffset)
end
--[[
	Creates an label.
	@return [luaIde#cc.LabelBMFont]
]]
function cc.LabelBMFont:create()
end
...
function cc.LabelTTF:enableShadow(const_Size_shadowOffset, float_shadowOpacity, float_shadowBlur, bool_mustUpdateTexture)
end
function cc.LabelTTF:setDimensions(const_Size_dim)
end
--[[
	@return float
]]
function cc.LabelTTF:getFontSize()
end
--[[
	@return std_string
]]
function cc.LabelTTF:getString()
end
function cc.LabelTTF:setFlippedY(bool_flippedY)
end
function cc.LabelTTF:setFlippedX(bool_flippedX)
end
--[[
	set the text definition used by this label
]]
function cc.LabelTTF:setTextDefinition(const_FontDefinition_theDefinition)
end
function cc.LabelTTF:setFontName(const_std_string_fontName)
end
--[[
	@return [luaIde#TextHAlignment]
]]
function cc.LabelTTF:getHorizontalAlignment()
end
--[[
	initializes the LabelTTF with a font name, alignment, dimension and font size
	@return bool
]]
function cc.LabelTTF:initWithStringAndTextDefinition(const_std_string_string, FontDefinition_textDefinition)
end
--[[
	changes the string to render
	@warning Changing the string is as expensive as creating a new LabelTTF. To obtain better performance use LabelAtlas
]]
function cc.LabelTTF:setString(const_std_string_label)
end
--[[
	set text tinting
]]
function cc.LabelTTF:setFontFillColor(const_Color3B_tintColor, bool_mustUpdateTexture)
end
--[[
	enable or disable stroke
]]
function cc.LabelTTF:enableStroke(const_Color3B_strokeColor, float_strokeSize, bool_mustUpdateTexture)
end
--[[
	@return [luaIde#cc.Size]
]]
function cc.LabelTTF:getDimensions()
end
function cc.LabelTTF:setVerticalAlignment(TextVAlignment_verticalAlignment)
end
function cc.LabelTTF:setFontSize(float_fontSize)
end
--[[
	@return [luaIde#TextVAlignment]
]]
function cc.LabelTTF:getVerticalAlignment()
end
--[[
	get the text definition used by this label
	@return [luaIde#cc.FontDefinition]
]]
function cc.LabelTTF:getTextDefinition()
end
function cc.LabelTTF:setBlendFunc(const_BlendFunc_blendFunc)
end
--[[
	@return std_string
]]
function cc.LabelTTF:getFontName()
end
function cc.LabelTTF:setHorizontalAlignment(TextHAlignment_alignment)
end
--[[
	disable shadow rendering
]]
function cc.LabelTTF:disableShadow(bool_mustUpdateTexture)
end
--[[
	disable stroke
]]
function cc.LabelTTF:disableStroke(bool_mustUpdateTexture)
end
--[[
	Creates an label.
	@return [luaIde#cc.LabelTTF]
]]
function cc.LabelTTF:create()
end
--[[
	Create a label with string and a font definitio
	@return [luaIde#cc.LabelTTF]
]]
function cc.LabelTTF:createWithFontDefinition(const_std_string_string, FontDefinition_textDefinition)
end
...
function cc.CCBProxy:createCCBReader()
end
--[[
	Read a ccb file.
...
function cc.CCBProxy:readCCBFromFile(const_char_pszFileName, CCBReader_pCCBReader, bool_bSetOwner)
end
--[[
...
function cc.CCBProxy:getNodeTypeName(Node_pNode)
end
--[[
...
function cc.CCBProxy:setCallback(Node_node, int_handle, int_controlEvents)
end
...
function ccs.CustomGUIReader:create(std_string_className, int_createFunc, int_setPropsFunc)
end
...
function cc.XMLHttpRequest:open()
end
function cc.XMLHttpRequest:send()
end
function cc.XMLHttpRequest:abort()
end
function cc.XMLHttpRequest:setRequestHeader()
end
function cc.XMLHttpRequest:getAllResponseHeaders()
end
function cc.XMLHttpRequest:getResponseHeader()
end
function cc.XMLHttpRequest:registerScriptHandler()
end
...
function cc.Layer:onTouch(callback, isMultiTouches, swallowTouches)
...
function cc.Layer:onKeypad(callback)
...
function cc.Layer:onAccelerate(callback)
...
function cc.MenuItem:onClicked(callback)
    self:registerScriptTapHandler(callback)
    return self
end

function cc.MenuItem:registerScriptTapHandler(callback)
end
function cc.MenuItem:unregisterScriptTapHandler(callback)
end
...
function cc.Node:addTo(parent, zorder, tag)
    if tag then
...
function cc.Node:moveTo(args)
    transition.moveTo(self, args)
    return self
end

function cc.Node:moveBy(args)
    transition.moveBy(self, args)
    return self
end

function cc.Node:fadeIn(args)
    transition.fadeIn(self, args)
    return self
end

function cc.Node:fadeOut(args)
    transition.fadeOut(self, args)
    return self
end

function cc.Node:fadeTo(args)
    transition.fadeTo(self, args)
    return self
end

function cc.Node:rotate(rotation)
    self:setRotation(rotation)
    return self
end

function cc.Node:rotateTo(args)
    transition.rotateTo(self, args)
    return self
end

function cc.Node:rotateBy(args)
    transition.rotateBy(self, args)
    return self
end

function cc.Node:scaleTo(args)
    transition.scaleTo(self, args)
    return self
end

function cc.Node:onUpdate(callback)
...
function cc.Node:onNodeEvent(eventName, callback)
...
function cc.Node:onEnter()
end

function cc.Node:onExit()
end

function cc.Node:onEnterTransitionFinish()
end

function cc.Node:onExitTransitionStart()
end

function cc.Node:onCleanup()
end
--[[
    @desc: 
    --@hander: 方法
...
function cc.Node:registerScriptHandler(hander)
end
function cc.Node:unregisterScriptHandler()
end

function cc.Sprite:playAnimationOnce(animation, args)
    local actions = {}
...
function ccui.CheckBox:onEvent(callback)
...
function ccui.EditBox:onEditHandler(callback)
    self:registerScriptEditBoxHandler(
...
function ccui.EditBox:removeEditHandler()
    self:unregisterScriptEditBoxHandler()
    return self
end

function ccui.ListView:onEvent(callback)
    self:addEventListener(
        function(sender, eventType)
            local event = {}
            if eventType == 0 then
...
function ccui.ListView:onScroll(callback)
    self:addScrollViewEventListener(
        function(sender, eventType)
            local event = {}
            if eventType == 0 then
...
function ccui.PageView:onEvent(callback)
    self:addEventListener(
        function(sender, eventType)
            local event = {}
            if eventType == 0 then
...
function ccui.ScrollView:onEvent(callback)
    self:addEventListener(
        function(sender, eventType)
            local event = {}
            if eventType == 0 then
...
function ccui.TextField:onEvent(callback)
    self:addEventListener(
        function(sender, eventType)
            local event = {}
            if eventType == 0 then
...
function ccui.Widget:onTouch(callback)
