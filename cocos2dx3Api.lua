...
function cc.Console:delCommand() end 
function cc.Console:stop() end 
function cc.Console:listenOnFileDescriptor() end 
function cc.Console:setCommandSeparator() end 
function cc.Console:setBindAddress() end 
function cc.Console:isIpv6Server() end 
...
function cc.Node:_setLocalZOrder(std_int32_t_z) end
--[[
...
function cc.Node:setLocalZOrder(std_int32_t_localZOrder) end
--[[
...
function cc.GLView:getSafeAreaRect() end
--[[
...
function cc.GLView:setDefaultIcon() end
--[[
...
function cc.GLView:setCursor(const_std_string_filename,Vec2_hotspot) end
--[[
	Get retina factor.
...
function cc.Director:getSafeAreaRect() end
--[[
...
function cc.Director:getClearColor() end
--[[
...
function cc.DrawNode:setIsolated(bool_isolated) end
--[[
...
function cc.DrawNode:isIsolated() end
--[[
...
function cc.Label:getLabelType() end
--[[
...
function cc.Label:getRenderingFontSize() end
--[[
...
function ccexp.VideoPlayer:isUserInputEnabled() end
--[[
...
function ccexp.VideoPlayer:setStyle(StyleType_style) end
--[[
...
function ccexp.VideoPlayer:isLooping() end
--[[
...
function ccexp.VideoPlayer:setLooping(bool_looping) end
--[[
...
function ccexp.VideoPlayer:setUserInputEnabled(bool_enableInput) end
...
function cc.ScrollView:stopScroll() end
--[[
...
function cc.ScrollView:stopOverallScroll() end
--[[
...
function cc.PhysicsWorld:setPreUpdateCallback() end
--[[
...
function cc.PhysicsWorld:setPostUpdateCallback() end
--[[
...
function sp.SkeletonRenderer:setDebugMeshesEnabled(bool_enabled) end
--[[
	Whether two color tinting is enabled
	@return bool
]]
function sp.SkeletonRenderer:isTwoColorTint() end
...
function sp.SkeletonRenderer:setTwoColorTint(bool_enabled) end
--[[
	@return bool
]]
function sp.SkeletonRenderer:getDebugMeshesEnabled() end
--[[
	Sets the vertex effect to be used, set to 0 to disable vertex effects
]]
function sp.SkeletonRenderer:setVertexEffect(spVertexEffect_effect) end
--[[
...
function ccui.Text:setBlendFunc(const_BlendFunc_blendFunc) end
--[[
...
function ccui.Slider:updateVisualSlider() end
--[[
...
function ccui.EditBox:openKeyboard() end 
...
function ccui.EditBox:getCapInsetsDisabledRenderer() end 
...
function ccui.EditBox:setCapInsetsDisabledRenderer() end 
function ccui.EditBox:setPlaceholderFontSize() end 
function ccui.EditBox:loadTextureDisabled() end 
...
function ccui.EditBox:setCapInsetsNormalRenderer() end 
function ccui.EditBox:loadTexturePressed() end 
function ccui.EditBox:getFontColor() end 
function ccui.EditBox:getInputFlag() end 
function ccui.EditBox:initWithSizeAndTexture() end 
function ccui.EditBox:getTextHorizontalAlignment() end 
function ccui.EditBox:getCapInsetsNormalRenderer() end 
function ccui.EditBox:getCapInsetsPressedRenderer() end 
function ccui.EditBox:getScriptEditBoxHandler() end 
function ccui.EditBox:loadTextures() end 
function ccui.EditBox:setPlaceHolder() end 
function ccui.EditBox:setInputFlag() end 
function ccui.EditBox:setReturnType() end 
function ccui.EditBox:loadTextureNormal() end 
function ccui.EditBox:getMaxLength() end 
function ccui.EditBox:setCapInsetsPressedRenderer() end 
...
function ccui.EditBox:setCapInsets() end 
...
function cc.Node:registerScriptHandler(hander) end
function cc.Node:unregisterScriptHandler()end
