local ChallengeFubenRewardCell =
    class(
    "ChallengeFubenRewardCell",
    function()
...
function ChallengeFubenRewardCell:getContentSize()
    ...
    local node = CCBReaderLoad("challenge/challengeFuben_reward_item.ccbi", proxy, rootNode)
...
function ChallengeFubenRewardCell:updateItem(itemData)
    ...
    self._rootnode["title_icon"]:setSpriteFrame(display.newSprite("#cfb_reward_title_" .. itemData.iconName .. ".png"):getSpriteFrame())
...
function ChallengeFubenRewardCell:create(param)
    ...
    local node = CCBReaderLoad("challenge/challengeFuben_reward_item.ccbi", proxy, self._rootnode)
