...
function BattleLayer:init(param)
    ...
    self.rootnode = {}
    self.bg = CCBReaderLoad("battle_bg/" .. bgCCB .. ".ccbi", proxy, self.rootnode, self, cc.size(display.width, display.height))
    ...
    self.countLayer = display.newLayer(cc.c4b(0, 0, 0, 170))
...
function BattleLayer:initBattle()
    ...
    local function createCardByData(data, isEnemy)
        ...
        local card =
            require("game.Charactor.characterCard").new(
            {
                isExist = true,
                id = cardID,
                isTouchAble = false,
