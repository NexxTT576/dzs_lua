...
function DuiHuanItemView:refresh(param)
    ...
    if data.exchNum == 0 then
        duihuanBtn:setSpriteFrame(display.newSprite("#duihuan_p.png"):getSpriteFrame())
        shuaxinBtn:setSpriteFrame(display.newSprite("#shuaxin_p.png"):getSpriteFrame())
        duihuanBtn:setTouchEnabled(false)
        shuaxinBtn:setTouchEnabled(false)
    else
        duihuanBtn:setSpriteFrame(display.newSprite("#duihuan_n.png"):getSpriteFrame())
        shuaxinBtn:setSpriteFrame(display.newSprite("#shuaxin_n.png"):getSpriteFrame())
