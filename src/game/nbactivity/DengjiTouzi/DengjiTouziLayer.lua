...
function DengjiTouziLayer:buyFunc()
    ...
    local msgBox =
        require("game.nbactivity.DengjiTouzi.DengjiTouziBuyMsgbox").new(
        {
...
function DengjiTouziLayer:ctor(param)
    ...
    local node = CCBReaderLoad("nbhuodong/dengjiTouzi_layer.ccbi", proxy, self._rootnode, self, viewSize)
    self:addChild(node)
