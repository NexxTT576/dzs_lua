...
function WaBaoGiftItemView:setUpView()
    ...
    local itemsViewBngs =
        ...
        {
            scale9 = true,
            size = cc.size(containnerSize.width - self._padding.left - self._padding.right, containnerSize.height - self._padding.top - self._padding.down - marginTop)
        }
