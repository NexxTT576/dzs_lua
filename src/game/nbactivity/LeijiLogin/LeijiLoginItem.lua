...
function LeijiLoginItem:getContentSize()
    ...
    local node = CCBReaderLoad("nbhuodong/leijiLogin_item.ccbi", proxy, rootNode)
...
function LeijiLoginItem:create(param)
    ...
    local node = CCBReaderLoad("nbhuodong/leijiLogin_item.ccbi", proxy, self._rootnode)
