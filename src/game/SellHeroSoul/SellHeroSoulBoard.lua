--[[
 ...
 --
 --]]
local SellHeroSoulBoard =
    class(
    "SellHeroSoulBoard",
    function(setBgVisible, typeIndex)
...
function SellHeroSoulBoard:ctor(setBgVisible, typeIndex)
    ...
    local sellByStars =
        require("utility.CommonButton").new(
        {
            ...
            font = sellByStarFont,
            listener = function(...)
                local sellByStarBoard =
                    require("game.SellHeroSoul.ChoseStarLvlLayer").new(
                    {
    ...
    local heroScrollLayer =
        require("app.ui.CScrollLayer").new(
        {
