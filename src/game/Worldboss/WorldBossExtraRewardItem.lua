--[[
 ...
 --
 --]]
local WorldBossExtraRewardItem =
    class(
    "WorldBossExtraRewardItem",
    function()
...
function WorldBossExtraRewardItem:getContentSize()
    ...
    local node = CCBReaderLoad("huodong/worldBoss_extraReward_item.ccbi", proxy, rootNode)
...
function WorldBossExtraRewardItem:refreshItem(cellData)
    ...
    self._rootnode["title_bg_icon"]:setSpriteFrame(display.newSprite(titleBgName):getSpriteFrame())
...
function WorldBossExtraRewardItem:create(param)
    ...
    local node = CCBReaderLoad("huodong/worldBoss_extraReward_item.ccbi", proxy, self._rootnode)
