...
FONT_COLOR = {
    ...
    LEVEL_NAME = cc.c3b(255, 246, 0) -- cc.c3b(252,234,206)
}

NAME_COLOR = {cc.c3b(141, 141, 141), FONT_COLOR.GREEN, cc.c3b(0, 146, 238), FONT_COLOR.PURPLE, cc.c3b(224, 169, 0)}

NAME_COLOR_HEX = {"#8d8d8d", "#00e430", "#0092ee", "#c000ff", "#e0a900"}

QUALITY_COLOR = {
    [1] = cc.c3b(141, 141, 141),
    [2] = FONT_COLOR.GREEN,
    [3] = cc.c3b(0, 146, 238),
    [4] = FONT_COLOR.PURPLE,
    [5] = cc.c3b(224, 169, 0)
