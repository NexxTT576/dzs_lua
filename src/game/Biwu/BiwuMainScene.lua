...
function BiwuMainScene:initTopRadios(index)
    local group
    group =
        cc.ui.UICheckBoxButtonGroup.new(display.LEFT_TO_RIGHT):addButton(cc.ui.UICheckBoxButton.new(RADIO_BUTTON_IMAGES.biwu):align(display.LEFT_CENTER)):addButton(
        cc.ui.UICheckBoxButton.new(RADIO_BUTTON_IMAGES.chouren):align(display.LEFT_CENTER)
...
function BiwuMainScene:loadRes()
    display.loadSpriteFrames("ui/biwu_main.plist", "ui/biwu_main.png")
    display.loadSpriteFrames("ui/ui_herolist_v2.plist", "ui/ui_herolist_v2.png")
    display.loadSpriteFrames("ui/ui_jingmai.plist", "ui/ui_jingmai.png")
    display.loadSpriteFrames("ui/ui_duobao.plist", "ui/ui_duobao.png")
    display.loadSpriteFrames("ui/ui_arena.plist", "ui/ui_arena.png")
    display.loadSpriteFrames("ui/ui_weijiao_yishou.plist", "ui/ui_weijiao_yishou.png")
    display.loadSpriteFrames("ui/ui_friend.plist", "ui/ui_friend.png")
    display.loadSpriteFrames("ui/ui_zhenrong.plist", "ui/ui_zhenrong.png")
...
function BiwuMainScene:releaseRes()
    display.removeSpriteFrames("ui/biwu_main.plist", "ui/biwu_main.png")
    display.removeSpriteFrames("ui/ui_herolist_v2.plist", "ui/ui_herolist_v2.png")
    display.removeSpriteFrames("ui/ui_jingmai.plist", "ui/ui_jingmai.png")
    ...
    display.removeSpriteFrames("ui/ui_toplayer.plist", "ui/ui_toplayer.png")
