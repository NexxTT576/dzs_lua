...
function BiwuDuihuanItem:refresh(param)
    ...
    --内容背景框
    self:setContentSize(param.viewSize)
    local contentBng = display.newSprite("#arena_item_inner_bg.png", 0, 0, {scale9 = true, size = cc.size(viewSize.width * 0.7, viewSize.height * 0.65)})
    ...
    nameDis:setAnchorPoint(cc.p(0, 0.5))
    nameDis:setPosition(bng:getContentSize().width * 0.18, bng:getContentSize().height * 0.14)
    bng:addChild(nameDis)
    ...
    levelDisIcon:setPosition(bng:getContentSize().width * 0.45, bng:getContentSize().height * 0.14)
    ...
    contentTitleDis:setPosition(contentBng:getContentSize().width * 0.25, contentBng:getContentSize().height * 0.8)
    ...
    --分割线
    local diviver = display.newSprite("#fenge.png", 0, 0, {scale9 = true, size = cc.size(contentBng:getContentSize().width * 0.5, contentBng:getContentSize().height * 0.03)})
    ...
    local contentDis =
        CCLabelTTF:create(
        text,
        FONTS_NAME.font_fzcy,
        20,
        cc.size(contentBng:getContentSize().width * 0.7, contentBng:getContentSize().height * 0.65),
