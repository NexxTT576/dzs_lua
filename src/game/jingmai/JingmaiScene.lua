...
function JingmaiScene:refreshBg()
    ...
    self._bg = display.newSprite(string.format("#jingmai_hero_bg_%d.png", self._index), 0, 0, {scale9 = true, size = cc.size(display.width, self:getContentHeight()), cc.rect(10, 10, 20, 20)})
