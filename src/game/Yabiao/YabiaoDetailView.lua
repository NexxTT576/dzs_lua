...
function YabiaoDetailView:setUpView(param)
    ...
    nameDis:setPosition(titleBng:getContentSize().width * 0.28, titleBng:getContentSize().height * 0.5)
    titleBng:addChild(nameDis)

    --战力title
    local fightBng = display.newSprite("#zhanli.png"):pos(titleBng:getContentSize().width, titleBng:getContentSize().height * 0.5)
    ...
    ):pos(titleBng:getContentSize().width * 0.90, titleBng:getContentSize().height * 0.5):addTo(titleBng)
