...
function ChoosePlayerNameLayer:ctor(listener)
    ...
    self._rootnode = {}
    self._startNode = CCBReaderLoad("choosePlayer/choose_player_start_bg.ccbi", proxy, self._rootnode)
...
function ChoosePlayerNameLayer:createNameLayer()
    local proxy = CCBProxy:create()
    local rootnode = {}
    local node = CCBReaderLoad("choosePlayer/choose_player_name_bg.ccbi", proxy, rootnode, self, cc.size(display.width, display.height))
