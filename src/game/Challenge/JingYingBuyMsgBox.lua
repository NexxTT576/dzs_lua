...
function JingYingBuyMsgBox:previewInit()
    ...
    local fubenName = ResMgr.createShadowMsgTTF({text = "精英副本", color = ccc3(255, 210, 0)})
     ----某副本
    ...
    local ableTime = ResMgr.createShadowMsgTTF({text = JingYingModel.getLimit() - JingYingModel.getBuyCnt(), color = ccc3(58, 209, 73)})
     --n
