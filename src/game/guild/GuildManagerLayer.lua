            ...
            callback = function(data)
                ...
                if data.err ~= "" then
                    ...
                    game.runningScene:addChild(
                        require("game.guild.utility.GuildNormalMsgBox").new(
                            {
                                title = "提示",
            ...
            callback = function(data)
                ...
                if data.err ~= "" then
                    ...
                    if data.rtnObj.success == 0 then
                        ...
                        if
                            GameStateManager.currentState == GAME_STATE.STATE_GUILD_MAINSCENE or GameStateManager.currentState == GAME_STATE.STATE_GUILD_GUILDLIST or
                                ...
                                GameStateManager.currentState == GAME_STATE.STATE_GUILD_DYNAMIC
                         then
...
function GuildManagerLayer:ctor()
    ...
    local node = CCBReaderLoad(ccbiName, proxy, rootnode)
    ...
    local function onTouchBtn(tag)
        ...
        elseif tag == tags[3] then
            -- 修改帮派宣言
            game.runningScene:addChild(
                require("game.guild.GuildModifyMsgBox").new(
                    {
                        title = "帮派宣言",
