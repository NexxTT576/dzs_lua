...
local GuildFubenChooseHeroScene =
    class(
    "GuildFubenChooseHeroScene",
    function()
        ...
        RequestHelper.guild.unionFBfight(
            {
                ...
                callback = function(data)
                    ...
                    elseif rtnObj.state == 0 then
                        pop_scene()
                        local scene =
                            require("game.guild.guildFuben.GuildFubenBattleScene").new(
                            {
                                data = data
                            }
                        )
...
function GuildFubenChooseHeroScene:initHeroListView()
    ...
    self._heroList =
        ...
        {
            size = cc.size(sz.width, sz.height - self._rootnode["content_msg_lbl"]:getContentSize().height - 5),
