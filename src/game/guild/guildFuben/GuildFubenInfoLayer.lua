...
function GuildFubenInfoLayer:ctor(param)
    ...
    self._rootnode = {}
    local node = CCBReaderLoad("ccbi/guild/guild_fuben_info.ccbi", proxy, self._rootnode)
            ...
            game.player:getGuildMgr():RequestFubenChooseCard(
                {
                    ...
                    cb = function(rtnObj)
                        ...
                        if rtnObj.state == 1 then
                            ...
                            push_scene(
                                require("game.guild.guildFuben.GuildFubenChooseHeroScene").new(
                                    {
                                        fbId = itemData.fbid,
                                        fbType = showType,
