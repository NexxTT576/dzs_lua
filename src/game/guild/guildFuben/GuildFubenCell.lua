...
function GuildFubenCell:setBoxState(state)
    ...
    if state == FUBEN_REWARD_STATE.notOpen then
        rewardBox:setSpriteFrame(display.newSprite("#guild_fuben_box_1.png"):getSpriteFrame())
    elseif state == FUBEN_REWARD_STATE.canGet then
        rewardBox:setSpriteFrame(display.newSprite("#guild_fuben_box_2.png"):getSpriteFrame())
    elseif state == FUBEN_REWARD_STATE.hasGet then
        rewardBox:setSpriteFrame(display.newSprite("#guild_fuben_box_3.png"):getSpriteFrame())
    end
end
