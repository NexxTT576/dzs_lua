    ...
    for i, v in ipairs(dynamicList) do
        ...
        elseif infoData.param_num == 7 then
            content =
                string.format(
                content,
                tostring(v.desList[1]),
                tostring(v.desList[2]),
                tostring(v.desList[3]),
                tostring(v.desList[4]),
                tostring(v.desList[5]),
                tostring(v.desList[6]),
                tostring(v.desList[7])
            )
        end
