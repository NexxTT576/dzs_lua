...
function GuildShopScene:createAllLbl()
    ...
    -- 升级帮派商店，会出现更多物品可购买
    local msgLbl = self:createShadowLbl("升级帮派商店，会出现更多物品可购买", cc.c3b(255, 144, 0), self._rootnode["tag_levelup_msg"], 18)
        ...
        return item:create(
            {
                ...
                exchangeFunc = function(cell)
                    ...
                    elseif showType == GUILD_SHOP_TYPE.prop then
                        ...
                        self:addChild(
                            require("game.Arena.ExchangeCountBox").new(
                                {
