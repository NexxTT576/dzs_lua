...
function FormEquipQHLayer:ctor(param)
    ...
    self._rootnode["bigImageSpirit"]:setSpriteFrame(display.newSprite(path):getSpriteFrame())
    ...
    local function refresh(tmpLv)
        ...
        self._rootnode["card_bg"]:setSpriteFrame(display.newSprite("#item_card_bg_" .. _info.star .. ".png"):getSpriteFrame())
