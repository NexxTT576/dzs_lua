...
function HeroChoseLayer:ctor(param)
    ...
    local topNode = CCBReaderLoad("skill/skill_select_top.ccbi", topProxy, self.topNode)
    ...
    self.topNode["title"]:setSpriteFrame(titleSp:getSpriteFrame())
    ...
    local bottomNode = CCBReaderLoad("skill/skill_select_bottom.ccbi", bottomProxy, self.bottomNode)
