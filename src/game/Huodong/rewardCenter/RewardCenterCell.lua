...
function RewardCenterCell:getContentSize()
    ...
    local node = CCBReaderLoad("reward/reward_center_item.ccbi", proxy, rootNode)
...
function RewardCenterCell:create(param)
    ...
    local node = CCBReaderLoad("reward/reward_center_item.ccbi", proxy, self._rootnode)
